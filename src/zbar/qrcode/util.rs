...
#[no_mangle]
pub unsafe extern "C" fn qr_isqrt(mut _val: libc::c_uint) -> libc::c_uint {
    ...
    loop  {
        ...
        if t <= _val { g = g.wrapping_add(b); _val = _val.wrapping_sub(t) }
        b >>= 1 as libc::c_int
    }
    return g;
}
...
#[no_mangle]
pub unsafe extern "C" fn qr_ihypot(mut _x: libc::c_int, mut _y: libc::c_int)
 -> libc::c_uint {
    ...
    shift =
        shift -
            (shift - 0 as libc::c_int &
                 -((0 as libc::c_int > shift) as libc::c_int));
    x =
        (((x << shift) as
              libc::c_ulonglong).wrapping_mul(0x9b74edaa as libc::c_ulonglong)
             >> 32 as libc::c_int) as libc::c_uint;
    _y =
        ((_y << shift) as libc::c_longlong * 0x9b74eda9 as libc::c_longlong >>
    ...
    _y -= u + mask ^ mask;
    u =
        (x.wrapping_add(1 as libc::c_int as libc::c_uint) >> 1 as libc::c_int)
            as libc::c_int;
    ...
    return x.wrapping_add((1 as libc::c_uint) << shift >> 1 as libc::c_int) >>
               shift;
}
#[no_mangle]
pub unsafe extern "C" fn qr_ilog(mut _v: libc::c_uint) -> libc::c_int {
    let mut ret: libc::c_int = 0;
    let mut m: libc::c_int = 0;
    m =
        ((_v & 0xffff0000 as libc::c_uint != 0) as libc::c_int) <<
            4 as libc::c_int;
    _v >>= m;
    ret = m;
    m =
        ((_v & 0xff00 as libc::c_int as libc::c_uint != 0) as libc::c_int) <<
            3 as libc::c_int;
    _v >>= m;
    ret |= m;
    m =
        ((_v & 0xf0 as libc::c_int as libc::c_uint != 0) as libc::c_int) <<
            2 as libc::c_int;
    _v >>= m;
    ret |= m;
    m =
        ((_v & 0xc as libc::c_int as libc::c_uint != 0) as libc::c_int) <<
            1 as libc::c_int;
    _v >>= m;
    ret |= m;
