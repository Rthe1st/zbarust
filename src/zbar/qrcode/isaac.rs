...
unsafe extern fn isaac_update(mut _ctx: *mut isaac_ctx) {
    ...
    while i < ((1 as libc::c_int) << 8 as libc::c_int) / 2 as libc::c_int {
        ...
        a = (a ^ a << 13 as libc::c_int).wrapping_add(
            *m.offset((i + ((1 as libc::c_int) << 8 as libc::c_int) / 2 as libc::c_int) as isize),
        ) & 0xffffffff as libc::c_uint;
        y = (*m.offset(
            ((x & ((((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
        ...
        *m.offset(i as isize) = y;
        b = (*m.offset(
            (y >> 8 as libc::c_int + 2 as libc::c_int
        ...
        *r.offset(i as isize) = b;
        i += 1;
        x = *m.offset(i as isize);
        a = (a ^ a >> 6 as libc::c_int).wrapping_add(
            *m.offset((i + ((1 as libc::c_int) << 8 as libc::c_int) / 2 as libc::c_int) as isize),
        ) & 0xffffffff as libc::c_uint;
        y = (*m.offset(
            ((x & ((((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
        ...
        *r.offset(i as isize) = b;
        i += 1;
        x = *m.offset(i as isize);
        a = (a ^ a << 2 as libc::c_int).wrapping_add(
            *m.offset((i + ((1 as libc::c_int) << 8 as libc::c_int) / 2 as libc::c_int) as isize),
        ) & 0xffffffff as libc::c_uint;
        y = (*m.offset(
            ((x & ((((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
        ...
        *r.offset(i as isize) = b;
        i += 1;
        x = *m.offset(i as isize);
        a = (a ^ a >> 16 as libc::c_int).wrapping_add(
            *m.offset((i + ((1 as libc::c_int) << 8 as libc::c_int) / 2 as libc::c_int) as isize),
        ) & 0xffffffff as libc::c_uint;
        y = (*m.offset(
            ((x & ((((1 as libc::c_int) << 8 as libc::c_int) - 1 as libc::c_int)
...
unsafe extern fn isaac_mix(mut _x: *mut libc::c_uint) {
    ...
    while i < 8 as libc::c_int {
        *_x.offset(i as isize) ^= *_x.offset((i + 1 as libc::c_int & 7 as libc::c_int) as isize)
            << SHIFT[i as usize] as libc::c_int;
        let ref mut fresh0 = *_x.offset((i + 3 as libc::c_int & 7 as libc::c_int) as isize);
        *fresh0 = (*fresh0).wrapping_add(*_x.offset(i as isize));
        let ref mut fresh1 = *_x.offset((i + 1 as libc::c_int & 7 as libc::c_int) as isize);
        *fresh1 =
            (*fresh1).wrapping_add(*_x.offset((i + 2 as libc::c_int & 7 as libc::c_int) as isize));
        i += 1;
        *_x.offset(i as isize) ^= *_x.offset((i + 1 as libc::c_int & 7 as libc::c_int) as isize)
            >> SHIFT[i as usize] as libc::c_int;
        let ref mut fresh2 = *_x.offset((i + 3 as libc::c_int & 7 as libc::c_int) as isize);
        *fresh2 = (*fresh2).wrapping_add(*_x.offset(i as isize));
        let ref mut fresh3 = *_x.offset((i + 1 as libc::c_int & 7 as libc::c_int) as isize);
        *fresh3 =
            (*fresh3).wrapping_add(*_x.offset((i + 2 as libc::c_int & 7 as libc::c_int) as isize));
        i += 1
    }
}
#[no_mangle]
pub unsafe extern fn isaac_init(
    mut _ctx: *mut isaac_ctx,
    ...
    while i < _nseed >> 2 as libc::c_int {
        *r.offset(i as isize) = ((*seed.offset((i << 2 as libc::c_int | 3 as libc::c_int) as isize)
            as libc::c_int)
            << 24 as libc::c_int
            | (*seed.offset((i << 2 as libc::c_int | 2 as libc::c_int) as isize) as libc::c_int)
                << 16 as libc::c_int
            | (*seed.offset((i << 2 as libc::c_int | 1 as libc::c_int) as isize) as libc::c_int)
                << 8 as libc::c_int
            | *seed.offset((i << 2 as libc::c_int) as isize) as libc::c_int)
            as libc::c_uint;
        i += 1
    }
    if _nseed & 3 as libc::c_int != 0 {
        *r.offset(i as isize) = *seed.offset((i << 2 as libc::c_int) as isize) as libc::c_uint;
        j = 1 as libc::c_int;
        while j < _nseed & 3 as libc::c_int {
            let ref mut fresh4 = *r.offset(i as isize);
            *fresh4 = (*fresh4).wrapping_add(
                ((*seed.offset((i << 2 as libc::c_int | j) as isize) as libc::c_int)
    ...
    memset(
        ...
        0 as libc::c_int,
        ((((1 as libc::c_int) << 8 as libc::c_int) - i) as libc::c_ulong)
    ...
    while i < (1 as libc::c_int) << 8 as libc::c_int {
        ...
        while j < 8 as libc::c_int {
            x[j as usize] = x[j as usize].wrapping_add(*r.offset((i + j) as isize));
            j += 1
        }
        isaac_mix(x.as_mut_ptr());
        memcpy(
            m.offset(i as isize) as *mut libc::c_void,
    ...
    while i < (1 as libc::c_int) << 8 as libc::c_int {
        j = 0 as libc::c_int;
        while j < 8 as libc::c_int {
            x[j as usize] = x[j as usize].wrapping_add(*m.offset((i + j) as isize));
            j += 1
        }
        isaac_mix(x.as_mut_ptr());
        memcpy(
...
#[no_mangle]
pub unsafe extern fn isaac_next_uint32(mut _ctx: *mut isaac_ctx) -> libc::c_uint {
    if (*_ctx).n == 0 {
        isaac_update(_ctx);
    }
...
Return: An integer uniformly distributed between 0 (inclusive) and _n
         (exclusive).*/
#[no_mangle]
pub unsafe extern fn isaac_next_uint(
    mut _ctx: *mut isaac_ctx,
    mut _n: libc::c_uint,
) -> libc::c_uint {
    ...
    loop {
        ...
        v = r.wrapping_rem(_n);
        d = r.wrapping_sub(v);
        if !((d.wrapping_add(_n).wrapping_sub(1 as libc::c_int as libc::c_uint)
            & 0xffffffff as libc::c_uint)
            < d)
        {
            break;
