...
This compares the current pixel value to the mean value of a (large) window
 surrounding it.*/
#[no_mangle]
pub unsafe extern fn qr_binarize(
    ...
    if _width > 0 as libc::c_int && _height > 0 as libc::c_int {
        ...
        mask = malloc(
            ((_width * _height) as libc::c_ulong)
        ...
        while logwindw < 8 as libc::c_int
            && (1 as libc::c_int) << logwindw < _width + 7 as libc::c_int >> 3 as libc::c_int
        {
            logwindw += 1
        }
        logwindh = 4 as libc::c_int;
        while logwindh < 8 as libc::c_int
            && (1 as libc::c_int) << logwindh < _height + 7 as libc::c_int >> 3 as libc::c_int
        {
            logwindh += 1
        }
        ...
        while x < _width {
            ...
            *col_sums.offset(x as isize) = (g << logwindh - 1 as libc::c_int).wrapping_add(g);
            x += 1
        }
        y = 1 as libc::c_int;
        while y < windh >> 1 as libc::c_int {
            y1offs = (y
                + (_height - 1 as libc::c_int - y
                    & -(((_height - 1 as libc::c_int) < y) as libc::c_int)))
                * _width;
            x = 0 as libc::c_int;
            while x < _width {
        ...
        while y < _height {
            ...
            m = (*col_sums.offset(0 as libc::c_int as isize) << logwindw - 1 as libc::c_int)
                .wrapping_add(*col_sums.offset(0 as libc::c_int as isize));
            x = 1 as libc::c_int;
            while x < windw >> 1 as libc::c_int {
                x1 = x
                    + (_width - 1 as libc::c_int - x
                        & -(((_width - 1 as libc::c_int) < x) as libc::c_int));
            ...
            while x < _width {
                ...
                *mask.offset((y * _width + x) as isize) = (-((g
                ...
                if (x + 1 as libc::c_int) < _width {
                    x0 = 0 as libc::c_int
                        - (0 as libc::c_int - (x - (windw >> 1 as libc::c_int))
                            & -((x - (windw >> 1 as libc::c_int) > 0 as libc::c_int)
                                as libc::c_int));
                    x1 = x
                        + (windw >> 1 as libc::c_int)
                        + (_width - 1 as libc::c_int - (x + (windw >> 1 as libc::c_int))
                            & -(((_width - 1 as libc::c_int) < x + (windw >> 1 as libc::c_int))
                                as libc::c_int));
                    m = m.wrapping_add(
                        (*col_sums.offset(x1 as isize)).wrapping_sub(*col_sums.offset(x0 as isize)),
                    )
                }
                x += 1
            }
            ...
            if (y + 1 as libc::c_int) < _height {
                y0offs = (0 as libc::c_int
                    - (0 as libc::c_int - (y - (windh >> 1 as libc::c_int))
                        & -((y - (windh >> 1 as libc::c_int) > 0 as libc::c_int) as libc::c_int)))
                    * _width;
                y1offs = (y
                    + (windh >> 1 as libc::c_int)
                    + (_height - 1 as libc::c_int - (y + (windh >> 1 as libc::c_int))
                        & -(((_height - 1 as libc::c_int) < y + (windh >> 1 as libc::c_int))
                            as libc::c_int)))
                    * _width;
                x = 0 as libc::c_int;
                while x < _width {
                    ...
                    *fresh1 =
                        (*fresh1).wrapping_sub(*_img.offset((y0offs + x) as isize) as libc::c_uint);
                    let ref mut fresh2 = *col_sums.offset(x as isize);
                    *fresh2 =
                        (*fresh2).wrapping_add(*_img.offset((y1offs + x) as isize) as libc::c_uint);
                    x += 1
                }
            }
            y += 1
