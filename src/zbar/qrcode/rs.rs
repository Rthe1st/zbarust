...
#[no_mangle]
pub unsafe extern "C" fn rs_gf256_init(mut _gf: *mut rs_gf256,
                                       mut _ppoly: libc::c_uint) {
    ...
    while i < 256 as libc::c_int {
        ...
        (*_gf).exp[i as usize] =
            (*_gf).exp[(i + 255 as libc::c_int) as usize];
        p =
            (p << 1 as libc::c_int ^
                 (p >> 7 as libc::c_int).wrapping_neg() & _ppoly) &
...
unsafe extern "C" fn rs_gmul(mut _gf: *const rs_gf256, mut _a: libc::c_uint,
                             mut _b: libc::c_uint) -> libc::c_uint {
    return if _a == 0 as libc::c_int as libc::c_uint ||
                  _b == 0 as libc::c_int as libc::c_uint {
               0 as libc::c_int
           } else {
               (*_gf).exp[((*_gf).log[_a as usize] as libc::c_int +
                               (*_gf).log[_b as usize] as libc::c_int) as
                              usize] as libc::c_int
           } as libc::c_uint;
}
/*Division in GF(2**8) using logarithms.
  The result of division by zero is undefined.*/
unsafe extern "C" fn rs_gdiv(mut _gf: *const rs_gf256, mut _a: libc::c_uint,
                             mut _b: libc::c_uint) -> libc::c_uint {
    return if _a == 0 as libc::c_int as libc::c_uint {
               0 as libc::c_int
           } else {
...
unsafe extern "C" fn rs_hgmul(mut _gf: *const rs_gf256, mut _a: libc::c_uint,
                              mut _logb: libc::c_uint) -> libc::c_uint {
    return if _a == 0 as libc::c_int as libc::c_uint {
               0 as libc::c_int
           } else {
               (*_gf).exp[((*_gf).log[_a as usize] as
                               libc::c_uint).wrapping_add(_logb) as usize] as
                   libc::c_int
           } as libc::c_uint;
}
/*Square root in GF(2**8) using logarithms.*/
unsafe extern "C" fn rs_gsqrt(mut _gf: *const rs_gf256, mut _a: libc::c_uint)
 -> libc::c_uint {
    let mut loga: libc::c_uint = 0;
    if _a == 0 { return 0 as libc::c_int as libc::c_uint }
    loga = (*_gf).log[_a as usize] as libc::c_uint;
    return (*_gf).exp[(loga.wrapping_add(255 as libc::c_int as libc::c_uint &
                                             (loga &
                                                  1 as libc::c_int as
...
unsafe extern "C" fn rs_quadratic_solve(mut _gf: *const rs_gf256,
                                        mut _b: libc::c_uint,
                                        mut _c: libc::c_uint,
 ...
 -> libc::c_int {
    ...
    if _b == 0 {
        *_x.offset(0 as libc::c_int as isize) =
            rs_gsqrt(_gf, _c) as libc::c_uchar;
    ...
    inc =
        (logb.wrapping_rem((255 as libc::c_int / 15 as libc::c_int) as
                               libc::c_uint) ==
             0 as libc::c_int as libc::c_uint) as libc::c_int;
    if inc != 0 {
        b =
            (*_gf).exp[logb.wrapping_add(254 as libc::c_int as libc::c_uint)
                           as usize] as libc::c_uint;
        logb = (*_gf).log[b as usize] as libc::c_uint;
        _c =
            (*_gf).exp[logc.wrapping_add(253 as libc::c_int as libc::c_uint)
                           as usize] as libc::c_uint;
        logc = (*_gf).log[_c as usize] as libc::c_uint
    } else { b = _b }
    logb2 =
        (*_gf).log[(*_gf).exp[(logb << 1 as libc::c_int) as usize] as usize]
            as libc::c_uint;
    logb4 =
        (*_gf).log[(*_gf).exp[(logb2 << 1 as libc::c_int) as usize] as usize]
            as libc::c_uint;
    logb8 =
        (*_gf).log[(*_gf).exp[(logb4 << 1 as libc::c_int) as usize] as usize]
            as libc::c_uint;
    logb12 =
        (*_gf).log[(*_gf).exp[logb4.wrapping_add(logb8) as usize] as usize] as
            libc::c_uint;
    logb14 =
        (*_gf).log[(*_gf).exp[logb2.wrapping_add(logb12) as usize] as usize]
            as libc::c_uint;
    logc2 =
        (*_gf).log[(*_gf).exp[(logc << 1 as libc::c_int) as usize] as usize]
            as libc::c_uint;
    logc4 =
        (*_gf).log[(*_gf).exp[(logc2 << 1 as libc::c_int) as usize] as usize]
            as libc::c_uint;
    c8 = (*_gf).exp[(logc4 << 1 as libc::c_int) as usize] as libc::c_uint;
    g3 =
        rs_hgmul(_gf,
                 ((*_gf).exp[logb14.wrapping_add(logc) as usize] as
                      libc::c_int ^
                      (*_gf).exp[logb12.wrapping_add(logc2) as usize] as
                          libc::c_int ^
                      (*_gf).exp[logb8.wrapping_add(logc4) as usize] as
                          libc::c_int) as libc::c_uint ^ c8, logb);
    /*If g3 doesn't lie in GF(2**4), then our roots lie in an extension field.
    Note that we rely on the fact that _gf->log[0]==0 here.*/
    if (*_gf).log[g3 as usize] as libc::c_int %
           (255 as libc::c_int / 15 as libc::c_int) != 0 as libc::c_int {
    ...
    z3 =
        rs_gdiv(_gf, g3,
                (*_gf).exp[(logb8 << 1 as libc::c_int) as usize] as
                    libc::c_uint ^ b);
    l3 =
    ...
    c0 =
        rs_hgmul(_gf, l3,
                 (255 as libc::c_int -
                      2 as libc::c_int *
                          (255 as libc::c_int / 15 as libc::c_int)) as
                     libc::c_uint);
    ...
    g2 =
        rs_hgmul(_gf,
                 rs_hgmul(_gf, c0,
                          (255 as libc::c_int -
                               2 as libc::c_int *
                                   (255 as libc::c_int / 15 as libc::c_int))
                              as libc::c_uint) ^ rs_gmul(_gf, c0, c0),
                 (255 as libc::c_int - 255 as libc::c_int / 15 as libc::c_int)
                     as libc::c_uint);
    z2 =
        rs_gdiv(_gf, g2,
                ((*_gf).exp[(255 as libc::c_int -
                                 255 as libc::c_int / 15 as libc::c_int *
                 ...
                 rs_gmul(_gf, z2, z2) ^
                     rs_hgmul(_gf, z2,
                              (255 as libc::c_int -
                                   255 as libc::c_int / 15 as libc::c_int) as
                                  libc::c_uint) ^ c0,
                 (2 as libc::c_int * (255 as libc::c_int / 15 as libc::c_int))
                     as libc::c_uint);
                                             ...
                                             rs_hgmul(_gf, l2,
                                                 ...
                                                 rs_hgmul(_gf, z2,
                                                          (255 as libc::c_int
                                                              ...
                                                              as
                                                              libc::c_uint),
                                             logb)) as usize] as libc::c_int +
                        inc) as usize];
    *_x.offset(1 as libc::c_int as isize) =
        (*_x.offset(0 as libc::c_int as isize) as libc::c_uint ^ _b) as
            libc::c_uchar;
    return 2 as libc::c_int;
}
/*Solve a cubic equation x**3 + _a*x**2 + _b*x + _c in GF(2**8).
  Returns the number of distinct roots.*/
unsafe extern "C" fn rs_cubic_solve(mut _gf: *const rs_gf256,
                                    mut _a: libc::c_uint,
                                    mut _b: libc::c_uint,
                                    mut _c: libc::c_uint,
                                    mut _x: *mut libc::c_uchar)
 -> libc::c_int {
    ...
    if d2 == 0 {
        ...
        *_x.offset(1 as libc::c_int as isize) =
            (_a ^
                 (*_gf).exp[(logx + 255 as libc::c_int / 3 as libc::c_int) as
                                usize] as libc::c_uint) as libc::c_uchar;
        *_x.offset(2 as libc::c_int as isize) =
            (_a ^ *_x.offset(0 as libc::c_int as isize) as libc::c_uint ^
                 *_x.offset(1 as libc::c_int as isize) as libc::c_uint) as
                libc::c_uchar;
        return 3 as libc::c_int
    }
    logd2 = (*_gf).log[d2 as usize] as libc::c_uint;
    logd =
        logd2.wrapping_add(255 as libc::c_int as libc::c_uint &
                               (logd2 &
                                    1 as libc::c_int as
                                        libc::c_uint).wrapping_neg()) >>
            1 as libc::c_int;
    k =
        rs_gdiv(_gf, k,
                (*_gf).exp[logd.wrapping_add(logd2) as usize] as
                    libc::c_uint);
    ...
    /*Recover w from z.*/
    logw =
        (*_gf).log[*_x.offset(0 as libc::c_int as isize) as usize] as
            libc::c_uint;
    if logw != 0 {
        if logw.wrapping_rem(3 as libc::c_int as libc::c_uint) !=
        ...
        *_x.offset(0 as libc::c_int as isize) =
            ((*_gf).exp[((*_gf).log[((*_gf).exp[logw as usize] as libc::c_int
                                         ^
                                         (*_gf).exp[(255 as libc::c_int as
                                                         libc::c_uint).wrapping_sub(logw)
                                                        as usize] as
                                             libc::c_int) as usize] as
                             libc::c_uint).wrapping_add(logd) as usize] as
                 libc::c_uint ^ _a) as libc::c_uchar;
        logw =
            logw.wrapping_add((255 as libc::c_int / 3 as libc::c_int) as
                                  libc::c_uint);
        *_x.offset(1 as libc::c_int as isize) =
            ((*_gf).exp[((*_gf).log[((*_gf).exp[logw as usize] as libc::c_int
                                         ^
                 ...
                 libc::c_uint ^ _a) as libc::c_uchar;
        *_x.offset(2 as libc::c_int as isize) =
            ((*_x.offset(0 as libc::c_int as isize) as libc::c_int ^
                  *_x.offset(1 as libc::c_int as isize) as libc::c_int) as
                 libc::c_uint ^ _a) as libc::c_uchar;
        return 3 as libc::c_int
    } else {
        *_x.offset(0 as libc::c_int as isize) = _a as libc::c_uchar;
...
unsafe extern "C" fn rs_quartic_solve(mut _gf: *const rs_gf256,
                                      mut _a: libc::c_uint,
                                      mut _b: libc::c_uint,
                                      mut _c: libc::c_uint,
                                      mut _d: libc::c_uint,
 ...
 -> libc::c_int {
    ...
    if _a != 0 {
        ...
        r =
            rs_hgmul(_gf, _c,
                     (255 as libc::c_int as libc::c_uint).wrapping_sub(loga));
        s = rs_gsqrt(_gf, r);
        t = _d ^ rs_gmul(_gf, _b, r) ^ rs_gmul(_gf, r, r);
        if t != 0 {
            let mut logti: libc::c_uint = 0;
            logti =
                (255 as libc::c_int - (*_gf).log[t as usize] as libc::c_int)
                    as libc::c_uint;
            /*The result is still quartic, but with no cubic term.*/
            nroots =
                rs_quartic_solve(_gf, 0 as libc::c_int as libc::c_uint,
                                 rs_hgmul(_gf, _b ^ rs_hgmul(_gf, s, loga),
                                          logti),
                                 (*_gf).exp[loga.wrapping_add(logti) as usize]
                                     as libc::c_uint,
            ...
            while i < nroots {
                *_x.offset(i as isize) =
                    ((*_gf).exp[(255 as libc::c_int -
                                     (*_gf).log[*_x.offset(i as isize) as
                                                    usize] as libc::c_int) as
                                    usize] as libc::c_uint ^ s) as
                        libc::c_uchar;
                i += 1
            }
        } else {
    ...
    nroots =
        rs_cubic_solve(_gf, 0 as libc::c_int as libc::c_uint, _b, _c, _x);
    if nroots < 1 as libc::c_int {
    ...
    if nroots < 2 as libc::c_int { return 0 as libc::c_int }
...
unsafe extern "C" fn rs_poly_zero(mut _p: *mut libc::c_uchar,
                                  mut _dp1: libc::c_int) {
    memset(_p as *mut libc::c_void, 0 as libc::c_int,
           (_dp1 as
                libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_uchar>()
                                                as libc::c_ulong));
}
unsafe extern "C" fn rs_poly_copy(mut _p: *mut libc::c_uchar,
                                  mut _q: *const libc::c_uchar,
                                  mut _dp1: libc::c_int) {
    memcpy(_p as *mut libc::c_void, _q as *const libc::c_void,
           (_dp1 as
                libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_uchar>()
                                                as libc::c_ulong));
}
...
unsafe extern "C" fn rs_poly_mul_x(mut _p: *mut libc::c_uchar,
                                   mut _q: *const libc::c_uchar,
                                   mut _dp1: libc::c_int) {
    memmove(_p.offset(1 as libc::c_int as isize) as *mut libc::c_void,
            _q as *const libc::c_void,
            ((_dp1 - 1 as libc::c_int) as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_uchar>()
                                                 as libc::c_ulong));
...
/*Divide the polynomial by the free variable, x (shift the coefficients).
  The number of coefficients, _dp1, must be non-zero.*/
unsafe extern "C" fn rs_poly_div_x(mut _p: *mut libc::c_uchar,
                                   mut _q: *const libc::c_uchar,
                                   mut _dp1: libc::c_int) {
    memmove(_p as *mut libc::c_void,
            _q.offset(1 as libc::c_int as isize) as *const libc::c_void,
            ((_dp1 - 1 as libc::c_int) as
                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<libc::c_uchar>()
                                                 as libc::c_ulong));
    *_p.offset((_dp1 - 1 as libc::c_int) as isize) =
        0 as libc::c_int as libc::c_uchar;
}
/*Compute the first (d+1) coefficients of the product of a degree e and a
   degree f polynomial.*/
unsafe extern "C" fn rs_poly_mult(mut _gf: *const rs_gf256,
    ...
    while i < m {
        if *_q.offset(i as isize) as libc::c_int != 0 as libc::c_int {
            ...
            n = if _dp1 - i < _fp1 { (_dp1) - i } else { _fp1 };
            logqi =
                (*_gf).log[*_q.offset(i as isize) as usize] as libc::c_uint;
            j = 0 as libc::c_int;
            while j < n {
                let ref mut fresh3 = *_p.offset((i + j) as isize);
                *fresh3 =
                    (*fresh3 as libc::c_uint ^
                         rs_hgmul(_gf, *_r.offset(j as isize) as libc::c_uint,
                                  logqi)) as libc::c_uchar;
                j += 1
            }
        }
        i += 1
...
unsafe extern "C" fn rs_calc_syndrome(mut _gf: *const rs_gf256,
                                      mut _m0: libc::c_int,
    ...
    while j < _npar {
        ...
        alphaj =
            (*_gf).log[(*_gf).exp[(j + _m0) as usize] as usize] as
                libc::c_uint;
        i = 0 as libc::c_int;
        while i < _ndata {
            sj =
                *_data.offset(i as isize) as libc::c_uint ^
                    rs_hgmul(_gf, sj, alphaj);
            i += 1
        }
...
unsafe extern "C" fn rs_init_lambda(mut _gf: *const rs_gf256,
    ...
    let mut i: libc::c_int = 0;
    let mut j: libc::c_int = 0;
    rs_poly_zero(_lambda,
                 (if _npar < 4 as libc::c_int {
                      4 as libc::c_int
                  } else { _npar }) + 1 as libc::c_int);
    *_lambda.offset(0 as libc::c_int as isize) =
        ...
        while j > 0 as libc::c_int {
            ...
            *fresh4 =
                (*fresh4 as libc::c_uint ^
                     rs_hgmul(_gf,
                              *_lambda.offset((j - 1 as libc::c_int) as isize)
                                  as libc::c_uint,
                              (_ndata - 1 as libc::c_int -
                                   *_erasures.offset(i as isize) as
...
unsafe extern "C" fn rs_modified_berlekamp_massey(mut _gf: *const rs_gf256,
                                                  mut _lambda:
                                                      *mut libc::c_uchar,
                                                  mut _s:
                                                      *const libc::c_uchar,
 ...
 -> libc::c_int {
    ...
    while n <= _npar {
        ...
        rs_poly_mul_x(tt.as_mut_ptr(), tt.as_mut_ptr(),
                      n - k + 1 as libc::c_int);
        d = 0 as libc::c_int as libc::c_uint;
        i = 0 as libc::c_int;
        while i <= l {
            d ^=
                rs_gmul(_gf, *_lambda.offset(i as isize) as libc::c_uint,
                        *_s.offset((n - 1 as libc::c_int - i) as isize) as
                            libc::c_uint);
            i += 1
        }
        if d != 0 as libc::c_int as libc::c_uint {
            ...
            if l < n - k {
                        ...
                        rs_hgmul(_gf,
                                 *_lambda.offset(i as isize) as libc::c_uint,
                                 (255 as libc::c_int as
                                      libc::c_uint).wrapping_sub(logd)) as
                            libc::c_uchar;
                    *_lambda.offset(i as isize) =
                        (*_lambda.offset(i as isize) as libc::c_uint ^
                             rs_hgmul(_gf, tti, logd)) as libc::c_uchar;
                    i += 1
                }
                t = n - k;
                k = n - l;
                ...
                while i <= l {
                    *_lambda.offset(i as isize) =
                        (*_lambda.offset(i as isize) as libc::c_uint ^
                             rs_hgmul(_gf, tt[i as usize] as libc::c_uint,
                                      logd)) as libc::c_uchar;
                    i += 1
                }
            }
        }
    ...
    rs_poly_mult(_gf, _omega, _npar, _lambda, l + 1 as libc::c_int, _s,
                 _npar);
    return l;
}
...
unsafe extern "C" fn rs_find_roots(mut _gf: *const rs_gf256,
                                   mut _epos: *mut libc::c_uchar,
                                   mut _lambda: *const libc::c_uchar,
                                   mut _nerrors: libc::c_int,
                                   mut _ndata: libc::c_int) -> libc::c_int {
    ...
    if _nerrors <= 4 as libc::c_int {
      ...
      Note that _lambda[0] is always 1.*/
        _nerrors =
            rs_quartic_solve(_gf,
                             *_lambda.offset(1 as libc::c_int as isize) as
                                 libc::c_uint,
                             *_lambda.offset(2 as libc::c_int as isize) as
                                 libc::c_uint,
                             *_lambda.offset(3 as libc::c_int as isize) as
                                 libc::c_uint,
                             *_lambda.offset(4 as libc::c_int as isize) as
                                 libc::c_uint, _epos);
        i = 0 as libc::c_int;
        while i < _nerrors {
            if *_epos.offset(i as isize) != 0 {
                alpha =
                    (*_gf).log[*_epos.offset(i as isize) as usize] as
                        libc::c_uint;
        ...
        while (alpha as libc::c_int) < _ndata {
            ...
            while i <= _nerrors {
                sum ^=
                    rs_hgmul(_gf,
                             *_lambda.offset((_nerrors - i) as isize) as
                                 libc::c_uint, alphai);
                alphai =
                    (*_gf).log[(*_gf).exp[alphai.wrapping_add(alpha) as usize]
                                   as usize] as libc::c_uint;
                i += 1
            }
            if sum == 0 {
...
/*Corrects a codeword with _ndata<256 bytes, of which the last _npar are parity
  ...
  Returns the number of errors corrected if successful, or a negative number if
   the message could not be corrected because too many errors were detected.*/
#[no_mangle]
pub unsafe extern "C" fn rs_correct(mut _gf: *const rs_gf256,
                                    mut _m0: libc::c_int,
 ...
 -> libc::c_int {
    ...
    if _nerasures > _npar { return -(1 as libc::c_int) }
    ...
    while i < _npar {
        if s[i as usize] != 0 {
            ...
            nerrors =
                rs_modified_berlekamp_massey(_gf, lambda.as_mut_ptr(),
                                             s.as_mut_ptr(),
                                             omega.as_mut_ptr(), _npar,
      ...
      Conversely, if we have too many errors, there's no reason to even attempt
       the root search.*/
            if nerrors <= 0 as libc::c_int ||
                   nerrors - _nerasures >
                       _npar - _nerasures >> 1 as libc::c_int {
                return -(1 as libc::c_int)
            }
      ...
      If they are not all distinct, or some of them were outside the valid
       range for our block size, we have a decoding error.*/
            if rs_find_roots(_gf, epos.as_mut_ptr(), lambda.as_mut_ptr(),
                             nerrors, _ndata) < nerrors {
                return -(1 as libc::c_int)
            }
            ...
            while i < nerrors {
                ...
                alphan1 =
                    (255 as libc::c_int as libc::c_uint).wrapping_sub(alpha);
                alphanj = 0 as libc::c_int as libc::c_uint;
                j = 0 as libc::c_int;
                while j < _npar {
                    a ^=
                        rs_hgmul(_gf, omega[j as usize] as libc::c_uint,
                                 alphanj);
                    alphanj =
                        (*_gf).log[(*_gf).exp[alphanj.wrapping_add(alphan1) as
                                                  usize] as usize] as
                            libc::c_uint;
                    j += 1
                }
        ...
        All the odd powers vanish.*/
                ...
                alphan2 =
                    (*_gf).log[(*_gf).exp[(alphan1 << 1 as libc::c_int) as
                                              usize] as usize] as
                        libc::c_uint;
                alphanj =
                    alphan1.wrapping_add((_m0 as
                                              libc::c_uint).wrapping_mul(alpha).wrapping_rem(255
                                                                                                 as
                                                                                                 libc::c_int
                                                                                                 as
                                                                                                 libc::c_uint));
                ...
                while j <= _npar {
                    b ^=
                        rs_hgmul(_gf, lambda[j as usize] as libc::c_uint,
                                 alphanj);
                    alphanj =
                        (*_gf).log[(*_gf).exp[alphanj.wrapping_add(alphan2) as
                                                  usize] as usize] as
                            libc::c_uint;
                    j += 2 as libc::c_int
                }
                ...
                let ref mut fresh7 =
                    *_data.offset(((_ndata - 1 as libc::c_int) as
                                       libc::c_uint).wrapping_sub(alpha) as
                                      isize);
                *fresh7 =
                    (*fresh7 as libc::c_uint ^ rs_gdiv(_gf, a, b)) as
                        libc::c_uchar;
                i += 1
            }
            return nerrors
...
#[no_mangle]
pub unsafe extern "C" fn rs_compute_genpoly(mut _gf: *const rs_gf256,
                                            mut _m0: libc::c_int,
                                            mut _genpoly: *mut libc::c_uchar,
                                            mut _npar: libc::c_int) {
    let mut i: libc::c_int = 0;
    if _npar <= 0 as libc::c_int { return }
    ...
    *_genpoly.offset(0 as libc::c_int as isize) =
    ...
    while i < _npar {
        ...
        let mut j: libc::c_int = 0;
        n =
            if (i + 1 as libc::c_int) < _npar - 1 as libc::c_int {
                (i) + 1 as libc::c_int
            } else { (_npar) - 1 as libc::c_int };
        alphai =
            (*_gf).log[(*_gf).exp[(_m0 + i) as usize] as usize] as
                libc::c_uint;
        j = n;
        while j > 0 as libc::c_int {
            *_genpoly.offset(j as isize) =
                (*_genpoly.offset((j - 1 as libc::c_int) as isize) as
                     libc::c_uint ^
                     rs_hgmul(_gf,
                              *_genpoly.offset(j as isize) as libc::c_uint,
                              alphai)) as libc::c_uchar;
            j -= 1
        }
        *_genpoly.offset(0 as libc::c_int as isize) =
            rs_hgmul(_gf,
                     *_genpoly.offset(0 as libc::c_int as isize) as
                         libc::c_uint, alphai) as libc::c_uchar;
        i += 1
    };
}
...
/*Adds _npar<=_ndata parity bytes to an _ndata-_npar byte message.
  _data must contain room for _ndata<256 bytes.*/
#[no_mangle]
pub unsafe extern "C" fn rs_encode(mut _gf: *const rs_gf256,
                                   mut _data: *mut libc::c_uchar,
                                   mut _ndata: libc::c_int,
    ...
    while i < _ndata - _npar {
        d =
            (*_data.offset(i as isize) as libc::c_int ^
                 *lfsr.offset(0 as libc::c_int as isize) as libc::c_int) as
                libc::c_uint;
        if d != 0 {
            let mut logd: libc::c_uint = 0;
            logd = (*_gf).log[d as usize] as libc::c_uint;
            ...
            while j < _npar - 1 as libc::c_int {
                *lfsr.offset(j as isize) =
                    (*lfsr.offset((j + 1 as libc::c_int) as isize) as
                         libc::c_uint ^
                         rs_hgmul(_gf,
                                  *_genpoly.offset((_npar - 1 as libc::c_int -
                                                        j) as isize) as
                                      libc::c_uint, logd)) as libc::c_uchar;
                j += 1
            }
