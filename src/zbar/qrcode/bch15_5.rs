...
unsafe extern fn gf16_mul(mut _a: libc::c_uint, mut _b: libc::c_uint) -> libc::c_uint {
    return if _a == 0 as libc::c_int as libc::c_uint || _b == 0 as libc::c_int as libc::c_uint {
        0 as libc::c_int
    } else {
        gf16_exp
            [(gf16_log[_a as usize] as libc::c_int + gf16_log[_b as usize] as libc::c_int) as usize]
            as libc::c_int
    } as libc::c_uint;
}
/*Division in GF(2**4) using logarithms.
The result when dividing by zero is undefined.*/
unsafe extern fn gf16_div(mut _a: libc::c_uint, mut _b: libc::c_uint) -> libc::c_uint {
    return if _a == 0 as libc::c_int as libc::c_uint {
        0 as libc::c_int
    } else {
        gf16_exp[(gf16_log[_a as usize] as libc::c_int + 15 as libc::c_int
            - gf16_log[_b as usize] as libc::c_int) as usize] as libc::c_int
    } as libc::c_uint;
}
/*Multiplication in GF(2**4) when the second argument is known to be non-zero
(proven by representing it by its logarithm).*/
unsafe extern fn gf16_hmul(mut _a: libc::c_uint, mut _logb: libc::c_uint) -> libc::c_uint {
    return if _a == 0 as libc::c_int as libc::c_uint {
        0 as libc::c_int
    } else {
        gf16_exp[(gf16_log[_a as usize] as libc::c_uint).wrapping_add(_logb) as usize]
            as libc::c_int
    } as libc::c_uint;
}
...
unsafe extern fn bch15_5_calc_syndrome(
    ...
    *_s.offset(0 as libc::c_int as isize) = p;
    ...
    while i < 3 as libc::c_int {
        ...
        while j < 5 as libc::c_int {
            if _y & ((1 as libc::c_int) << 5 as libc::c_int * i + j) as libc::c_uint != 0 {
    ...
    *_s.offset(1 as libc::c_int as isize) = p;
    ...
    while i < 5 as libc::c_int {
        ...
        while j < 3 as libc::c_int {
            if _y & ((1 as libc::c_int) << 3 as libc::c_int * i + j) as libc::c_uint != 0 {
    ...
    *_s.offset(2 as libc::c_int as isize) = p;
    return (*_s.offset(0 as libc::c_int as isize) != 0 as libc::c_int as libc::c_uint
        || *_s.offset(1 as libc::c_int as isize) != 0 as libc::c_int as libc::c_uint
        || *_s.offset(2 as libc::c_int as isize) != 0 as libc::c_int as libc::c_uint)
        as libc::c_int;
}
/*Compute the coefficients of the error-locator polynomial.
Returns the number of errors (the degree of the polynomial).*/
unsafe extern fn bch15_5_calc_omega(
    mut _o: *mut libc::c_uint,
    mut _s: *mut libc::c_uint,
) -> libc::c_int {
    ...
    *_o.offset(0 as libc::c_int as isize) = *_s.offset(0 as libc::c_int as isize);
    s02 = gf16_mul(*_s.offset(0 as libc::c_int as isize), *_s.offset(0 as libc::c_int as isize));
    dd = *_s.offset(1 as libc::c_int as isize)
        ^ gf16_mul(*_s.offset(0 as libc::c_int as isize), s02);
    tt = *_s.offset(2 as libc::c_int as isize)
        ^ gf16_mul(s02, *_s.offset(1 as libc::c_int as isize));
    *_o.offset(1 as libc::c_int as isize) = if dd != 0 {
        gf16_div(tt, dd)
    } else {
        0 as libc::c_int as libc::c_uint
    };
    *_o.offset(2 as libc::c_int as isize) =
        dd ^ gf16_mul(*_s.offset(0 as libc::c_int as isize), *_o.offset(1 as libc::c_int as isize));
    d = 3 as libc::c_int;
    while d > 0 as libc::c_int && *_o.offset((d - 1 as libc::c_int) as isize) == 0 {
        d -= 1
    }
    return d;
}
...
unsafe extern fn bch15_5_calc_epos(
    mut _epos: *mut libc::c_uint,
    mut _s: *mut libc::c_uint,
) -> libc::c_int {
    ...
    if d == 1 as libc::c_int {
        ...
        *_epos.offset(fresh0 as isize) =
        ...
        while i < 15 as libc::c_int {
            ...
            i2 = gf16_log[gf16_exp[(i << 1 as libc::c_int) as usize] as usize] as libc::c_int;
...
#[no_mangle]
pub unsafe extern fn bch15_5_correct(mut _y: *mut libc::c_uint) -> libc::c_int {
...
#[no_mangle]
pub unsafe extern fn bch15_5_encode(mut _x: libc::c_uint) -> libc::c_uint {
    return (_x & 1 as libc::c_int as libc::c_uint).wrapping_neg()
        & 0x537 as libc::c_int as libc::c_uint
        ^ (_x >> 1 as libc::c_int & 1 as libc::c_int as libc::c_uint).wrapping_neg()
            & 0xa6e as libc::c_int as libc::c_uint
        ^ (_x >> 2 as libc::c_int & 1 as libc::c_int as libc::c_uint).wrapping_neg()
            & 0x11eb as libc::c_int as libc::c_uint
        ^ (_x >> 3 as libc::c_int & 1 as libc::c_int as libc::c_uint).wrapping_neg()
            & 0x23d6 as libc::c_int as libc::c_uint
        ^ (_x >> 4 as libc::c_int & 1 as libc::c_int as libc::c_uint).wrapping_neg()
