 ...
 *------------------------------------------------------------------------ */
#[no_mangle]
pub unsafe extern fn zbar_get_symbol_name(mut sym: zbar_symbol_type_t) -> *const libc::c_char {
    match sym as libc::c_uint & ZBAR_SYMBOL as libc::c_int as libc::c_uint {
        ...
        35 => return b"DataBar-Exp\x00" as *const u8 as *const libc::c_char,
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_get_addon_name(mut sym: zbar_symbol_type_t) -> *const libc::c_char {
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_get_config_name(mut cfg: zbar_config_t) -> *const libc::c_char {
    match cfg as libc::c_uint {
        ...
        64 => return b"UNCERTAINTY\x00" as *const u8 as *const libc::c_char,
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_get_modifier_name(mut mod_0: zbar_modifier_t) -> *const libc::c_char {
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_get_orientation_name(
    mut orient: zbar_orientation_t,
) -> *const libc::c_char {
...
#[no_mangle]
pub unsafe extern fn _zbar_get_symbol_hash(mut sym: zbar_symbol_type_t) -> libc::c_int {
    ...
    let mut g0: libc::c_int =
        hash[(sym as libc::c_uint & 0x1f as libc::c_int as libc::c_uint) as usize] as libc::c_int;
    let mut g1: libc::c_int = hash[(!(sym as libc::c_uint >> 4 as libc::c_int)
    ...
    if g0 >= 0 as libc::c_int && g1 >= 0 as libc::c_int {
        ...
        __assert_fail(
            ...
            b"zbar/symbol.c\x00" as *const u8 as *const libc::c_char,
            109 as libc::c_int as libc::c_uint,
            (*::std::mem::transmute::<&[u8; 46], &[libc::c_char; 46]>(
                b"int _zbar_get_symbol_hash(zbar_symbol_type_t)\x00",
            ))
            .as_ptr(),
        );
    }
...
#[no_mangle]
pub unsafe extern fn _zbar_symbol_free(mut sym: *mut zbar_symbol_t) {
    if !(*sym).syms.is_null() {
        zbar_symbol_set_ref((*sym).syms, -(1 as libc::c_int));
        (*sym).syms = 0 as *mut zbar_symbol_set_t
    }
    if !(*sym).pts.is_null() {
        free((*sym).pts as *mut libc::c_void);
    }
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_ref(mut sym: *const zbar_symbol_t, mut refs: libc::c_int) {
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_get_type(mut sym: *const zbar_symbol_t) -> zbar_symbol_type_t {
    return (*sym).type_0;
}
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_get_configs(mut sym: *const zbar_symbol_t) -> libc::c_uint {
    return (*sym).configs;
}
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_get_modifiers(mut sym: *const zbar_symbol_t) -> libc::c_uint {
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_get_data(mut sym: *const zbar_symbol_t) -> *const libc::c_char {
    return (*sym).data;
}
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_get_data_length(mut sym: *const zbar_symbol_t) -> libc::c_uint {
    return (*sym).datalen;
}
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_get_count(mut sym: *const zbar_symbol_t) -> libc::c_int {
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_get_quality(mut sym: *const zbar_symbol_t) -> libc::c_int {
    return (*sym).quality;
}
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_get_loc_size(mut sym: *const zbar_symbol_t) -> libc::c_uint {
    return (*sym).npts;
}
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_get_loc_x(
    mut sym: *const zbar_symbol_t,
    mut idx: libc::c_uint,
) -> libc::c_int {
    if idx < (*sym).npts {
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_get_loc_y(
    mut sym: *const zbar_symbol_t,
    mut idx: libc::c_uint,
) -> libc::c_int {
    if idx < (*sym).npts {
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_get_orientation(
    mut sym: *const zbar_symbol_t,
) -> zbar_orientation_t {
    return (*sym).orient;
}
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_next(mut sym: *const zbar_symbol_t) -> *const zbar_symbol_t {
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_get_components(
    mut sym: *const zbar_symbol_t,
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_first_component(
    mut sym: *const zbar_symbol_t,
) -> *const zbar_symbol_t {
...
#[no_mangle]
pub unsafe extern fn base64_encode(
    ...
    while srclen != 0 {
        let fresh0 = src;
        src = src.offset(1);
        let mut buf: libc::c_uint = ((*fresh0 as libc::c_int) << 16 as libc::c_int) as libc::c_uint;
        if srclen > 1 as libc::c_int as libc::c_uint {
            let fresh1 = src;
            src = src.offset(1);
            buf |= ((*fresh1 as libc::c_int) << 8 as libc::c_int) as libc::c_uint
        }
        ...
        dst = dst.offset(1);
        *fresh3 =
            alphabet[(buf >> 18 as libc::c_int & 0x3f as libc::c_int as libc::c_uint) as usize];
        let fresh4 = dst;
        dst = dst.offset(1);
        *fresh4 =
            alphabet[(buf >> 12 as libc::c_int & 0x3f as libc::c_int as libc::c_uint) as usize];
        let fresh5 = dst;
        dst = dst.offset(1);
        *fresh5 = if srclen > 1 as libc::c_int as libc::c_uint {
            alphabet[(buf >> 6 as libc::c_int & 0x3f as libc::c_int as libc::c_uint) as usize]
                as libc::c_int
        } else {
            '=' as i32
        } as libc::c_char;
        let fresh6 = dst;
        dst = dst.offset(1);
        *fresh6 = if srclen > 2 as libc::c_int as libc::c_uint {
            alphabet[(buf & 0x3f as libc::c_int as libc::c_uint) as usize] as libc::c_int
        } else {
            '=' as i32
        } as libc::c_char;
        if srclen < 3 as libc::c_int as libc::c_uint {
            break;
        }
        nline -= 1;
        if nline == 0 {
    ...
    *fresh9 = '\u{0}' as i32 as libc::c_char;
    return (dst.wrapping_offset_from(start) as libc::c_long - 1 as libc::c_int as libc::c_long)
        as libc::c_uint;
}
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_xml(
    mut sym: *const zbar_symbol_t,
    ...
    let mut orient: *const libc::c_char = zbar_get_orientation_name((*sym).orient);
    /* check for binary data */
    let mut data: *mut libc::c_uchar = (*sym).data as *mut libc::c_uchar;
    let mut binary: libc::c_char = (*data.offset(0 as libc::c_int as isize) as libc::c_int
        == 0xff as libc::c_int
        && *data.offset(1 as libc::c_int as isize) as libc::c_int == 0xfe as libc::c_int
        || *data.offset(0 as libc::c_int as isize) as libc::c_int == 0xfe as libc::c_int
            && *data.offset(1 as libc::c_int as isize) as libc::c_int == 0xff as libc::c_int
        || strncmp(
            (*sym).data,
    ...
    while binary == 0 && (i as libc::c_uint) < (*sym).datalen {
        let mut c: libc::c_uchar = *(*sym).data.offset(i as isize) as libc::c_uchar;
        binary = ((c as libc::c_int) < 0x20 as libc::c_int
            && !(0x2600 as libc::c_int) >> c as libc::c_int & 1 as libc::c_int != 0
            || c as libc::c_int >= 0x7f as libc::c_int && (c as libc::c_int) < 0xa0 as libc::c_int
            || c as libc::c_int == ']' as i32
                && ((i + 2 as libc::c_int) as libc::c_uint) < (*sym).datalen
                && *(*sym).data.offset((i + 1 as libc::c_int) as isize) as libc::c_int
                    == ']' as i32
                && *(*sym).data.offset((i + 2 as libc::c_int) as isize) as libc::c_int
    ...
    if binary != 0 {
        datalen = (*sym)
            ...
            .wrapping_add((*sym).datalen.wrapping_div(57 as libc::c_int as libc::c_uint))
            .wrapping_add(3 as libc::c_int as libc::c_uint)
    }
    maxlen = (256 as libc::c_int as libc::c_ulong)
        .wrapping_add(strlen(type_0))
        .wrapping_add(strlen(orient))
        .wrapping_add(datalen as libc::c_ulong)
    ...
    if mods != 0 {
        maxlen =
            maxlen.wrapping_add((5 as libc::c_int * ZBAR_MOD_NUM as libc::c_int) as libc::c_uint)
    }
    let mut cfgs: libc::c_uint =
        (*sym).configs & !((1 as libc::c_int) << ZBAR_CFG_ENABLE as libc::c_int) as libc::c_uint;
    if cfgs != 0 {
        maxlen =
            maxlen.wrapping_add((10 as libc::c_int * ZBAR_CFG_NUM as libc::c_int) as libc::c_uint)
    }
    if binary != 0 {
    ...
    static mut _st: *const libc::c_char =
        b"<symbol type=\'%s\' quality=\'%d\' orientation=\'%s\'\x00" as *const u8
    ...
    if i > 0 as libc::c_int {
        ...
        __assert_fail(
            ...
            (*::std::mem::transmute::<&[u8; 70], &[libc::c_char; 70]>(
                b"char *zbar_symbol_xml(const zbar_symbol_t *, char **, unsigned int *)\x00",
            ))
            .as_ptr(),
        );
    }
    ...
    if n as libc::c_uint <= maxlen {
        ...
        __assert_fail(
            b"n <= maxlen\x00" as *const u8 as *const libc::c_char,
            b"zbar/symbol.c\x00" as *const u8 as *const libc::c_char,
            318 as libc::c_int as libc::c_uint,
            (*::std::mem::transmute::<&[u8; 70], &[libc::c_char; 70]>(
                b"char *zbar_symbol_xml(const zbar_symbol_t *, char **, unsigned int *)\x00",
    ...
    if mods != 0 {
        ...
        memcpy(
            (*buf).offset(n as isize) as *mut libc::c_void,
        ...
        n -= 1;
        static mut _st_2: *const libc::c_char = b"\'\x00" as *const u8 as *const libc::c_char;
    ...
    if cfgs != 0 {
        ...
        /* cleanup trailing space */
        n -= 1;
        static mut _st_5: *const libc::c_char = b"\'\x00" as *const u8 as *const libc::c_char;
    ...
    static mut _st_7: *const libc::c_char = b"><data\x00" as *const u8 as *const libc::c_char;
    ...
    if binary != 0 {
        static mut _st_8: *const libc::c_char =
            b" format=\'base64\' length=\'%d\'\x00" as *const u8 as *const libc::c_char;
        i = snprintf(
            (*buf).offset(n as isize),
            maxlen.wrapping_sub(n as libc::c_uint) as libc::c_ulong,
            _st_8,
    ...
    static mut _st_9: *const libc::c_char = b"><![CDATA[\x00" as *const u8 as *const libc::c_char;
    ...
    if binary == 0 {
        memcpy(
            ...
            (*sym).datalen.wrapping_add(1 as libc::c_int as libc::c_uint) as libc::c_ulong,
        );
        n = (n as libc::c_uint).wrapping_add((*sym).datalen) as libc::c_int as libc::c_int
    } else {
        static mut _st_10: *const libc::c_char = b"\n\x00" as *const u8 as *const libc::c_char;
        ...
        n = (n as libc::c_uint).wrapping_add(base64_encode(
            (*buf).offset(n as isize),
            (*sym).data,
            (*sym).datalen,
...
#[no_mangle]
pub unsafe extern fn _zbar_symbol_set_create() -> *mut zbar_symbol_set_t {
    let mut syms: *mut zbar_symbol_set_t = calloc(
        1 as libc::c_int as libc::c_ulong,
        ::std::mem::size_of::<zbar_symbol_set_t>() as libc::c_ulong,
    ) as *mut zbar_symbol_set_t;
...
#[inline]
#[linkage = "external"]
pub unsafe extern fn _zbar_symbol_set_free(mut syms: *mut zbar_symbol_set_t) {
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_set_get_size(mut syms: *const zbar_symbol_set_t) -> libc::c_int {
    return (*syms).nsyms;
}
/* * set iterator.
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_set_first_symbol(
    mut syms: *const zbar_symbol_set_t,
) -> *const zbar_symbol_t {
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_symbol_set_first_unfiltered(
    mut syms: *const zbar_symbol_set_t,
) -> *const zbar_symbol_t {
    return (*syms).head;
}
