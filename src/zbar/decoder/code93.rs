...
static mut code93_hash: [libc::c_schar; 64] = [
    ...
    0x26 as libc::c_int as libc::c_schar,
    0x23 as libc::c_int as libc::c_schar,
    0 as libc::c_int as libc::c_schar,
    -(1 as libc::c_int) as libc::c_schar,
    ...
    0x3b as libc::c_int as libc::c_schar,
    -(1 as libc::c_int) as libc::c_schar,
    0x33 as libc::c_int as libc::c_schar,
    0 as libc::c_int as libc::c_schar,
    -(1 as libc::c_int) as libc::c_schar,
...
#[inline]
unsafe extern fn check_width(mut cur: libc::c_uint, mut prev: libc::c_uint) -> libc::c_int {
    let mut dw: libc::c_uint = 0;
    if prev > cur {
        dw = prev.wrapping_sub(cur)
    } else {
        dw = cur.wrapping_sub(prev)
    }
    dw = dw.wrapping_mul(4 as libc::c_int as libc::c_uint);
    return (dw > prev) as libc::c_int;
}
#[inline]
unsafe extern fn encode6(mut dcode: *mut zbar_decoder_t) -> libc::c_int {
    /* build edge signature of character */
    let mut s: libc::c_uint = (*dcode).s6;
    let mut sig: libc::c_int = 0 as libc::c_int;
    let mut i: libc::c_int = 0;
    if s < 9 as libc::c_int as libc::c_uint {
    ...
    loop {
        ...
        let mut c: libc::c_uint =
            decode_e(pair_width(dcode, i as libc::c_uchar), s, 9 as libc::c_int as libc::c_uint)
                as libc::c_uint;
        if c > 3 as libc::c_int as libc::c_uint {
            return -(1 as libc::c_int);
        }
...
#[inline]
unsafe extern fn validate_sig(mut sig: libc::c_int) -> libc::c_int {
    let mut i: libc::c_int = 0;
...
#[inline]
unsafe extern fn decode6(mut dcode: *mut zbar_decoder_t) -> libc::c_int {
    ...
    if (*dcode).code93.direction() != 0 {
        /* reverse signature */
        let mut tmp: libc::c_uint = (sig & 0x30 as libc::c_int) as libc::c_uint;
        sig = (sig & 0x3c0 as libc::c_int) >> 6 as libc::c_int
            | (sig & 0xf as libc::c_int) << 6 as libc::c_int;
        sig = (((sig & 0x30c as libc::c_int) >> 2 as libc::c_int
            | (sig & 0xc3 as libc::c_int) << 2 as libc::c_int) as libc::c_uint
            | tmp) as libc::c_int
    }
    g0 = code93_hash[(sig - (sig >> 4 as libc::c_int) & 0x3f as libc::c_int) as usize]
        as libc::c_int;
    g1 = code93_hash
        [((sig >> 2 as libc::c_int) - (sig >> 7 as libc::c_int) & 0x3f as libc::c_int) as usize]
        as libc::c_int;
...
#[inline]
unsafe extern fn decode_start(mut dcode: *mut zbar_decoder_t) -> zbar_symbol_type_t {
    ...
    let mut c: libc::c_int = 0;
    c = encode6(dcode);
    if c < 0 as libc::c_int || c != 0xf as libc::c_int && c != 0xf0 as libc::c_int {
        return ZBAR_NONE;
    }
    dir = (c >> 7 as libc::c_int) as libc::c_uint;
    if dir != 0 {
        if decode_e(
            pair_width(dcode, 0 as libc::c_int as libc::c_uchar),
            s,
...
#[inline]
unsafe extern fn check_stop(mut dcode: *mut zbar_decoder_t) -> zbar_symbol_type_t {
    let mut dcode93: *mut code93_decoder_t = &mut (*dcode).code93;
    let mut n: libc::c_uint = (*dcode93).character() as libc::c_uint;
    let mut s: libc::c_uint = (*dcode).s6;
    let mut max_len: libc::c_int = (*dcode93).configs
    ...
    {
        return decode_abort(dcode, b"invalid len\x00" as *const u8 as *const libc::c_char);
    }
        ...
        if qz != 0
            && qz
                < s.wrapping_mul(3 as libc::c_int as libc::c_uint)
                    .wrapping_div(4 as libc::c_int as libc::c_uint)
        {
            return decode_abort(dcode, b"invalid qz\x00" as *const u8 as *const libc::c_char);
        }
    } else if decode_e(
        pair_width(dcode, 0 as libc::c_int as libc::c_uchar),
        s,
    ...
    ) != 0
    {
        ...
        return decode_abort(dcode, b"invalid stop\x00" as *const u8 as *const libc::c_char);
    }
    return ZBAR_CODE93;
}
#[inline]
unsafe extern fn plusmod47(mut acc: libc::c_int, mut add: libc::c_int) -> libc::c_int {
    acc += add;
    if acc >= 47 as libc::c_int {
        acc -= 47 as libc::c_int
    }
    return acc;
}
#[inline]
unsafe extern fn validate_checksums(mut dcode: *mut zbar_decoder_t) -> libc::c_int {
    let mut dcode93: *mut code93_decoder_t = &mut (*dcode).code93;
    ...
    let mut i_c: libc::c_uint = n
        .wrapping_sub(2 as libc::c_int as libc::c_uint)
        .wrapping_rem(20 as libc::c_int as libc::c_uint);
    let mut sum_k: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut acc_k: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut i_k: libc::c_uint = n
        .wrapping_sub(1 as libc::c_int as libc::c_uint)
        .wrapping_rem(15 as libc::c_int as libc::c_uint);
    i = 0 as libc::c_int as libc::c_uint;
    while i < n.wrapping_sub(2 as libc::c_int as libc::c_uint) {
        d = *(*dcode).buf.offset(if (*dcode93).direction() as libc::c_int != 0 {
            n.wrapping_sub(1 as libc::c_int as libc::c_uint).wrapping_sub(i)
        } else {
            i
        ...
        acc_c = plusmod47(acc_c as libc::c_int, d as libc::c_int) as libc::c_uint;
        sum_c = plusmod47(sum_c as libc::c_int, acc_c as libc::c_int) as libc::c_uint;
        let fresh1 = i_k;
        ...
        acc_k = plusmod47(acc_k as libc::c_int, d as libc::c_int) as libc::c_uint;
        sum_k = plusmod47(sum_k as libc::c_int, acc_k as libc::c_int) as libc::c_uint;
        i = i.wrapping_add(1)
    }
    d = *(*dcode).buf.offset(if (*dcode93).direction() as libc::c_int != 0 {
        1 as libc::c_int as libc::c_uint
    } else {
        n.wrapping_sub(2 as libc::c_int as libc::c_uint)
    } as isize) as libc::c_uint;
    if d != sum_c {
        return 1 as libc::c_int;
    }
    acc_k = plusmod47(acc_k as libc::c_int, sum_c as libc::c_int) as libc::c_uint;
    sum_k = plusmod47(sum_k as libc::c_int, acc_k as libc::c_int) as libc::c_uint;
    d = *(*dcode).buf.offset(if (*dcode93).direction() as libc::c_int != 0 {
...
#[inline]
unsafe extern fn postprocess(mut dcode: *mut zbar_decoder_t) -> libc::c_int {
    let mut dcode93: *mut code93_decoder_t = &mut (*dcode).code93;
    let mut i: libc::c_uint = 0;
    let mut j: libc::c_uint = 0;
    let mut n: libc::c_uint = (*dcode93).character() as libc::c_uint;
    static mut code93_graph: [libc::c_uchar; 8] = [45, 46, 32, 36, 47, 43, 37, 0];
    static mut code93_s2: [libc::c_uchar; 27] = [
        27, 28, 29, 30, 31, 59, 60, 61, 62, 63, 91, 92, 93, 94, 95, 123, 124, 125, 126, 127, 0, 64,
        96, 127, 127, 127, 0,
    ];
    (*dcode).direction =
        1 as libc::c_int - 2 as libc::c_int * (*dcode93).direction() as libc::c_int;
    if (*dcode93).direction() != 0 {
        /* reverse buffer */
        i = 0 as libc::c_int as libc::c_uint;
    ...
    while i < n {
        ...
        if (d_0 as libc::c_int) < 0xa as libc::c_int {
            ...
            d_0 = ('A' as i32 + d_0 as libc::c_int - 0xa as libc::c_int) as libc::c_uchar
        } else if (d_0 as libc::c_int) < 0x2b as libc::c_int {
            d_0 = code93_graph[(d_0 as libc::c_int - 0x24 as libc::c_int) as usize]
        } else {
            ...
            if !(shift < 0x2f as libc::c_int as libc::c_uint) {
                fprintf(
                    ...
                    b"WARNING: %s:%d: %s: Assertion \"%s\" failed.\n\t%s\n\x00" as *const u8
                        as *const libc::c_char,
                    b"zbar/decoder/code93.c\x00" as *const u8 as *const libc::c_char,
                    304 as libc::c_int,
                    (*::std::mem::transmute::<&[u8; 12], &[libc::c_char; 12]>(b"postprocess\x00"))
                        .as_ptr(),
                    b"shift < 0x2f\x00" as *const u8 as *const libc::c_char,
                    _zbar_decoder_buf_dump((*dcode).buf, (*dcode93).character() as libc::c_uint),
                );
                return -(1 as libc::c_int);
            }
            let fresh3 = i;
            ...
            match shift {
                ...
                45 => d_0 = (d_0 as libc::c_int + 0x21 as libc::c_int) as libc::c_uchar,
                46 => d_0 = (d_0 as libc::c_int + 0x61 as libc::c_int) as libc::c_uchar,
    ...
    if !(j < (*dcode).buf_alloc) {
        fprintf(
            ...
            j,
            _zbar_decoder_buf_dump((*dcode).buf, (*dcode).code93.character() as libc::c_uint),
        );
        return 1 as libc::c_int;
    }
    (*dcode).buflen = j;
...
#[no_mangle]
pub unsafe extern fn _zbar_decode_code93(mut dcode: *mut zbar_decoder_t) -> zbar_symbol_type_t {
    let mut dcode93: *mut code93_decoder_t = &mut (*dcode).code93;
    let mut c: libc::c_int = 0;
    ...
    if (*dcode93).element() as libc::c_int != 6 as libc::c_int
        || get_color(dcode) as libc::c_int == (*dcode93).direction() as libc::c_int
    {
        return ZBAR_NONE;
    }
    (*dcode93).set_element(0 as libc::c_int as libc::c_uint);
    if check_width((*dcode).s6, (*dcode93).width) != 0 {
        return decode_abort(dcode, b"width var\x00" as *const u8 as *const libc::c_char);
    }
    c = decode6(dcode);
    if c < 0 as libc::c_int {
        return decode_abort(dcode, b"aborted\x00" as *const u8 as *const libc::c_char);
    }
    if c == 0x2f as libc::c_int {
        if check_stop(dcode) as u64 == 0 {
            return ZBAR_NONE;
        }
        if validate_checksums(dcode) != 0 {
            return decode_abort(dcode, b"checksum error\x00" as *const u8 as *const libc::c_char);
        }
        if postprocess(dcode) != 0 {
            return decode_abort(
                dcode,
                b"invalid encoding\x00" as *const u8 as *const libc::c_char,
            );
        }
        (*dcode93).set_character(-(1 as libc::c_int));
        return ZBAR_CODE93;
    }
    if size_buf(dcode, ((*dcode93).character() + 1 as libc::c_int) as libc::c_uint) != 0 {
        return decode_abort(dcode, b"overflow\x00" as *const u8 as *const libc::c_char);
    }
    ...
    if (*dcode93).character() == 0 {
        ...
        *(*dcode).buf.offset((*dcode93).character() as isize) = c as libc::c_uchar
    }
