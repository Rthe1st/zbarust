...
#[inline]
unsafe extern "C" fn decode_sort3(mut dcode: *mut zbar_decoder_t,
                                  mut i0: libc::c_int) -> libc::c_uint {
    let mut w0: libc::c_uint = get_width(dcode, i0 as libc::c_uchar);
    let mut w2: libc::c_uint =
        get_width(dcode, (i0 + 2 as libc::c_int) as libc::c_uchar);
    let mut w4: libc::c_uint =
        get_width(dcode, (i0 + 4 as libc::c_int) as libc::c_uchar);
    if w0 < w2 {
        if w2 < w4 {
        ...
        return ((i0 + 4 as libc::c_int) << 8 as libc::c_int |
                    i0 << 4 as libc::c_int | i0 + 2 as libc::c_int) as
                   libc::c_uint
    }
    if w4 < w2 {
        return ((i0 + 4 as libc::c_int) << 8 as libc::c_int |
                    (i0 + 2 as libc::c_int) << 4 as libc::c_int | i0) as
                   libc::c_uint
    }
    if w0 < w4 {
        return ((i0 + 2 as libc::c_int) << 8 as libc::c_int |
                    i0 << 4 as libc::c_int | i0 + 4 as libc::c_int) as
                   libc::c_uint
    }
    return ((i0 + 2 as libc::c_int) << 8 as libc::c_int |
                (i0 + 4 as libc::c_int) << 4 as libc::c_int | i0) as
               libc::c_uint;
}
#[inline]
unsafe extern "C" fn decode_sortn(mut dcode: *mut zbar_decoder_t,
                                  mut n: libc::c_int, mut i0: libc::c_int)
 -> libc::c_uint {
    ...
    while i >= 0 as libc::c_int {
        ...
        while j >= 0 as libc::c_int {
            if !(mask >> j & 1 as libc::c_int as libc::c_uint != 0) {
                let mut w: libc::c_uint =
                    get_width(dcode,
                              (i0 + j * 2 as libc::c_int) as libc::c_uchar);
                if wmin >= w { wmin = w; jmin = j }
            }
            j -= 1
        }
        if !(jmin >= 0 as libc::c_int) {
            fprintf(stderr,
                    ...
                    b"./zbar/decoder.h\x00" as *const u8 as
                        *const libc::c_char, 238 as libc::c_int,
                    (*::std::mem::transmute::<&[u8; 13],
                                              &[libc::c_char; 13]>(b"decode_sortn\x00")).as_ptr(),
                    b"jmin >= 0\x00" as *const u8 as *const libc::c_char, n,
                    i0, jmin);
...
static mut codabar_lo: [libc::c_schar; 12] =
    [0 as libc::c_int as libc::c_schar, 0x1 as libc::c_int as libc::c_schar,
     0x4 as libc::c_int as libc::c_schar, 0x5 as libc::c_int as libc::c_schar,
     0x2 as libc::c_int as libc::c_schar, 0xa as libc::c_int as libc::c_schar,
     0xb as libc::c_int as libc::c_schar, 0x9 as libc::c_int as libc::c_schar,
     0x6 as libc::c_int as libc::c_schar, 0x7 as libc::c_int as libc::c_schar,
...
static mut codabar_hi: [libc::c_uchar; 8] =
    [0x1 as libc::c_int as libc::c_uchar, 0x4 as libc::c_int as libc::c_uchar,
     0x7 as libc::c_int as libc::c_uchar, 0x6 as libc::c_int as libc::c_uchar,
     0x2 as libc::c_int as libc::c_uchar, 0x3 as libc::c_int as libc::c_uchar,
     0 as libc::c_int as libc::c_uchar, 0x5 as libc::c_int as libc::c_uchar];
...
#[inline]
unsafe extern "C" fn codabar_decode7(mut dcode: *mut zbar_decoder_t)
 -> libc::c_schar {
    ...
    /* extract min/max bar */
    let mut ibar: libc::c_uint =
        decode_sortn(dcode, 4 as libc::c_int, 1 as libc::c_int);
    let mut wbmax: libc::c_uint =
        get_width(dcode,
                  (ibar & 0xf as libc::c_int as libc::c_uint) as
                      libc::c_uchar);
    let mut wbmin: libc::c_uint =
        get_width(dcode, (ibar >> 12 as libc::c_int) as libc::c_uchar);
    ...
    let mut wb1: libc::c_uint =
        get_width(dcode,
                  (ibar >> 8 as libc::c_int &
                       0xf as libc::c_int as libc::c_uint) as libc::c_uchar);
    let mut wb2: libc::c_uint =
        get_width(dcode,
                  (ibar >> 4 as libc::c_int &
                       0xf as libc::c_int as libc::c_uint) as libc::c_uchar);
    ...
    if b1b2.wrapping_add(b1b2.wrapping_div(8 as libc::c_int as libc::c_ulong))
           < b0b3 {
        ...
        ibar = ibar >> 1 as libc::c_int & 0x3 as libc::c_int as libc::c_uint
                  ...
                  b0b3.wrapping_add(b0b3.wrapping_div(8 as libc::c_int as
                                                          libc::c_ulong)) {
        ...
        ibar =
            (ibar >>
                 13 as
                     libc::c_int).wrapping_add(4 as libc::c_int as
                                                   libc::c_uint)
    } else { return -(1 as libc::c_int) as libc::c_schar }
    let mut ispc: libc::c_uint = decode_sort3(dcode, 2 as libc::c_int);
    let mut wsmax: libc::c_uint =
        get_width(dcode,
                  (ispc & 0xf as libc::c_int as libc::c_uint) as
                      libc::c_uchar);
    let mut wsmid: libc::c_uint =
        get_width(dcode,
                  (ispc >> 4 as libc::c_int &
                       0xf as libc::c_int as libc::c_uint) as libc::c_uchar);
    let mut wsmin: libc::c_uint =
        get_width(dcode,
                  (ispc >> 8 as libc::c_int &
                       0xf as libc::c_int as libc::c_uint) as libc::c_uchar);
    if ibar >> 2 as libc::c_int != 0 {
        ...
        let mut c: libc::c_int =
            0xfcde as libc::c_int >> (ibar << 2 as libc::c_int) &
                0xf as libc::c_int;
    ...
    if s1s1.wrapping_add(s1s1.wrapping_div(8 as libc::c_int as libc::c_ulong))
           < s0s2 {
        /* single wide space */
        ...
        ispc =
            ((ispc & 0xf as libc::c_int as libc::c_uint) >>
                 1 as
        ...
        return c_0 as libc::c_schar
                  ...
                  s0s2.wrapping_add(s0s2.wrapping_div(8 as libc::c_int as
                                                          libc::c_ulong)) {
        ...
        let mut ic_0: libc::c_uint =
            ispc.wrapping_mul(4 as libc::c_int as
                                  libc::c_uint).wrapping_add(ibar);
        if !(ic_0 < 8 as libc::c_int as libc::c_uint) {
            fprintf(stderr,
                    b"WARNING: %s:%d: %s: Assertion \"%s\" failed.\n\tic=%d ispc=%d ibar=%d\x00"
                        as *const u8 as *const libc::c_char,
                    b"zbar/decoder/codabar.c\x00" as *const u8 as
                        *const libc::c_char, 182 as libc::c_int,
                    (*::std::mem::transmute::<&[u8; 16],
                                              &[libc::c_char; 16]>(b"codabar_decode7\x00")).as_ptr(),
                    b"ic < 8\x00" as *const u8 as *const libc::c_char, ic_0,
                    ispc, ibar);
            return -(1 as libc::c_int) as libc::c_schar
        }
        let mut c_1: libc::c_uchar = codabar_hi[ic_0 as usize];
        if c_1 as libc::c_int >> 2 as libc::c_int !=
               (*codabar).direction() as libc::c_int {
            return -(1 as libc::c_int) as libc::c_schar
        }
        c_1 =
            (c_1 as libc::c_int & 0x3 as libc::c_int | 0x10 as libc::c_int) as
                libc::c_uchar;
        return c_1 as libc::c_schar
    } else { return -(1 as libc::c_int) as libc::c_schar };
}
#[inline]
unsafe extern "C" fn codabar_decode_start(mut dcode: *mut zbar_decoder_t)
 -> libc::c_schar {
    let mut codabar: *mut codabar_decoder_t = &mut (*dcode).codabar;
    let mut s: libc::c_uint = (*codabar).s7;
    ...
    let mut qz: libc::c_uint =
        get_width(dcode, 8 as libc::c_int as libc::c_uchar);
    if qz != 0 && qz.wrapping_mul(2 as libc::c_int as libc::c_uint) < s ||
           (4 as libc::c_int as
                libc::c_uint).wrapping_mul(get_width(dcode,
                                                     0 as libc::c_int as
                                                         libc::c_uchar)) >
    ...
    let mut wsmax: libc::c_uint =
        get_width(dcode,
                  (ispc & 0xf as libc::c_int as libc::c_uint) as
                      libc::c_uchar);
    let mut wsmin: libc::c_uint =
        get_width(dcode, (ispc >> 8 as libc::c_int) as libc::c_uchar);
    let mut wsmid: libc::c_uint =
        get_width(dcode,
                  (ispc >> 4 as libc::c_int &
                       0xf as libc::c_int as libc::c_uint) as libc::c_uchar);
    ...
    if !(ic < 8 as libc::c_int) {
        fprintf(stderr,
                ...
                (*::std::mem::transmute::<&[u8; 21],
                                          &[libc::c_char; 21]>(b"codabar_decode_start\x00")).as_ptr(),
                b"ic < 8\x00" as *const u8 as *const libc::c_char, ic, ispc,
                ibar);
        return ZBAR_NONE as libc::c_int as libc::c_schar
    }
...
#[inline]
unsafe extern "C" fn codabar_checksum(mut dcode: *mut zbar_decoder_t,
...
#[inline]
unsafe extern "C" fn codabar_postprocess(mut dcode: *mut zbar_decoder_t)
 -> zbar_symbol_type_t {
    let mut codabar: *mut codabar_decoder_t = &mut (*dcode).codabar;
    ...
    if dir != 0 {
        ...
        while i < n / 2 as libc::c_int {
            let mut j: libc::c_uint =
                (n - 1 as libc::c_int - i) as libc::c_uint;
    ...
    if (*codabar).config >> ZBAR_CFG_ADD_CHECK as libc::c_int &
    ...
    while i < n {
        let mut c: libc::c_uint =
            *(*dcode).buf.offset(i as isize) as libc::c_uint;
        *(*dcode).buf.offset(i as isize) =
            if c < 0x14 as libc::c_int as libc::c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn _zbar_decode_codabar(mut dcode: *mut zbar_decoder_t)
 -> zbar_symbol_type_t {
    let mut buf: *mut libc::c_uchar = 0 as *mut libc::c_uchar;
    ...
    (*codabar).s7 =
        (*codabar).s7.wrapping_sub(get_width(dcode,
                                             8 as libc::c_int as
                                                 libc::c_uchar));
    (*codabar).s7 =
        (*codabar).s7.wrapping_add(get_width(dcode,
                                             1 as libc::c_int as
                                                 libc::c_uchar));
    ...
    if (*codabar).character() < 2 as libc::c_int &&
           codabar_decode_start(dcode) as libc::c_int != 0 {
        return ZBAR_PARTIAL
    }
    (*codabar).set_element((*codabar).element() - 1);
    if (*codabar).element() != 0 { return ZBAR_NONE }
    (*codabar).set_element(4 as libc::c_int as libc::c_uint);
    ...
    if !((c as libc::c_int) < 0 as libc::c_int) {
        ...
        if (*codabar).character() < 6 as libc::c_int {
            ...
            current_block = 9828876828309294594;
                      ...
                      size_buf(dcode,
                               ((*codabar).character() + 1 as libc::c_int) as
                                   libc::c_uint) as libc::c_int != 0 {
            current_block = 9416449825185623772;
        } else { buf = (*dcode).buf; current_block = 9828876828309294594; }
        match current_block {
            9416449825185623772 => { }
            _ => {
                ...
                *buf.offset(fresh3 as isize) = c as libc::c_uchar;
                ...
                if c as libc::c_int & 0x10 as libc::c_int != 0 {
                    ...
                    if !(qz != 0 &&
                             qz.wrapping_mul(2 as libc::c_int as libc::c_uint)
                                 < s) {
                        let mut n: libc::c_uint =
                            (*codabar).character() as libc::c_uint;
                        if !(n <
                                 (*codabar).configs[(ZBAR_CFG_MIN_LEN as
                                                         libc::c_int -
                                                         ZBAR_CFG_MIN_LEN as
                                                             libc::c_int) as
                                                        usize] as libc::c_uint
                                 ||
                                 (*codabar).configs[(ZBAR_CFG_MAX_LEN as
                                                         libc::c_int -
                                                         ZBAR_CFG_MIN_LEN as
                                                             libc::c_int) as
                                                        usize] >
                                     0 as libc::c_int &&
                                     n >
                                         (*codabar).configs[(ZBAR_CFG_MAX_LEN
                                                                 as
                                                                 libc::c_int -
                                                                 ZBAR_CFG_MIN_LEN
                                                                     as
                                             ...
                                             libc::c_uint) {
                            if (*codabar).character() < 6 as libc::c_int &&
                                   acquire_lock(dcode, ZBAR_CODABAR) as
                                       libc::c_int != 0 {
                                (*codabar).set_character(-(1 as libc::c_int));
                                return ZBAR_PARTIAL
                            }
                            let mut sym: zbar_symbol_type_t =
                                codabar_postprocess(dcode);
                            if !(sym as libc::c_uint >
                                     ZBAR_PARTIAL as libc::c_int as
                                         libc::c_uint) {
