...
static mut code39_encodings: [char39_t; 44] = [
    {
        let mut init = char39_s {
            chk: 0x7 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0xd as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x13 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x16 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x19 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x1c as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x25 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x2a as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x31 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x34 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x43 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x46 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x49 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x4c as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x52 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x58 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x61 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x64 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x70 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x85 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x8a as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x91 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x94 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0xa2 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0xa8 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0xc1 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0xc4 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0xd0 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x3 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x6 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x9 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0xc as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x12 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x18 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x21 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x24 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x30 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x42 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x48 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x60 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x81 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x84 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0x90 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = char39_s {
            chk: 0xc0 as libc::c_int as libc::c_uchar,
...
static mut code39_characters: [libc::c_uchar; 44] = [
    ...
    79, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90, 45, 46, 32, 36, 47, 43, 37, 42,
];
#[inline]
unsafe extern fn code39_decode1(
    mut enc: libc::c_uchar,
    mut e: libc::c_uint,
    mut s: libc::c_uint,
) -> libc::c_uchar {
    let mut E: libc::c_uchar = decode_e(e, s, 72 as libc::c_int as libc::c_uint) as libc::c_uchar;
...
#[inline]
unsafe extern fn code39_decode9(mut dcode: *mut zbar_decoder_t) -> libc::c_schar {
    ...
    if !((enc as libc::c_int) < 0x20 as libc::c_int) {
        fprintf(
            ...
            b"WARNING: %s:%d: %s: Assertion \"%s\" failed.\n\t enc=%x s9=%x\n\x00" as *const u8
                as *const libc::c_char,
            b"zbar/decoder/code39.c\x00" as *const u8 as *const libc::c_char,
            160 as libc::c_int,
            (*::std::mem::transmute::<&[u8; 15], &[libc::c_char; 15]>(b"code39_decode9\x00"))
                .as_ptr(),
    ...
    if idx as libc::c_int & 0xc0 as libc::c_int == 0x80 as libc::c_int {
        idx = ((idx as libc::c_int & 0x3f as libc::c_int)
...
#[inline]
unsafe extern fn code39_decode_start(mut dcode: *mut zbar_decoder_t) -> libc::c_schar {
    let mut dcode39: *mut code39_decoder_t = &mut (*dcode).code39;
    let mut c: libc::c_schar = code39_decode9(dcode);
    if c as libc::c_int != 0x19 as libc::c_int && c as libc::c_int != 0x2b as libc::c_int {
        return ZBAR_NONE as libc::c_int as libc::c_schar;
    }
    (*dcode39).set_direction(
        (*dcode39).direction()
            ^ (c as libc::c_int == 0x19 as libc::c_int) as libc::c_int as libc::c_uint,
    );
    /* check leading quiet zone - spec is 10x */
    let mut quiet: libc::c_uint = get_width(dcode, 9 as libc::c_int as libc::c_uchar);
    if quiet != 0 && quiet < (*dcode39).s9.wrapping_div(2 as libc::c_int as libc::c_uint) {
        return ZBAR_NONE as libc::c_int as libc::c_schar;
    }
...
#[inline]
unsafe extern fn code39_postprocess(mut dcode: *mut zbar_decoder_t) -> libc::c_int {
    let mut dcode39: *mut code39_decoder_t = &mut (*dcode).code39;
    (*dcode).direction =
        1 as libc::c_int - 2 as libc::c_int * (*dcode39).direction() as libc::c_int;
    ...
    if (*dcode39).direction() != 0 {
        ...
        while i < (*dcode39).character() / 2 as libc::c_int {
            let mut j: libc::c_uint =
                ((*dcode39).character() - 1 as libc::c_int - i) as libc::c_uint;
    ...
    while i < (*dcode39).character() {
        *(*dcode).buf.offset(i as isize) =
            if (*(*dcode).buf.offset(i as isize) as libc::c_int) < 0x2b as libc::c_int {
                code39_characters[*(*dcode).buf.offset(i as isize) as libc::c_uint as usize]
                    as libc::c_int
            } else {
                '?' as i32
            } as libc::c_uchar;
    ...
    if !((i as libc::c_uint) < (*dcode).buf_alloc) {
        fprintf(
            ...
            b"zbar/decoder/code39.c\x00" as *const u8 as *const libc::c_char,
            236 as libc::c_int,
            (*::std::mem::transmute::<&[u8; 19], &[libc::c_char; 19]>(b"code39_postprocess\x00"))
                .as_ptr(),
            b"i < dcode->buf_alloc\x00" as *const u8 as *const libc::c_char,
            i,
            _zbar_decoder_buf_dump((*dcode).buf, (*dcode39).character() as libc::c_uint),
        );
...
#[no_mangle]
pub unsafe extern fn _zbar_decode_code39(mut dcode: *mut zbar_decoder_t) -> zbar_symbol_type_t {
    let mut dcode39: *mut code39_decoder_t = &mut (*dcode).code39;
    /* update latest character width */
    (*dcode39).s9 = (*dcode39).s9.wrapping_sub(get_width(dcode, 9 as libc::c_int as libc::c_uchar));
    (*dcode39).s9 = (*dcode39).s9.wrapping_add(get_width(dcode, 0 as libc::c_int as libc::c_uchar));
    ...
    if (*dcode39).element() as libc::c_int == 10 as libc::c_int {
        let mut space: libc::c_uint = get_width(dcode, 0 as libc::c_int as libc::c_uchar);
        if (*dcode39).character() != 0
            && *(*dcode).buf.offset(((*dcode39).character() - 1 as libc::c_int) as isize)
                as libc::c_int
                == 0x2b as libc::c_int
        {
            /* STOP */
            ...
            if !(space != 0
                && space < (*dcode39).width.wrapping_div(2 as libc::c_int as libc::c_uint))
            {
        ...
        if space > (*dcode39).width.wrapping_div(2 as libc::c_int as libc::c_uint) {
    ...
    if (*dcode39).character() == 0 && acquire_lock(dcode, ZBAR_CODE39) as libc::c_int != 0 {
        (*dcode39).set_character(-(1 as libc::c_int));
        return ZBAR_PARTIAL;
    }
    if (c as libc::c_int) < 0 as libc::c_int
        || size_buf(dcode, ((*dcode39).character() + 1 as libc::c_int) as libc::c_uint)
            as libc::c_int
            != 0
    {
        release_lock(dcode, ZBAR_CODE39);
