...
pub static mut groups: [group_s; 14] = [
    ...
    {
        let mut init = group_s {
            sum: 348 as libc::c_int as libc::c_ushort,
    ...
    {
        let mut init = group_s {
            sum: 1388 as libc::c_int as libc::c_ushort,
    ...
    {
        let mut init = group_s {
            sum: 2948 as libc::c_int as libc::c_ushort,
    ...
    {
        let mut init = group_s {
            sum: 3988 as libc::c_int as libc::c_ushort,
    ...
    {
        let mut init = group_s {
            sum: 161 as libc::c_int as libc::c_ushort,
    ...
    {
        let mut init = group_s {
            sum: 961 as libc::c_int as libc::c_ushort,
            wmax: 4 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = group_s {
            sum: 2015 as libc::c_int as libc::c_ushort,
            wmax: 3 as libc::c_int as libc::c_uchar,
            todd: 10 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = group_s {
            sum: 2715 as libc::c_int as libc::c_ushort,
            wmax: 1 as libc::c_int as libc::c_uchar,
            todd: 1 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = group_s {
            sum: 1516 as libc::c_int as libc::c_ushort,
            wmax: 8 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = group_s {
            sum: 1036 as libc::c_int as libc::c_ushort,
            wmax: 6 as libc::c_int as libc::c_uchar,
    ...
    {
        let mut init = group_s {
            sum: 336 as libc::c_int as libc::c_ushort,
            wmax: 4 as libc::c_int as libc::c_uchar,
...
#[inline]
unsafe extern fn append_check14(mut buf: *mut libc::c_uchar) {
    ...
    loop {
        ...
        if i & 1 as libc::c_int == 0 {
            chk = (chk as libc::c_int + ((d as libc::c_int) << 1 as libc::c_int)) as libc::c_uchar
        }
    }
...
#[inline]
unsafe extern fn decode10(mut buf: *mut libc::c_uchar, mut n: libc::c_ulong, mut i: libc::c_int) {
    ...
    loop {
        ...
        let mut d: libc::c_uchar =
            n.wrapping_rem(10 as libc::c_int as libc::c_ulong) as libc::c_uchar;
...
#[inline]
unsafe extern fn databar_postprocess_exp(
    mut dcode: *mut zbar_decoder_t,
    ...
    let mut len: libc::c_int =
        d.wrapping_div(211 as libc::c_int as libc::c_ulong)
    ...
    n = (d >> 4 as libc::c_int & 0x7f as libc::c_int as libc::c_ulong) as libc::c_uint;
    if n >= 0x40 as libc::c_int as libc::c_uint {
        ...
        buflen = 2 as libc::c_int
            ...
            + ((len * 12 as libc::c_int
                + (10 as libc::c_int - 2 as libc::c_int - 44 as libc::c_int + 6 as libc::c_int))
                * 2 as libc::c_int
                + 6 as libc::c_int)
                / 7 as libc::c_int
            + 2 as libc::c_int
        ...
        i = 4 as libc::c_int;
        enc = (6 as libc::c_int as libc::c_uint).wrapping_add(n & 7 as libc::c_int as libc::c_uint)
            as libc::c_int;
        buflen = 2 as libc::c_int
            + 14 as libc::c_int
            + 4 as libc::c_int
        ...
        enc = (2 as libc::c_int as libc::c_uint)
            .wrapping_add(n >> 2 as libc::c_int & 1 as libc::c_int as libc::c_uint)
            as libc::c_int;
        buflen = 2 as libc::c_int
            + 14 as libc::c_int
            + 4 as libc::c_int
        ...
        i = 7 as libc::c_int;
        enc = (4 as libc::c_int as libc::c_uint)
            .wrapping_add(n >> 3 as libc::c_int & 1 as libc::c_int as libc::c_uint)
            as libc::c_int;
        buflen = 2 as libc::c_int + 14 as libc::c_int + 4 as libc::c_int + 6 as libc::c_int
    } else {
        i = 9 as libc::c_int;
        enc = 0 as libc::c_int;
        buflen = ((len * 12 as libc::c_int + (9 as libc::c_int - 2 as libc::c_int))
            * 2 as libc::c_int
            + 6 as libc::c_int)
            / 7 as libc::c_int
            + 2 as libc::c_int
    ...
    if !(buflen > 2 as libc::c_int) {
        fprintf(
            ...
            b"WARNING: %s:%d: %s: Assertion \"%s\" failed.\n\tbuflen=%d\n\x00" as *const u8
                as *const libc::c_char,
            b"zbar/decoder/databar.c\x00" as *const u8 as *const libc::c_char,
            182 as libc::c_int,
            (*::std::mem::transmute::<&[u8; 24], &[libc::c_char; 24]>(
                b"databar_postprocess_exp\x00",
            ))
            .as_ptr(),
    ...
    if enc < 4 as libc::c_int {
        ...
        i -= 1;
        if (len as libc::c_ulong ^ d >> i) & 1 as libc::c_int as libc::c_ulong != 0 {
    ...
    if enc == 1 as libc::c_int {
        ...
        let fresh7 = buf;
        buf = buf.offset(1);
        *fresh7 = ('0' as i32 as libc::c_uint).wrapping_add(n) as libc::c_uchar
    } else if enc != 0 {
        let fresh8 = buf;
        buf = buf.offset(1);
    ...
    if enc != 0 {
        ...
        while j < 4 as libc::c_int {
            while i < 10 as libc::c_int && len != 0 {
                let fresh9 = data;
                data = data.offset(1);
                d = d << 12 as libc::c_int | (*fresh9 & 0xfff as libc::c_int) as libc::c_ulong;
                i += 12 as libc::c_int;
                len -= 1
            }
            i -= 10 as libc::c_int;
            n = (d >> i & 0x3ff as libc::c_int as libc::c_ulong) as libc::c_uint;
    ...
    match enc {
        2 => {
            ...
            while i < 2 as libc::c_int && len != 0 {
                let fresh10 = data;
                data = data.offset(1);
                d = d << 12 as libc::c_int | (*fresh10 & 0xfff as libc::c_int) as libc::c_ulong;
                i += 12 as libc::c_int;
                len -= 1
            }
            i -= 2 as libc::c_int;
            n = (d >> i & 0x3 as libc::c_int as libc::c_ulong) as libc::c_uint;
            let fresh11 = buf;
            buf = buf.offset(1);
            ...
            *fresh13 = '2' as i32 as libc::c_uchar;
            let fresh14 = buf;
            buf = buf.offset(1);
            *fresh14 = ('0' as i32 as libc::c_uint).wrapping_add(n) as libc::c_uchar
        }
        3 => {
            /* 01101: AI 393x */
            while i < 12 as libc::c_int && len != 0 {
                let fresh15 = data;
                data = data.offset(1);
                d = d << 12 as libc::c_int | (*fresh15 & 0xfff as libc::c_int) as libc::c_ulong;
                i += 12 as libc::c_int;
                len -= 1
            }
            i -= 2 as libc::c_int;
            ...
            *fresh18 = '3' as i32 as libc::c_uchar;
            let fresh19 = buf;
            buf = buf.offset(1);
            *fresh19 = ('0' as i32 as libc::c_uint).wrapping_add(n) as libc::c_uchar;
            i -= 10 as libc::c_int;
            n = (d >> i & 0x3ff as libc::c_int as libc::c_ulong) as libc::c_uint;
            if n >= 1000 as libc::c_int as libc::c_uint {
                return -(1 as libc::c_int);
        ...
        4 => {
            ...
            while i < 15 as libc::c_int && len != 0 {
                let fresh20 = data;
                data = data.offset(1);
                d = d << 12 as libc::c_int | (*fresh20 & 0xfff as libc::c_int) as libc::c_ulong;
                i += 12 as libc::c_int;
                len -= 1
            }
            i -= 15 as libc::c_int;
            n = (d >> i & 0x7fff as libc::c_int as libc::c_ulong) as libc::c_uint;
            let fresh21 = buf;
            buf = buf.offset(1);
        ...
        5 => {
            ...
            while i < 15 as libc::c_int && len != 0 {
                let fresh25 = data;
                data = data.offset(1);
                d = d << 12 as libc::c_int | (*fresh25 & 0xfff as libc::c_int) as libc::c_ulong;
                i += 12 as libc::c_int;
                len -= 1
            }
            i -= 15 as libc::c_int;
            ...
            *fresh28 = '0' as i32 as libc::c_uchar;
            let fresh29 = buf;
            buf = buf.offset(1);
            *fresh29 = if n >= 10000 as libc::c_int as libc::c_uint {
                '3' as i32
            } else {
                '2' as i32
            } as libc::c_uchar;
    ...
    if enc >= 6 as libc::c_int {
        ...
        *fresh33 = 'x' as i32 as libc::c_uchar;
        while i < 20 as libc::c_int && len != 0 {
            let fresh34 = data;
            data = data.offset(1);
            d = d << 12 as libc::c_int | (*fresh34 & 0xfff as libc::c_int) as libc::c_ulong;
            i += 12 as libc::c_int;
            len -= 1
        }
        i -= 20 as libc::c_int;
        n = (d >> i & 0xfffff as libc::c_int as libc::c_ulong) as libc::c_uint;
        ...
        *buf = '0' as i32 as libc::c_uchar;
        ...
        while i < 16 as libc::c_int && len != 0 {
            let fresh35 = data;
            data = data.offset(1);
            d = d << 12 as libc::c_int | (*fresh35 & 0xfff as libc::c_int) as libc::c_ulong;
            i += 12 as libc::c_int;
            len -= 1
        }
        i -= 16 as libc::c_int;
        ...
        if n < 38400 as libc::c_int as libc::c_uint {
            ...
            dd = n.wrapping_rem(32 as libc::c_int as libc::c_uint) as libc::c_int;
            ...
            *fresh36 = '1' as i32 as libc::c_uchar;
            let fresh37 = buf;
            buf = buf.offset(1);
            *fresh37 = ('0' as i32 + (enc - 6 as libc::c_int | 1 as libc::c_int)) as libc::c_uchar;
    ...
    if enc < 4 as libc::c_int {
        ...
        while i > 0 as libc::c_int || len > 0 as libc::c_int {
            while i < 8 as libc::c_int && len != 0 {
                let fresh38 = data;
                data = data.offset(1);
                d = d << 12 as libc::c_int | (*fresh38 & 0xfff as libc::c_int) as libc::c_ulong;
                i += 12 as libc::c_int;
                len -= 1
            }
            if scheme == SCH_NUM as libc::c_int {
                ...
                if d >> i & 0xf as libc::c_int as libc::c_ulong == 0 {
                    ...
                    n = (d >> i & 0xf as libc::c_int as libc::c_ulong)
                    ...
                    let fresh39 = buf;
                    buf = buf.offset(1);
                    *fresh39 = ('0' as i32 as libc::c_uint).wrapping_add(n) as libc::c_uchar;
                    break;
                } else {
                    i -= 3 as libc::c_int;
                    if !(i >= 0 as libc::c_int) {
                        fprintf(
                            ...
                            .as_ptr(),
                            b"i >= 0\x00" as *const u8 as *const libc::c_char,
                        );
                        return -(1 as libc::c_int);
                    }
                    n = (d >> i & 0x7f as libc::c_int as libc::c_ulong)
                        .wrapping_sub(8 as libc::c_int as libc::c_ulong)
                        as libc::c_uint;
                    n1 = n.wrapping_rem(11 as libc::c_int as libc::c_uint) as libc::c_int;
                    n = n.wrapping_div(11 as libc::c_int as libc::c_uint);
                    let fresh40 = buf;
                    buf = buf.offset(1);
                    *fresh40 = if n < 10 as libc::c_int as libc::c_uint {
                        ('0' as i32 as libc::c_uint).wrapping_add(n)
                    } else {
                        '\u{1d}' as i32 as libc::c_uint
                    } as libc::c_uchar;
                    let fresh41 = buf;
                    buf = buf.offset(1);
                    *fresh41 = if n1 < 10 as libc::c_int {
                        ('0' as i32) + n1
                    } else {
                        '\u{1d}' as i32
                    } as libc::c_uchar
                ...
                if d >> i & 0x7 as libc::c_int as libc::c_ulong == 0 {
                    ...
                    n = (d >> i & 0x1f as libc::c_int as libc::c_ulong) as libc::c_uint;
                    if n == 0x4 as libc::c_int as libc::c_uint {
                        ...
                        c = (43 as libc::c_int as libc::c_uint).wrapping_add(n)
                        ...
                        if n < 0x1a as libc::c_int as libc::c_uint {
                            ...
                            c = (',' as i32 as libc::c_uint)
                                .wrapping_add(n)
                                .wrapping_sub(0x1b as libc::c_int as libc::c_uint)
                        } else {
                            return -(1 as libc::c_int);
                        }
                        ...
                        && n < 0x1d as libc::c_int as libc::c_uint
                    {
                        ...
                        n = (d >> i & 0x3f as libc::c_int as libc::c_ulong) as libc::c_uint;
                        if n < 0x1a as libc::c_int as libc::c_uint {
                            c = ('A' as i32 as libc::c_uint).wrapping_add(n)
                        } else if n < 0x34 as libc::c_int as libc::c_uint {
                            c = ('a' as i32 as libc::c_uint)
                                .wrapping_add(n)
                                .wrapping_sub(0x1a as libc::c_int as libc::c_uint)
                        } else {
                            return -(1 as libc::c_int);
                        }
                    } else if scheme == SCH_ISO646 as libc::c_int {
                        ...
                        if n < 0xa as libc::c_int as libc::c_uint {
                            ...
                            c = ('%' as i32 as libc::c_uint)
                                .wrapping_add(n)
                                .wrapping_sub(0xa as libc::c_int as libc::c_uint)
                        } else if n < 0x1b as libc::c_int as libc::c_uint {
                            c = (':' as i32 as libc::c_uint)
                                .wrapping_add(n)
                                .wrapping_sub(0x15 as libc::c_int as libc::c_uint)
                        } else if n == 0x1b as libc::c_int as libc::c_uint {
    ...
    if !((i as libc::c_uint) < (*dcode).buf_alloc) {
        fprintf(
            ...
            .as_ptr(),
            b"i < dcode->buf_alloc\x00" as *const u8 as *const libc::c_char,
            i,
 ...
 */
#[inline]
unsafe extern fn databar_postprocess(mut dcode: *mut zbar_decoder_t, mut d: *mut libc::c_uint) {
    ...
    *buf = '\u{0}' as i32 as libc::c_uchar;
    buf = buf.offset(-1);
    *buf = '\u{0}' as i32 as libc::c_uchar;
    let mut r: libc::c_ulong = (*d.offset(0 as libc::c_int as isize))
        .wrapping_mul(1597 as libc::c_int as libc::c_uint)
        .wrapping_add(*d.offset(1 as libc::c_int as isize))
        as libc::c_ulong;
    *d.offset(1 as libc::c_int as isize) =
    ...
    r = r
        .wrapping_mul(2841 as libc::c_int as libc::c_ulong)
        .wrapping_add(*d.offset(2 as libc::c_int as isize) as libc::c_ulong);
    *d.offset(2 as libc::c_int as isize) =
        r.wrapping_div(10000 as libc::c_int as libc::c_ulong) as libc::c_uint;
    r = r.wrapping_rem(10000 as libc::c_int as libc::c_ulong);
    r = r
        .wrapping_mul(1597 as libc::c_int as libc::c_ulong)
        .wrapping_add(*d.offset(3 as libc::c_int as isize) as libc::c_ulong);
    *d.offset(3 as libc::c_int as isize) =
    ...
    loop {
        ...
        c = r.wrapping_rem(10 as libc::c_int as libc::c_ulong) as libc::c_uint;
        ...
        *buf = c.wrapping_add('0' as i32 as libc::c_uint) as libc::c_uchar;
        if i != 0 {
            r = r.wrapping_div(10 as libc::c_int as libc::c_ulong)
        }
    }
    r = (*d.offset(1 as libc::c_int as isize))
        .wrapping_mul(2841 as libc::c_int as libc::c_uint)
        .wrapping_add(*d.offset(2 as libc::c_int as isize)) as libc::c_ulong;
    *d.offset(2 as libc::c_int as isize) =
        r.wrapping_div(10000 as libc::c_int as libc::c_ulong) as libc::c_uint;
    r = r.wrapping_rem(10000 as libc::c_int as libc::c_ulong);
    ...
    *d.offset(3 as libc::c_int as isize) =
    ...
    r = (*d.offset(2 as libc::c_int as isize))
        .wrapping_mul(1597 as libc::c_int as libc::c_uint)
        .wrapping_add(*d.offset(3 as libc::c_int as isize)) as libc::c_ulong;
    i = 5 as libc::c_int;
    loop {
    ...
    if (*db).config >> ZBAR_CFG_EMIT_CHECK as libc::c_int & 1 as libc::c_int as libc::c_uint != 0 {
        ...
        *buf.offset(13 as libc::c_int as isize) =
        ...
        (*dcode).buflen = (buf.wrapping_offset_from((*dcode).buf) as libc::c_long
...
#[inline]
unsafe extern fn check_width(
    mut wf: libc::c_uint,
    mut wd: libc::c_uint,
    mut n: libc::c_uint,
) -> libc::c_int {
    let mut dwf: libc::c_uint = wf.wrapping_mul(3 as libc::c_int as libc::c_uint);
    wd = wd.wrapping_mul(14 as libc::c_int as libc::c_uint);
    wf = wf.wrapping_mul(n);
    return (wf.wrapping_sub(dwf) <= wd && wd <= wf.wrapping_add(dwf)) as libc::c_int;
}
#[inline]
unsafe extern fn merge_segment(mut db: *mut databar_decoder_t, mut seg: *mut databar_segment_t) {
    ...
    while (i as libc::c_uint) < csegs {
            ...
            ) != 0
        {
            ...
            (*seg).set_count(cnt);
            (*seg).set_partial((*seg).partial() & (*s).partial() as libc::c_int as libc::c_uint);
            (*seg).width = ((3 as libc::c_int * (*seg).width as libc::c_int
                + (*s).width as libc::c_int
                + 2 as libc::c_int)
                / 4 as libc::c_int) as libc::c_ushort;
            (*s).set_finder(-(1 as libc::c_int))
        } else if (*s).finder() >= 0 as libc::c_int {
            let mut age: libc::c_uint = ((*db).epoch() as libc::c_int - (*s).epoch() as libc::c_int
...
#[inline]
unsafe extern fn match_segment(
    mut dcode: *mut zbar_decoder_t,
    ...
    let mut smax: [*mut databar_segment_t; 3] =
        [0 as *mut databar_segment_t, 0 as *mut databar_segment_t, 0 as *mut databar_segment_t];
    if (*seg).partial() as libc::c_int != 0 && ((*seg).count() as libc::c_int) < 4 as libc::c_int {
        return ZBAR_PARTIAL;
    }
    i0 = 0 as libc::c_int;
    while (i0 as libc::c_uint) < csegs {
            ...
            ) == 0)
        {
            ...
            while (i1 as libc::c_uint) < csegs {
                let mut s1: *mut databar_segment_t = (*db).segs.offset(i1 as isize);
                let mut chkf: libc::c_int = 0;
                let mut chks: libc::c_int = 0;
                let mut chk: libc::c_int = 0;
                let mut age1: libc::c_uint = 0;
                if !(i1 == i0
                    || (*s1).finder() < 0 as libc::c_int
                    || (*s1).exp() as libc::c_int != 0
                    || (*s1).color() as libc::c_int == (*seg).color() as libc::c_int
                ...
                {
                    if (*seg).color() != 0 {
                        chkf = (*seg).finder() + (*s1).finder() * 9 as libc::c_int
                    } else {
                        chkf = (*s1).finder() + (*seg).finder() * 9 as libc::c_int
                    }
                    if chkf > 72 as libc::c_int {
                        chkf -= 1
                    }
                    if chkf > 8 as libc::c_int {
                        chkf -= 1
                    }
                    chks = ((*seg).check() as libc::c_int
                    ...
                    if chkf >= chks {
                        ...
                        chk = 79 as libc::c_int + chkf - chks
                    }
                    age1 = (((*db).epoch() as libc::c_int - (*s0).epoch() as libc::c_int
                        & 0xff as libc::c_int)
                        + ((*db).epoch() as libc::c_int - (*s1).epoch() as libc::c_int
                            & 0xff as libc::c_int)) as libc::c_uint;
                    i2 = i1 + 1 as libc::c_int;
                    while (i2 as libc::c_uint) < csegs {
                        let mut s2: *mut databar_segment_t = (*db).segs.offset(i2 as isize);
                        ...
                        if !(i2 == i0
                            ...
                            || (*s2).color() as libc::c_int != (*s1).color() as libc::c_int
                            || (*s2).side() as libc::c_int == (*s1).side() as libc::c_int
                            || (*s2).check() as libc::c_int != chk
                            || (*s2).partial() as libc::c_int != 0
                                && ((*s2).count() as libc::c_int) < 4 as libc::c_int
                            || check_width(
                                (*seg).width as libc::c_uint,
                        ...
                        {
                            age2 = ((*db).epoch() as libc::c_int - (*s2).epoch() as libc::c_int
                                & 0xff as libc::c_int)
                                as libc::c_uint;
                            age = age1.wrapping_add(age2);
                            cnt = ((*s0).count() as libc::c_int
    ...
    if smax[0 as libc::c_int as usize].is_null() {
        return ZBAR_PARTIAL;
    }
    let mut d: [libc::c_uint; 4] = [0; 4];
    d[(((*seg).color() as libc::c_int) << 1 as libc::c_int | (*seg).side() as libc::c_int)
        as usize] = (*seg).data as libc::c_uint;
    i0 = 0 as libc::c_int;
    ...
    if acquire_lock(dcode, ZBAR_DATABAR) != 0 {
        return ZBAR_PARTIAL;
    }
    databar_postprocess(dcode, d.as_mut_ptr());
    (*dcode).modifiers = ((1 as libc::c_int) << ZBAR_MOD_GS1 as libc::c_int) as libc::c_uint;
    (*dcode).direction = 1 as libc::c_int
        - 2 as libc::c_int
            * ((*seg).side() as libc::c_int ^ (*seg).color() as libc::c_int ^ 1 as libc::c_int);
    return ZBAR_DATABAR;
}
#[inline]
unsafe extern fn lookup_sequence(
    mut seg: *mut databar_segment_t,
    mut fixed: libc::c_int,
    mut seq: *mut libc::c_int,
) -> libc::c_uint {
    let mut n: libc::c_uint = ((*seg).data as libc::c_int / 211 as libc::c_int) as libc::c_uint;
...
#[inline]
unsafe extern fn match_segment_exp(
    mut dcode: *mut zbar_decoder_t,
    mut seg: *mut databar_segment_t,
    mut dir: libc::c_int,
) -> zbar_symbol_type_t {
    ...
    let mut fixed: libc::c_int = (*seg).finder() << 2 as libc::c_int
    ...
    seg = (*db).segs.offset(csegs as isize).offset(-(1 as libc::c_int as isize));
    loop {
        i -= 1;
        if !(i >= 0 as libc::c_int) {
            break;
        ...
        if (*seg).exp() as libc::c_int != 0
            ...
            && ((*seg).partial() == 0 || (*seg).count() as libc::c_int >= 4 as libc::c_int)
        {
            iseg[i as usize] = (*seg).finder() << 2 as libc::c_int
                | ((*seg).color() as libc::c_int) << 1 as libc::c_int
                | (*seg).color() as libc::c_int ^ (*seg).side() as libc::c_int
        } else {
            iseg[i as usize] = -(1 as libc::c_int)
        }
        seg = seg.offset(-1)
    }
    i = 0 as libc::c_int;
    loop {
                ...
                while (j as libc::c_uint) < csegs {
                    if iseg[j as usize] == seq[i as usize]
                        && (i == 0
                            || check_width(
                                width,
                                (*(*db).segs.offset(j as isize)).width as libc::c_uint,
                                14 as libc::c_int as libc::c_uint,
                            ) != 0)
                    {
            ...
            match current_block_36 {
                5529461102203738653 => {
                    if i == 0 {
                        ...
                        width = width
                            .wrapping_add((*seg).width as libc::c_uint)
                            .wrapping_div(2 as libc::c_int as libc::c_uint);
                        current_block_36 = 1423531122933789233;
                    }
                    match current_block_36 {
        ...
        let mut chk: libc::c_uint = 0 as libc::c_int as libc::c_uint;
        let mut age: libc::c_uint = ((*db).epoch() as libc::c_int - (*seg).epoch() as libc::c_int
            & 0xff as libc::c_int) as libc::c_uint;
        i = 1 as libc::c_int;
        while segs[i as usize] >= 0 as libc::c_int {
            ...
            age = age.wrapping_add(
                ((*db).epoch() as libc::c_int - (*seg).epoch() as libc::c_int & 0xff as libc::c_int)
                    as libc::c_uint,
            );
            i += 1
        }
        let mut data0: libc::c_uint =
            (*(*db).segs.offset(segs[0 as libc::c_int as usize] as isize)).data as libc::c_uint;
        let mut chk0: libc::c_uint = data0.wrapping_rem(211 as libc::c_int as libc::c_uint);
        chk = chk.wrapping_rem(211 as libc::c_int as libc::c_uint);
        if !(chk != chk0) {
            if !(maxcnt as libc::c_uint > cnt || maxcnt as libc::c_uint == cnt && maxage <= age) {
                maxcnt = cnt as libc::c_int;
                maxage = age;
                i = 0 as libc::c_int;
                while segs[i as usize] >= 0 as libc::c_int {
    ...
    if acquire_lock(dcode, ZBAR_DATABAR_EXP) != 0 {
        return ZBAR_PARTIAL;
    }
    i = 0 as libc::c_int;
    while bestsegs[i as usize] >= 0 as libc::c_int {
        segs[i as usize] = (*(*db).segs.offset(bestsegs[i as usize] as isize)).data as libc::c_int;
        i += 1
    }
     ...
     */
    (*dcode).direction = (1 as libc::c_int
        - 2 as libc::c_int * ((*seg).side() as libc::c_int ^ (*seg).color() as libc::c_int))
        * dir;
    (*dcode).modifiers = ((1 as libc::c_int) << ZBAR_MOD_GS1 as libc::c_int) as libc::c_uint;
    return ZBAR_DATABAR_EXP;
}
#[inline]
unsafe extern fn calc_check(
    mut sig0: libc::c_uint,
    mut sig1: libc::c_uint,
    mut side: libc::c_uint,
    mut mod_0: libc::c_uint,
) -> libc::c_uint {
    let mut chk: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut i: libc::c_int = 0;
    i = 4 as libc::c_int;
    loop {
        ...
        chk = chk
            ...
            .wrapping_add(sig1 & 0xf as libc::c_int as libc::c_uint)
            .wrapping_add(1 as libc::c_int as libc::c_uint)
            .wrapping_mul(3 as libc::c_int as libc::c_uint)
            .wrapping_add(sig0 & 0xf as libc::c_int as libc::c_uint)
            .wrapping_add(1 as libc::c_int as libc::c_uint);
        sig1 >>= 4 as libc::c_int;
        sig0 >>= 4 as libc::c_int;
        if i & 1 as libc::c_int == 0 {
            chk = chk.wrapping_rem(mod_0)
        }
    }
    if side != 0 {
        chk = chk
            .wrapping_mul((6561 as libc::c_int as libc::c_uint).wrapping_rem(mod_0))
            .wrapping_rem(mod_0)
    }
    return chk;
}
#[inline]
unsafe extern fn calc_value4(
    mut sig: libc::c_uint,
    mut n: libc::c_uint,
    mut wmax: libc::c_uint,
    mut nonarrow: libc::c_uint,
) -> libc::c_int {
    let mut v: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    n = n.wrapping_sub(1);
    let mut w0: libc::c_uint = sig >> 12 as libc::c_int & 0xf as libc::c_int as libc::c_uint;
    if w0 > 1 as libc::c_int as libc::c_uint {
        ...
        let mut sk20: libc::c_uint =
            n.wrapping_sub(1 as libc::c_int as libc::c_uint).wrapping_mul(n).wrapping_mul(
                (2 as libc::c_int as libc::c_uint)
                    .wrapping_mul(n)
                    .wrapping_sub(1 as libc::c_int as libc::c_uint),
            );
        let mut sk21: libc::c_uint =
            n0.wrapping_mul(n0.wrapping_add(1 as libc::c_int as libc::c_uint)).wrapping_mul(
                (2 as libc::c_int as libc::c_uint)
                    .wrapping_mul(n0)
                    .wrapping_add(1 as libc::c_int as libc::c_uint),
            );
        v = sk20.wrapping_sub(sk21).wrapping_sub(
            (3 as libc::c_int as libc::c_uint)
                .wrapping_mul(w0.wrapping_sub(1 as libc::c_int as libc::c_uint))
                .wrapping_mul((2 as libc::c_int as libc::c_uint).wrapping_mul(n).wrapping_sub(w0)),
        );
        if nonarrow == 0
            && w0 > 2 as libc::c_int as libc::c_uint
            && n > 4 as libc::c_int as libc::c_uint
        {
            let mut k: libc::c_uint = n
            ...
            k = k.wrapping_sub(
                (3 as libc::c_int as libc::c_uint)
                    .wrapping_mul(w0.wrapping_sub(2 as libc::c_int as libc::c_uint))
                    .wrapping_mul(
                        (14 as libc::c_int as libc::c_uint)
                            .wrapping_mul(n)
                            .wrapping_sub((7 as libc::c_int as libc::c_uint).wrapping_mul(w0))
                            .wrapping_sub(31 as libc::c_int as libc::c_uint),
                    ),
            );
            v = v.wrapping_sub(k)
        }
        if n.wrapping_sub(2 as libc::c_int as libc::c_uint) > wmax {
            let mut wm20: libc::c_uint = (2 as libc::c_int as libc::c_uint)
                .wrapping_mul(wmax)
                .wrapping_mul(wmax.wrapping_add(1 as libc::c_int as libc::c_uint));
            let mut wm21: libc::c_uint = (2 as libc::c_int as libc::c_uint)
                .wrapping_mul(wmax)
                .wrapping_add(1 as libc::c_int as libc::c_uint);
            let mut k_0: libc::c_uint = sk20;
            if n0 > wmax {
                k_0 = k_0.wrapping_sub(sk21);
                k_0 = k_0.wrapping_add(
                    (3 as libc::c_int as libc::c_uint)
                        .wrapping_mul(w0.wrapping_sub(1 as libc::c_int as libc::c_uint))
                        .wrapping_mul(wm20.wrapping_sub(wm21.wrapping_mul(
                            (2 as libc::c_int as libc::c_uint).wrapping_mul(n).wrapping_sub(w0),
                        ))),
                )
            } else {
                k_0 = k_0.wrapping_sub(
                    wmax.wrapping_add(1 as libc::c_int as libc::c_uint)
                        .wrapping_mul(wmax.wrapping_add(2 as libc::c_int as libc::c_uint))
                        .wrapping_mul(
                            (2 as libc::c_int as libc::c_uint)
                                .wrapping_mul(wmax)
                ...
                k_0 = k_0.wrapping_add(
                    (3 as libc::c_int as libc::c_uint)
                        .wrapping_mul(
                            n.wrapping_sub(wmax).wrapping_sub(2 as libc::c_int as libc::c_uint),
                        )
                        .wrapping_mul(wm20.wrapping_sub(wm21.wrapping_mul(
                            n.wrapping_add(wmax).wrapping_add(1 as libc::c_int as libc::c_uint),
                        ))),
                )
            }
    ...
    n = n.wrapping_sub(w0);
    let mut w1: libc::c_uint = sig >> 8 as libc::c_int & 0xf as libc::c_int as libc::c_uint;
    if w1 > 1 as libc::c_int as libc::c_uint {
        ...
        v = v.wrapping_add(
            (2 as libc::c_int as libc::c_uint)
                .wrapping_mul(n)
                .wrapping_sub(w1)
                .wrapping_mul(w1.wrapping_sub(1 as libc::c_int as libc::c_uint))
                .wrapping_div(2 as libc::c_int as libc::c_uint),
        );
        if nonarrow == 0
            && w1 > 2 as libc::c_int as libc::c_uint
            && n > 3 as libc::c_int as libc::c_uint
        {
            v = v.wrapping_sub(
                (2 as libc::c_int as libc::c_uint)
                    ...
                    .wrapping_mul(w1.wrapping_sub(2 as libc::c_int as libc::c_uint))
                    .wrapping_div(2 as libc::c_int as libc::c_uint),
            )
        }
        if n.wrapping_sub(1 as libc::c_int as libc::c_uint) > wmax {
            if n.wrapping_sub(w1) > wmax {
                v = v.wrapping_sub(
                    w1.wrapping_sub(1 as libc::c_int as libc::c_uint).wrapping_mul(
                        (2 as libc::c_int as libc::c_uint)
                            .wrapping_mul(n)
                            .wrapping_sub(w1)
                            .wrapping_sub((2 as libc::c_int as libc::c_uint).wrapping_mul(wmax)),
                    ),
                )
            } else {
                v = v.wrapping_sub(n.wrapping_sub(wmax).wrapping_mul(
                    n.wrapping_sub(wmax).wrapping_sub(1 as libc::c_int as libc::c_uint),
                ))
            }
        }
    } else {
    ...
    n = n.wrapping_sub(w1);
    let mut w2: libc::c_uint = sig >> 4 as libc::c_int & 0xf as libc::c_int as libc::c_uint;
    if w2 > 1 as libc::c_int as libc::c_uint {
        ...
        if nonarrow == 0
            && w2 > 2 as libc::c_int as libc::c_uint
            && n > 2 as libc::c_int as libc::c_uint
        {
            v = v.wrapping_sub(n.wrapping_sub(2 as libc::c_int as libc::c_uint))
        }
        if n > wmax {
...
unsafe extern fn decode_char(
    ...
    if s < 13 as libc::c_int as libc::c_uint
        || check_width((*seg).width as libc::c_uint, s, n as libc::c_uint) == 0
    {
        return ZBAR_NONE;
    }
    i = 4 as libc::c_int;
    loop {
        ...
        let mut e: libc::c_int =
            decode_e(pair_width(dcode, off as libc::c_uchar), s, n as libc::c_uint);
        ...
        e = decode_e(pair_width(dcode, off as libc::c_uchar), s, n as libc::c_uint);
        if e < 0 as libc::c_int {
            return ZBAR_NONE;
        }
        sum = e - sum;
    ...
    if sum0.wrapping_add(sum1).wrapping_add(8 as libc::c_int as libc::c_uint) != n as libc::c_uint {
        return ZBAR_NONE;
    }
    if (sum0 ^ (n >> 1 as libc::c_int) as libc::c_uint
        | sum1 ^ (n >> 1 as libc::c_int) as libc::c_uint ^ n as libc::c_uint)
        & 1 as libc::c_int as libc::c_uint
        != 0
    {
        return ZBAR_NONE;
    }
    i = (((n & 0x3 as libc::c_int ^ 1 as libc::c_int) * 5 as libc::c_int) as libc::c_uint)
        .wrapping_add(sum1 >> 1 as libc::c_int) as libc::c_int;
    if !((i as libc::c_ulong)
        < (::std::mem::size_of::<[group_s; 14]>() as libc::c_ulong)
            .wrapping_div(::std::mem::size_of::<group_s>() as libc::c_ulong))
    {
        fprintf(
            stderr,
            ...
            b"zbar/decoder/databar.c\x00" as *const u8 as *const libc::c_char,
            1026 as libc::c_int,
            (*::std::mem::transmute::<&[u8; 12], &[libc::c_char; 12]>(b"decode_char\x00")).as_ptr(),
            b"i < sizeof(groups) / sizeof(*groups)\x00" as *const u8 as *const libc::c_char,
            n,
            sum0,
            sum1,
            sig0,
    ...
    let mut vodd: libc::c_int = calc_value4(
        sig0.wrapping_add(0x1111 as libc::c_int as libc::c_uint),
    ...
    let mut veven: libc::c_int = calc_value4(
        sig1.wrapping_add(0x1111 as libc::c_int as libc::c_uint),
        sum1.wrapping_add(4 as libc::c_int as libc::c_uint),
        (9 as libc::c_int - (*g).wmax as libc::c_int) as libc::c_uint,
        (n & 1 as libc::c_int) as libc::c_uint,
    );
    ...
    if n & 2 as libc::c_int != 0 {
        ...
        v += veven + vodd * (*g).teven as libc::c_int
    }
    let mut chk: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    if (*seg).exp() != 0 {
        let mut side: libc::c_uint = ((*seg).color() as libc::c_int
            ^ (*seg).side() as libc::c_int
            ^ 1 as libc::c_int) as libc::c_uint;
        if v >= 4096 as libc::c_int {
            return ZBAR_NONE;
        }
        /* skip A1 left */
        chk = calc_check(sig0, sig1, side, 211 as libc::c_int as libc::c_uint);
        if (*seg).finder() != 0
            || (*seg).color() as libc::c_int != 0
            || (*seg).side() as libc::c_int != 0
        {
            i = (((*seg).finder() << 1 as libc::c_int) as libc::c_uint)
                .wrapping_sub(side)
                .wrapping_add((*seg).color()) as libc::c_int;
            ...
            chk = chk
                .wrapping_mul(exp_checksums[i as usize] as libc::c_uint)
                .wrapping_rem(211 as libc::c_int as libc::c_uint)
        } else if v >= 4009 as libc::c_int {
            return ZBAR_NONE;
        } else {
            chk = 0 as libc::c_int as libc::c_uint
        }
    } else {
        chk = calc_check(sig0, sig1, (*seg).side(), 79 as libc::c_int as libc::c_uint);
        if (*seg).color() != 0 {
            chk = chk
                .wrapping_mul(16 as libc::c_int as libc::c_uint)
                .wrapping_rem(79 as libc::c_int as libc::c_uint)
        }
    }
    (*seg).set_check(chk);
...
#[inline]
unsafe extern fn alloc_segment(mut db: *mut databar_decoder_t) -> libc::c_int {
    ...
    while (i as libc::c_uint) < csegs {
        ...
        age = ((*db).epoch() as libc::c_int - (*seg).epoch() as libc::c_int & 0xff as libc::c_int)
            as libc::c_uint;
        ...
        if age > (*seg).count() {
            age = age.wrapping_sub((*seg).count()).wrapping_add(1 as libc::c_int as libc::c_uint)
        } else {
            age = 1 as libc::c_int as libc::c_uint
        }
        if maxage < age {
            maxage = age;
            old = i
    ...
    if csegs < 32 as libc::c_int as libc::c_uint {
        ...
        if csegs != (*db).csegs() {
            let mut seg_0: *mut databar_segment_t = 0 as *mut databar_segment_t;
            (*db).segs = realloc(
                (*db).segs as *mut libc::c_void,
                (csegs as libc::c_ulong)
                    .wrapping_mul(::std::mem::size_of::<databar_segment_t>() as libc::c_ulong),
    ...
    if !(old >= 0 as libc::c_int) {
        fprintf(
            ...
            b"zbar/decoder/databar.c\x00" as *const u8 as *const libc::c_char,
            1144 as libc::c_int,
            (*::std::mem::transmute::<&[u8; 14], &[libc::c_char; 14]>(b"alloc_segment\x00"))
                .as_ptr(),
...
#[inline]
unsafe extern fn decode_finder(mut dcode: *mut zbar_decoder_t) -> zbar_symbol_type_t {
    let mut db: *mut databar_decoder_t = &mut (*dcode).databar;
    let mut seg: *mut databar_segment_t = 0 as *mut databar_segment_t;
    let mut e0: libc::c_uint = pair_width(dcode, 1 as libc::c_int as libc::c_uchar);
    let mut e2: libc::c_uint = pair_width(dcode, 3 as libc::c_int as libc::c_uchar);
    ...
    if e0 < e2 {
        let mut e: libc::c_uint = e2.wrapping_mul(4 as libc::c_int as libc::c_uint);
        ...
        let mut e_0: libc::c_uint = e0.wrapping_mul(4 as libc::c_int as libc::c_uint);
    ...
    if s < 12 as libc::c_int as libc::c_uint {
        return ZBAR_NONE;
    }
    sig = decode_e(e3, s, 14 as libc::c_int as libc::c_uint) << 8 as libc::c_int
        | decode_e(e2, s, 14 as libc::c_int as libc::c_uint) << 4 as libc::c_int
    ...
    if sig < 0 as libc::c_int
        ...
        || (sig >> 8 as libc::c_int) + sig & 0xf as libc::c_int != 10 as libc::c_int
    {
        return ZBAR_NONE;
    }
    finder = (finder_hash[(sig - (sig >> 5 as libc::c_int) & 0x1f as libc::c_int) as usize]
        as libc::c_int
        + finder_hash[(sig >> 1 as libc::c_int & 0x1f as libc::c_int) as usize] as libc::c_int
    ...
    if !(finder >= 0 as libc::c_int as libc::c_uint) {
        fprintf(
            ...
            b"zbar/decoder/databar.c\x00" as *const u8 as *const libc::c_char,
            1201 as libc::c_int,
            (*::std::mem::transmute::<&[u8; 14], &[libc::c_char; 14]>(b"decode_finder\x00"))
                .as_ptr(),
            b"finder >= 0\x00" as *const u8 as *const libc::c_char,
            dir,
            sig & 0xfff as libc::c_int,
            finder,
        );
        return ZBAR_NONE;
    }
    iseg = alloc_segment(db);
    if iseg < 0 as libc::c_int {
        return ZBAR_NONE;
    }
    seg = (*db).segs.offset(iseg as isize);
    (*seg).set_finder(if finder >= 9 as libc::c_int as libc::c_uint {
        finder.wrapping_sub(9 as libc::c_int as libc::c_uint)
    } else {
        finder
    } as libc::c_int);
    (*seg).set_exp((finder >= 9 as libc::c_int as libc::c_uint) as libc::c_int as libc::c_uint);
    (*seg).set_color(get_color(dcode) as libc::c_uint ^ dir ^ 1 as libc::c_int as libc::c_uint);
    (*seg).set_side(dir);
    ...
    let mut rc: libc::c_int = decode_char(
        dcode,
        seg,
        (12 as libc::c_int as libc::c_uint).wrapping_sub(dir) as libc::c_int,
        -(1 as libc::c_int),
    ) as libc::c_int;
    if rc == 0 {
    ...
    let mut i: libc::c_int = ((((*dcode).idx as libc::c_int + 8 as libc::c_int) as libc::c_uint)
        .wrapping_add(dir)
    ...
    if !((*db).chars[i as usize] as libc::c_int == -(1 as libc::c_int)) {
        fprintf(
            ...
            (*::std::mem::transmute::<&[u8; 14], &[libc::c_char; 14]>(b"decode_finder\x00"))
                .as_ptr(),
            b"db->chars[i] == -1\x00" as *const u8 as *const libc::c_char,
        );
        return ZBAR_NONE;
    }
...
#[no_mangle]
pub unsafe extern fn _zbar_decode_databar(mut dcode: *mut zbar_decoder_t) -> zbar_symbol_type_t {
    let mut db: *mut databar_decoder_t = &mut (*dcode).databar;
    let mut seg: *mut databar_segment_t = 0 as *mut databar_segment_t;
    ...
    if !((*seg).finder() >= 0 as libc::c_int) {
        fprintf(
            ...
            b"zbar/decoder/databar.c\x00" as *const u8 as *const libc::c_char,
            1249 as libc::c_int,
            (*::std::mem::transmute::<&[u8; 21], &[libc::c_char; 21]>(b"_zbar_decode_databar\x00"))
                .as_ptr(),
