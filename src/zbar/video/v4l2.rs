...
#[inline]
unsafe extern fn err_capture_int(
    mut container: *const libc::c_void,
    mut sev: errsev_t,
    mut type_0: zbar_error_t,
    mut func: *const libc::c_char,
...
#[inline]
unsafe extern fn video_unlock(mut vdo: *mut zbar_video_t) -> libc::c_int {
    ...
    if rc != 0 {
        err_capture(
            ...
            SEV_FATAL,
            ZBAR_ERR_LOCKING,
            (*::std::mem::transmute::<&[u8; 13], &[libc::c_char; 13]>(b"video_unlock\x00"))
                .as_ptr(),
...
unsafe extern fn v4l2_nq(mut vdo: *mut zbar_video_t, mut img: *mut zbar_image_t) -> libc::c_int {
    if (*vdo).iomode as libc::c_uint == VIDEO_READWRITE as libc::c_int as libc::c_uint {
        return video_nq_image(vdo, img);
    }
    if video_unlock(vdo) != 0 {
        return -(1 as libc::c_int);
    }
    let mut vbuf: v4l2_buffer = v4l2_buffer {
        index: 0,
        type_0: 0,
        bytesused: 0,
        flags: 0,
    ...
    memset(
        &mut vbuf as *mut v4l2_buffer as *mut libc::c_void,
        0 as libc::c_int,
        ::std::mem::size_of::<v4l2_buffer>() as libc::c_ulong,
    );
    vbuf.type_0 = V4L2_BUF_TYPE_VIDEO_CAPTURE as libc::c_int as __u32;
    if (*vdo).iomode as libc::c_uint == VIDEO_MMAP as libc::c_int as libc::c_uint {
    ...
    ) < 0 as libc::c_int
    {
        return err_capture(
            ...
            SEV_ERROR,
            ZBAR_ERR_SYSTEM,
            (*::std::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"v4l2_nq\x00")).as_ptr(),
            b"queuing video buffer (VIDIOC_QBUF)\x00" as *const u8 as *const libc::c_char,
        );
    }
    return 0 as libc::c_int;
}
unsafe extern fn v4l2_dq(mut vdo: *mut zbar_video_t) -> *mut zbar_image_t {
    ...
    if (*vdo).iomode as libc::c_uint != VIDEO_READWRITE as libc::c_int as libc::c_uint {
        ...
        if iomode as libc::c_uint == VIDEO_MMAP as libc::c_int as libc::c_uint {
            if vbuf.index >= 0 as libc::c_int as libc::c_uint {
                ...
                __assert_fail(
                    b"vbuf.index >= 0\x00" as *const u8 as *const libc::c_char,
                    b"zbar/video/v4l2.c\x00" as *const u8 as *const libc::c_char,
                    115 as libc::c_int as libc::c_uint,
                    (*::std::mem::transmute::<&[u8; 38], &[libc::c_char; 38]>(
                        b"zbar_image_t *v4l2_dq(zbar_video_t *)\x00",
                    ))
                    .as_ptr(),
                );
            }
            if vbuf.index < (*vdo).num_images as libc::c_uint {
                ...
                __assert_fail(
                    b"vbuf.index < vdo->num_images\x00" as *const u8 as *const libc::c_char,
                    b"zbar/video/v4l2.c\x00" as *const u8 as *const libc::c_char,
            ...
            if vbuf.m.userptr >= (*vdo).buf as libc::c_ulong {
                ...
                __assert_fail(
                    b"vbuf.m.userptr >= (unsigned long)vdo->buf\x00" as *const u8
            ...
            if vbuf.m.userptr < (*vdo).buf.offset((*vdo).buflen as isize) as libc::c_ulong {
            } else {
                __assert_fail(
                    b"vbuf.m.userptr < (unsigned long)(vdo->buf + vdo->buflen)\x00" as *const u8
                        as *const libc::c_char,
                    b"zbar/video/v4l2.c\x00" as *const u8 as *const libc::c_char,
            ...
            let mut i: libc::c_int = vbuf
                .m
                .userptr
                .wrapping_sub((*vdo).buf as libc::c_ulong)
                .wrapping_div((*vdo).datalen) as libc::c_int;
            ...
            if i < (*vdo).num_images {
                ...
                __assert_fail(
                    b"i < vdo->num_images\x00" as *const u8 as *const libc::c_char,
                    b"zbar/video/v4l2.c\x00" as *const u8 as *const libc::c_char,
            ...
            if vbuf.m.userptr == (*img).data as libc::c_ulong {
                ...
                __assert_fail(
                    b"vbuf.m.userptr == (unsigned long)img->data\x00" as *const u8
                        as *const libc::c_char,
                    b"zbar/video/v4l2.c\x00" as *const u8 as *const libc::c_char,
        ...
        let mut datalen: libc::c_ulong =
            read(fd, (*img).data as *mut libc::c_void, (*img).datalen) as libc::c_ulong;
                ...
                if _zbar_verbosity >= 0 as libc::c_int {
                    fprintf(
                        ...
                        b"%s: WARNING: read() size mismatch: 0x%lx != 0x%lx\n\x00" as *const u8
                            as *const libc::c_char,
                        (*::std::mem::transmute::<&[u8; 8], &[libc::c_char; 8]>(b"v4l2_dq\x00"))
                            .as_ptr(),
                        datalen,
                        (*img).datalen,
                    );
...
unsafe extern fn v4l2_start(mut vdo: *mut zbar_video_t) -> libc::c_int {
    if (*vdo).iomode as libc::c_uint == VIDEO_READWRITE as libc::c_int as libc::c_uint {
        return 0 as libc::c_int;
    }
    ...
    if ioctl(
        ...
        ((1 as libc::c_uint)
            ...
            | (::std::mem::size_of::<libc::c_int>() as libc::c_ulong)
                << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int,
        &mut type_0 as *mut v4l2_buf_type,
    ) < 0 as libc::c_int
    {
        return err_capture(
            vdo as *const libc::c_void,
            SEV_ERROR,
            ZBAR_ERR_SYSTEM,
            (*::std::mem::transmute::<&[u8; 11], &[libc::c_char; 11]>(b"v4l2_start\x00")).as_ptr(),
            b"starting video stream (VIDIOC_STREAMON)\x00" as *const u8 as *const libc::c_char,
        );
    }
    return 0 as libc::c_int;
}
unsafe extern fn v4l2_stop(mut vdo: *mut zbar_video_t) -> libc::c_int {
    if (*vdo).iomode as libc::c_uint == VIDEO_READWRITE as libc::c_int as libc::c_uint {
        return 0 as libc::c_int;
    }
    let mut type_0: v4l2_buf_type = V4L2_BUF_TYPE_VIDEO_CAPTURE;
    if ioctl(
        ...
        ((1 as libc::c_uint)
            << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int + 14 as libc::c_int
            | (('V' as i32) << 0 as libc::c_int + 8 as libc::c_int) as libc::c_uint
            | ((19 as libc::c_int) << 0 as libc::c_int) as libc::c_uint) as libc::c_ulong
            | (::std::mem::size_of::<libc::c_int>() as libc::c_ulong)
                << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int,
        &mut type_0 as *mut v4l2_buf_type,
    ) < 0 as libc::c_int
    {
        return err_capture(
            ...
            SEV_ERROR,
            ZBAR_ERR_SYSTEM,
            (*::std::mem::transmute::<&[u8; 10], &[libc::c_char; 10]>(b"v4l2_stop\x00")).as_ptr(),
            b"stopping video stream (VIDIOC_STREAMOFF)\x00" as *const u8 as *const libc::c_char,
        );
    }
    return 0 as libc::c_int;
}
unsafe extern fn v4l2_cleanup(mut vdo: *mut zbar_video_t) -> libc::c_int {
    if (*vdo).iomode as libc::c_uint == VIDEO_READWRITE as libc::c_int as libc::c_uint {
        return 0 as libc::c_int;
    }
    let mut rb: v4l2_requestbuffers = v4l2_requestbuffers {
        count: 0,
        type_0: 0,
        memory: 0,
        capabilities: 0,
    ...
    memset(
        &mut rb as *mut v4l2_requestbuffers as *mut libc::c_void,
        0 as libc::c_int,
    ...
    if (*vdo).iomode as libc::c_uint == VIDEO_MMAP as libc::c_int as libc::c_uint {
        ...
        while i < (*vdo).num_images {
            ...
            if !(*img).data.is_null()
                && munmap((*img).data as *mut libc::c_void, (*img).datalen) != 0
            {
                err_capture(
                    vdo as *const libc::c_void,
                    SEV_WARNING,
                    ZBAR_ERR_SYSTEM,
                    (*::std::mem::transmute::<&[u8; 13], &[libc::c_char; 13]>(b"v4l2_cleanup\x00"))
                        .as_ptr(),
                    b"unmapping video frame buffers\x00" as *const u8 as *const libc::c_char,
                );
            }
    ...
    if ioctl(
        ...
        ((2 as libc::c_uint | 1 as libc::c_uint)
            ...
            | (::std::mem::size_of::<v4l2_requestbuffers>() as libc::c_ulong)
                << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int,
        &mut rb as *mut v4l2_requestbuffers,
    ) < 0 as libc::c_int
    {
        err_capture(
            vdo as *const libc::c_void,
            ...
            (*::std::mem::transmute::<&[u8; 13], &[libc::c_char; 13]>(b"v4l2_cleanup\x00"))
                .as_ptr(),
            b"releasing video frame buffers (VIDIOC_REQBUFS)\x00" as *const u8
                as *const libc::c_char,
        );
    }
...
unsafe extern fn v4l2_mmap_buffers(mut vdo: *mut zbar_video_t) -> libc::c_int {
    let mut vbuf: v4l2_buffer = v4l2_buffer {
        index: 0,
        type_0: 0,
        bytesused: 0,
    ...
    while i < (*vdo).num_images {
        ...
        if ioctl(
            ...
            ((2 as libc::c_uint | 1 as libc::c_uint)
                << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int + 14 as libc::c_int
                | (('V' as i32) << 0 as libc::c_int + 8 as libc::c_int) as libc::c_uint
                | ((9 as libc::c_int) << 0 as libc::c_int) as libc::c_uint)
                as libc::c_ulong
                | (::std::mem::size_of::<v4l2_buffer>() as libc::c_ulong)
                    << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int,
            &mut vbuf as *mut v4l2_buffer,
        ) < 0 as libc::c_int
        {
            ...
            return err_capture(
                ...
                (*::std::mem::transmute::<&[u8; 18], &[libc::c_char; 18]>(
                    b"v4l2_mmap_buffers\x00",
                ))
                .as_ptr(),
                b"querying video buffer (VIDIOC_QUERYBUF)\x00" as *const u8 as *const libc::c_char,
            );
        }
        ...
        (*img).data = mmap(
            ...
            vbuf.length as size_t,
            0x1 as libc::c_int | 0x2 as libc::c_int,
            0x1 as libc::c_int,
            (*vdo).fd,
            vbuf.m.offset as __off_t,
        );
        if (*img).data == -(1 as libc::c_int) as *mut libc::c_void {
            ...
            return err_capture(
                ...
                .as_ptr(),
                b"mapping video frame buffers\x00" as *const u8 as *const libc::c_char,
            );
        }
...
unsafe extern fn v4l2_set_format(mut vdo: *mut zbar_video_t, mut fmt: uint32_t) -> libc::c_int {
    let mut vfmt: v4l2_format = v4l2_format {
        type_0: 0,
        fmt: C2RustUnnamed_8 {
            pix: v4l2_pix_format {
                width: 0,
    ...
    memset(
        &mut vfmt as *mut v4l2_format as *mut libc::c_void,
        0 as libc::c_int,
    ...
    if rc < 0 as libc::c_int {
        ...
        if _zbar_verbosity >= 1 as libc::c_int {
            fprintf(
                ...
                b"%s: VIDIOC_S_FMT returned %d(%d), trying interlaced...\n\x00" as *const u8
                    as *const libc::c_char,
                (*::std::mem::transmute::<&[u8; 16], &[libc::c_char; 16]>(b"v4l2_set_format\x00"))
                    .as_ptr(),
                rc,
                *__errno_location(),
            );
        ...
        {
            return err_capture_int(
                vdo as *const libc::c_void,
                SEV_ERROR,
                ZBAR_ERR_SYSTEM,
                (*::std::mem::transmute::<&[u8; 16], &[libc::c_char; 16]>(b"v4l2_set_format\x00"))
                    .as_ptr(),
                b"setting format %x (VIDIOC_S_FMT)\x00" as *const u8 as *const libc::c_char,
                fmt as libc::c_int,
            );
        }
        if _zbar_verbosity >= 0 as libc::c_int {
    ...
    let mut newfmt: v4l2_format = v4l2_format {
        type_0: 0,
        fmt: C2RustUnnamed_8 {
            pix: v4l2_pix_format {
                width: 0,
    ...
    memset(
        &mut newfmt as *mut v4l2_format as *mut libc::c_void,
        0 as libc::c_int,
        ::std::mem::size_of::<v4l2_format>() as libc::c_ulong,
    );
    ...
    ) < 0 as libc::c_int
    {
        return err_capture(
            ...
            (*::std::mem::transmute::<&[u8; 16], &[libc::c_char; 16]>(b"v4l2_set_format\x00"))
                .as_ptr(),
            b"querying format (VIDIOC_G_FMT)\x00" as *const u8 as *const libc::c_char,
        );
    }
    ...
    if (*newpix).pixelformat != fmt {
        ...
        return err_capture(
            ...
            (*::std::mem::transmute::<&[u8; 16], &[libc::c_char; 16]>(b"v4l2_set_format\x00"))
                .as_ptr(),
            b"video driver can\'t provide compatible format\x00" as *const u8
                as *const libc::c_char,
        );
    }
    (*vdo).format = fmt;
...
unsafe extern fn v4l2_init(mut vdo: *mut zbar_video_t, mut fmt: uint32_t) -> libc::c_int {
    let mut rb: v4l2_requestbuffers = v4l2_requestbuffers {
        count: 0,
        type_0: 0,
        memory: 0,
    ...
    ) < 0 as libc::c_int
    {
        return err_capture(
            ...
            SEV_ERROR,
            ZBAR_ERR_SYSTEM,
            (*::std::mem::transmute::<&[u8; 10], &[libc::c_char; 10]>(b"v4l2_init\x00")).as_ptr(),
            b"requesting video frame buffers (VIDIOC_REQBUFS)\x00" as *const u8
                as *const libc::c_char,
        );
    }
    if rb.count == 0 {
        return err_capture(
            ...
            ZBAR_ERR_INVALID,
            (*::std::mem::transmute::<&[u8; 10], &[libc::c_char; 10]>(b"v4l2_init\x00")).as_ptr(),
            b"driver returned 0 buffers\x00" as *const u8 as *const libc::c_char,
        );
    }
...
unsafe extern fn v4l2_probe_iomode(mut vdo: *mut zbar_video_t) -> libc::c_int {
    let mut rb: v4l2_requestbuffers = v4l2_requestbuffers {
        count: 0,
        type_0: 0,
        memory: 0,
    ...
    ) < 0 as libc::c_int
    {
        if (*vdo).iomode as u64 != 0 {
            return err_capture_int(
                ...
                ZBAR_ERR_INVALID,
                (*::std::mem::transmute::<&[u8; 18], &[libc::c_char; 18]>(
                    b"v4l2_probe_iomode\x00",
                ))
                .as_ptr(),
                b"unsupported iomode requested (%d)\x00" as *const u8 as *const libc::c_char,
            ...
            if *__errno_location() != 22 as libc::c_int {
                return err_capture(
                    ...
                    .as_ptr(),
                    b"querying streaming mode (VIDIOC_REQBUFS)\x00" as *const u8
                        as *const libc::c_char,
                );
            }
        }
        err_capture(
            ...
            SEV_WARNING,
            ZBAR_ERR_SYSTEM,
            (*::std::mem::transmute::<&[u8; 18], &[libc::c_char; 18]>(b"v4l2_probe_iomode\x00"))
                .as_ptr(),
            b"USERPTR failed. Falling back to mmap\x00" as *const u8 as *const libc::c_char,
        );
...
#[inline]
unsafe extern fn v4l2_max_size(
    mut vdo: *mut zbar_video_t,
    mut pixfmt: uint32_t,
    ...
    let mut i: libc::c_int = 0;
    let mut frm: v4l2_frmsizeenum = v4l2_frmsizeenum {
        index: 0,
        pixel_format: 0,
        type_0: 0,
    ...
    while i < 256 as libc::c_int {
        memset(
            &mut frm as *mut v4l2_frmsizeenum as *mut libc::c_void,
            0 as libc::c_int,
        ...
        if ioctl(
            ...
            ((2 as libc::c_uint | 1 as libc::c_uint)
                << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int + 14 as libc::c_int
                | (('V' as i32) << 0 as libc::c_int + 8 as libc::c_int) as libc::c_uint
                | ((74 as libc::c_int) << 0 as libc::c_int) as libc::c_uint)
                as libc::c_ulong
                | (::std::mem::size_of::<v4l2_frmsizeenum>() as libc::c_ulong)
                    << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int,
            &mut frm as *mut v4l2_frmsizeenum,
        ) != 0
        {
            break;
        }
        match frm.type_0 {
            ...
            2 | 3 => {
                ...
                mheight = frm.c2rust_unnamed.stepwise.max_height as libc::c_int;
                current_block_11 = 4166486009154926805;
            }
            _ => {
...
#[inline]
unsafe extern fn v4l2_probe_formats(mut vdo: *mut zbar_video_t) -> libc::c_int {
    ...
    if _zbar_verbosity >= 2 as libc::c_int {
        fprintf(
            ...
            (*::std::mem::transmute::<&[u8; 19], &[libc::c_char; 19]>(b"v4l2_probe_formats\x00"))
                .as_ptr(),
        );
    }
    let mut desc: v4l2_fmtdesc = v4l2_fmtdesc {
        index: 0,
        type_0: 0,
        flags: 0,
        description: [0; 32],
    ...
    memset(
        &mut desc as *mut v4l2_fmtdesc as *mut libc::c_void,
        0 as libc::c_int,
    ...
    while desc.index < 64 as libc::c_int as libc::c_uint {
        if ioctl(
            ...
            ((2 as libc::c_uint | 1 as libc::c_uint)
                << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int + 14 as libc::c_int
                | (('V' as i32) << 0 as libc::c_int + 8 as libc::c_int) as libc::c_uint
                | ((2 as libc::c_int) << 0 as libc::c_int) as libc::c_uint)
                as libc::c_ulong
                | (::std::mem::size_of::<v4l2_fmtdesc>() as libc::c_ulong)
                    << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int,
            &mut desc as *mut v4l2_fmtdesc,
        ) < 0 as libc::c_int
        {
            break;
        }
        ...
        if desc.flags & 0x2 as libc::c_int as libc::c_uint != 0 {
            (*vdo).emu_formats = realloc(
                (*vdo).emu_formats as *mut libc::c_void,
                ((n_emu_formats + 2 as libc::c_int) as libc::c_ulong)
            ...
            *(*vdo).emu_formats.offset(fresh0 as isize) = desc.pixelformat
            ...
            (*vdo).formats = realloc(
                (*vdo).formats as *mut libc::c_void,
                ((n_formats + 2 as libc::c_int) as libc::c_ulong)
                    .wrapping_mul(::std::mem::size_of::<uint32_t>() as libc::c_ulong),
            ) as *mut uint32_t;
        ...
        if (*vdo).width == 0 || (*vdo).height == 0 {
            v4l2_max_size(vdo, desc.pixelformat, &mut max_width, &mut max_height);
        }
    ...
    if (*vdo).width == 0 || (*vdo).height == 0 {
        ...
        if max_width != 0 && max_height != 0 {
            ...
            (*vdo).width = (640 as libc::c_int * 64 as libc::c_int) as libc::c_uint;
            (*vdo).height = (480 as libc::c_int * 64 as libc::c_int) as libc::c_uint
        }
    }
    if desc.index == 0 {
        return err_capture(
            ...
            (*::std::mem::transmute::<&[u8; 19], &[libc::c_char; 19]>(b"v4l2_probe_formats\x00"))
                .as_ptr(),
            b"enumerating video formats (VIDIOC_ENUM_FMT)\x00" as *const u8 as *const libc::c_char,
        );
    }
    if !(*vdo).formats.is_null() {
        *(*vdo).formats.offset(n_formats as isize) = 0 as libc::c_int as uint32_t
    }
    if !(*vdo).emu_formats.is_null() {
        *(*vdo).emu_formats.offset(n_emu_formats as isize) = 0 as libc::c_int as uint32_t
    }
    ...
    let mut fmt: v4l2_format = v4l2_format {
        type_0: 0,
        fmt: C2RustUnnamed_8 {
            pix: v4l2_pix_format {
                width: 0,
    ...
    memset(
        &mut fmt as *mut v4l2_format as *mut libc::c_void,
        0 as libc::c_int,
        ::std::mem::size_of::<v4l2_format>() as libc::c_ulong,
    );
    ...
    ) < 0 as libc::c_int
    {
        return err_capture(
            ...
            (*::std::mem::transmute::<&[u8; 19], &[libc::c_char; 19]>(b"v4l2_probe_formats\x00"))
                .as_ptr(),
            b"querying current video format (VIDIO_G_FMT)\x00" as *const u8 as *const libc::c_char,
        );
    }
    if _zbar_verbosity >= 1 as libc::c_int {
        fprintf(
            ...
            (*pix).width,
            (*pix).height,
            if (*pix).field != V4L2_FIELD_NONE as libc::c_int as libc::c_uint {
    ...
    let mut maxfmt: v4l2_format = v4l2_format {
        type_0: 0,
        fmt: C2RustUnnamed_8 {
            pix: v4l2_pix_format {
                width: 0,
    ...
    memcpy(
        &mut maxfmt as *mut v4l2_format as *mut libc::c_void,
    ...
    ) < 0 as libc::c_int
    {
        return err_capture(
            ...
            (*::std::mem::transmute::<&[u8; 19], &[libc::c_char; 19]>(b"v4l2_probe_formats\x00"))
                .as_ptr(),
            b"querying current video format (VIDIOC_G_FMT)\x00" as *const u8 as *const libc::c_char,
        );
    }
    if _zbar_verbosity >= 1 as libc::c_int {
        fprintf(
...
#[inline]
unsafe extern fn v4l2_reset_crop(mut vdo: *mut zbar_video_t) -> libc::c_int {
    /* check cropping */
    let mut ccap: v4l2_cropcap = v4l2_cropcap {
        type_0: 0,
        bounds: v4l2_rect {
            left: 0,
            top: 0,
    ...
    memset(
        &mut ccap as *mut v4l2_cropcap as *mut libc::c_void,
        0 as libc::c_int,
    ...
    if ioctl(
        ...
        ((2 as libc::c_uint | 1 as libc::c_uint)
            << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int + 14 as libc::c_int
            | (('V' as i32) << 0 as libc::c_int + 8 as libc::c_int) as libc::c_uint
            | ((58 as libc::c_int) << 0 as libc::c_int) as libc::c_uint) as libc::c_ulong
            | (::std::mem::size_of::<v4l2_cropcap>() as libc::c_ulong)
                << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int,
        &mut ccap as *mut v4l2_cropcap,
    ) < 0 as libc::c_int
    {
        return err_capture(
            vdo as *const libc::c_void,
            SEV_ERROR,
            ZBAR_ERR_SYSTEM,
            (*::std::mem::transmute::<&[u8; 16], &[libc::c_char; 16]>(b"v4l2_reset_crop\x00"))
                .as_ptr(),
            b"querying crop support (VIDIOC_CROPCAP)\x00" as *const u8 as *const libc::c_char,
        );
    }
    if _zbar_verbosity >= 1 as libc::c_int {
        fprintf(
    ...
    if _zbar_verbosity >= 1 as libc::c_int {
        fprintf(
            ...
            ccap.defrect.left,
            ccap.defrect.top,
            ccap.pixelaspect.numerator,
            ccap.pixelaspect.denominator,
        );
    }
    /* reset crop parameters */
    let mut crop: v4l2_crop = v4l2_crop {
        type_0: 0,
        c: v4l2_rect {
            left: 0,
            top: 0,
    ...
    memset(
        &mut crop as *mut v4l2_crop as *mut libc::c_void,
        0 as libc::c_int,
    ...
    if ioctl(
        ...
        ((1 as libc::c_uint)
            << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int + 14 as libc::c_int
            | (('V' as i32) << 0 as libc::c_int + 8 as libc::c_int) as libc::c_uint
            | ((60 as libc::c_int) << 0 as libc::c_int) as libc::c_uint) as libc::c_ulong
            | (::std::mem::size_of::<v4l2_crop>() as libc::c_ulong)
                << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int,
        &mut crop as *mut v4l2_crop,
    ) < 0 as libc::c_int
        && *__errno_location() != 22 as libc::c_int
    {
        return err_capture(
            ...
            (*::std::mem::transmute::<&[u8; 16], &[libc::c_char; 16]>(b"v4l2_reset_crop\x00"))
                .as_ptr(),
            b"setting default crop window (VIDIOC_S_CROP)\x00" as *const u8 as *const libc::c_char,
        );
    }
    return 0 as libc::c_int;
}
unsafe extern fn v4l2_ctrl_type(mut type_0: uint32_t) -> *const libc::c_char {
    match type_0 {
        1 => {
...
unsafe extern fn v4l2_ctrl_class(mut class: uint32_t) -> *const libc::c_char {
    match class {
        9961472 => {
            // All classes below are available since, at least, Kernel 2.6.31
            return b"User\x00" as *const u8 as *const libc::c_char;
        }
        10027008 => return b"MPEG-compression\x00" as *const u8 as *const libc::c_char,
        10092544 => return b"Camera\x00" as *const u8 as *const libc::c_char,
        10158080 => return b"FM Modulator\x00" as *const u8 as *const libc::c_char,
        10223616 => {
            // Newer classes added up to Kernel 3.16
            return b"Camera flash\x00" as *const u8 as *const libc::c_char;
        }
        10289152 => return b"JPEG-compression\x00" as *const u8 as *const libc::c_char,
        10354688 => return b"Image source\x00" as *const u8 as *const libc::c_char,
        10420224 => return b"Image processing\x00" as *const u8 as *const libc::c_char,
        10485760 => return b"Digital Video\x00" as *const u8 as *const libc::c_char,
        10551296 => return b"FM Receiver\x00" as *const u8 as *const libc::c_char,
        10616832 => return b"RF tuner\x00" as *const u8 as *const libc::c_char,
        10682368 => return b"Detection\x00" as *const u8 as *const libc::c_char,
        _ => return b"Unknown\x00" as *const u8 as *const libc::c_char,
    };
}
// return values: 1: ignore, 0: added, -1: silently ignore
unsafe extern fn v4l2_add_control(
    mut vdo: *mut zbar_video_t,
    mut query: *mut v4l2_query_ext_ctrl,
    mut ptr: *mut *mut video_controls_priv_s,
) -> libc::c_int {
    ...
    if (*query).type_0 == V4L2_CTRL_TYPE_CTRL_CLASS as libc::c_int as libc::c_uint {
        return -(1 as libc::c_int);
    }
    ...
    if (*vdo).controls.is_null() {
        *ptr = calloc(
            ...
            ::std::mem::size_of::<video_controls_priv_s>() as libc::c_ulong,
        ) as *mut video_controls_priv_s;
    ...
    // Fill control data
    (**ptr).id = (*query).id;
    (**ptr).s.name = strdup((*query).name.as_mut_ptr() as *const libc::c_char);
    (**ptr).s.group = strdup(v4l2_ctrl_class(
        ((*query).id as libc::c_ulong & 0xfff0000 as libc::c_ulong) as uint32_t,
    ));
    match (*query).type_0 {
        1 => {
        ...
        4 => {
            (**ptr).s.type_0 = VIDEO_CNTL_BUTTON;
            return 0 as libc::c_int;
        }
        7 => {
            (**ptr).s.type_0 = VIDEO_CNTL_STRING;
            return 0 as libc::c_int;
        }
        3 => {
            let mut menu: v4l2_querymenu = v4l2_querymenu {
                id: 0,
                index: 0,
            ...
            let mut first: *mut video_control_menu_s = 0 as *mut video_control_menu_s;
            let mut p: *mut video_control_menu_s = 0 as *mut video_control_menu_s;
            let mut n_menu: libc::c_int = 0 as libc::c_int;
            memset(
                &mut menu as *mut v4l2_querymenu as *mut libc::c_void,
                0 as libc::c_int,
                ...
                if ioctl(
                    ...
                    ((2 as libc::c_uint | 1 as libc::c_uint)
                        << 0 as libc::c_int
                            ...
                            + 14 as libc::c_int
                        | (('V' as i32) << 0 as libc::c_int + 8 as libc::c_int) as libc::c_uint
                        | ((37 as libc::c_int) << 0 as libc::c_int) as libc::c_uint)
                        as libc::c_ulong
                        | (::std::mem::size_of::<v4l2_querymenu>() as libc::c_ulong)
                            << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int,
                    &mut menu as *mut v4l2_querymenu,
                ) == 0
                {
                    first = realloc(
                        first as *mut libc::c_void,
                        ((n_menu + 1 as libc::c_int) as libc::c_ulong).wrapping_mul(
                            ::std::mem::size_of::<video_control_menu_t>() as libc::c_ulong,
                        ),
                    ) as *mut video_control_menu_s;
                    p = &mut *first.offset(n_menu as isize) as *mut video_control_menu_s;
                    (*p).value = menu.index as int64_t;
                    (*p).name =
                        strdup(menu.c2rust_unnamed.name.as_mut_ptr() as *const libc::c_char);
                    n_menu += 1
                }
...
#[no_mangle]
pub unsafe extern fn v4l2_free_controls(mut vdo: *mut zbar_video_t) {
    let mut i: libc::c_int = 0;
    if !(*vdo).controls.is_null() {
        ...
        while !p.is_null() {
            ...
            if !(*p).menu.is_null() {
                ...
                while (i as libc::c_uint) < (*p).menu_size {
                    free((*(*p).menu.offset(i as isize)).name as *mut libc::c_void);
                    i += 1
                }
...
unsafe extern fn v4l2_query_controls(mut vdo: *mut zbar_video_t) -> libc::c_int {
    let mut ptr: *mut video_controls_priv_s = 0 as *mut video_controls_priv_s;
    let mut query: v4l2_query_ext_ctrl = v4l2_query_ext_ctrl {
        id: 0,
        type_0: 0,
        name: [0; 32],
        minimum: 0,
    ...
    memset(
        &mut query as *mut v4l2_query_ext_ctrl as *mut libc::c_void,
        0 as libc::c_int,
    ...
    while ioctl(
        ...
        ((2 as libc::c_uint | 1 as libc::c_uint)
            << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int + 14 as libc::c_int
            | (('V' as i32) << 0 as libc::c_int + 8 as libc::c_int) as libc::c_uint
            | ((103 as libc::c_int) << 0 as libc::c_int) as libc::c_uint) as libc::c_ulong
            | (::std::mem::size_of::<v4l2_query_ext_ctrl>() as libc::c_ulong)
                << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int,
        &mut query as *mut v4l2_query_ext_ctrl,
    ) == 0
    {
        ignore = v4l2_add_control(vdo, &mut query, &mut ptr);
        if ignore >= 0 as libc::c_int && _zbar_verbosity != 0 {
            let mut i: libc::c_int = 0;
            let mut class: *const libc::c_char = v4l2_ctrl_class(
                (query.id as libc::c_ulong & 0xfff0000 as libc::c_ulong) as uint32_t,
            );
            if class != old_class {
                if _zbar_verbosity >= 1 as libc::c_int {
            ...
            if _zbar_verbosity >= 1 as libc::c_int {
                fprintf(
                    ...
                    .as_ptr(),
                    v4l2_ctrl_type(query.type_0),
                    query.name.as_mut_ptr(),
                    query.id,
                    if ignore != 0 {
 ...
 */
unsafe extern fn v4l2_g_control_def(
    mut vdo: *mut zbar_video_t,
    mut name: *const libc::c_char,
) -> *mut video_controls_priv_s {
    let mut p: *mut video_controls_priv_s =
        (*vdo).controls as *mut libc::c_void as *mut video_controls_priv_s; // we have no such a control on the list
    while !p.is_null() {
    ...
    if (*p).s.name.is_null() {
        if _zbar_verbosity >= 1 as libc::c_int {
            fprintf(
                stderr,
                b"%s: Control not found: %s\x00" as *const u8 as *const libc::c_char,
                (*::std::mem::transmute::<&[u8; 19], &[libc::c_char; 19]>(
                    b"v4l2_g_control_def\x00",
                ))
                .as_ptr(),
                name,
            );
...
unsafe extern fn v4l2_s_control(
    mut vdo: *mut zbar_video_t,
    mut name: *const libc::c_char,
    mut value: *mut libc::c_void,
) -> libc::c_int {
    let mut ctrls: v4l2_ext_controls = v4l2_ext_controls {
    ...
    let mut c: v4l2_ext_control = v4l2_ext_control {
        id: 0,
        size: 0,
        reserved2: [0; 1],
    ...
    memset(
        &mut ctrls as *mut v4l2_ext_controls as *mut libc::c_void,
        0 as libc::c_int,
    ...
    memset(
        &mut c as *mut v4l2_ext_control as *mut libc::c_void,
        0 as libc::c_int,
        ::std::mem::size_of::<v4l2_ext_control>() as libc::c_ulong,
    );
    c.id = (*p).id;
    match (*p).s.type_0 as libc::c_uint {
        1 | 6 | 3 | 2 => c.c2rust_unnamed.value = *(value as *mut libc::c_int),
        _ => return ZBAR_ERR_UNSUPPORTED as libc::c_int,
    }
    let mut rv: libc::c_int = ioctl(
        (*vdo).fd,
        ((2 as libc::c_uint | 1 as libc::c_uint)
            << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int + 14 as libc::c_int
            | (('V' as i32) << 0 as libc::c_int + 8 as libc::c_int) as libc::c_uint
            | ((72 as libc::c_int) << 0 as libc::c_int) as libc::c_uint) as libc::c_ulong
            | (::std::mem::size_of::<v4l2_ext_controls>() as libc::c_ulong)
                << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int,
        ...
        if _zbar_verbosity >= 1 as libc::c_int {
            fprintf(
                ...
                b"%s: v4l2 set user control \"%s\" returned %d\n\x00" as *const u8
                    as *const libc::c_char,
                (*::std::mem::transmute::<&[u8; 15], &[libc::c_char; 15]>(b"v4l2_s_control\x00"))
                    .as_ptr(),
                (*p).s.name,
                rv,
            );
    ...
    if _zbar_verbosity >= 1 as libc::c_int {
        fprintf(
            ...
            name,
            (*p).id,
            *(value as *mut libc::c_int),
        );
    }
    return 0 as libc::c_int;
}
unsafe extern fn v4l2_g_control(
    mut vdo: *mut zbar_video_t,
    mut name: *const libc::c_char,
    mut value: *mut libc::c_void,
) -> libc::c_int {
    ...
    let mut rv: libc::c_int = ioctl(
        ...
        ((2 as libc::c_uint | 1 as libc::c_uint)
            << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int + 14 as libc::c_int
            | (('V' as i32) << 0 as libc::c_int + 8 as libc::c_int) as libc::c_uint
            | ((71 as libc::c_int) << 0 as libc::c_int) as libc::c_uint) as libc::c_ulong
            | (::std::mem::size_of::<v4l2_ext_controls>() as libc::c_ulong)
                << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int,
        &mut ctrls as *mut v4l2_ext_controls,
    );
        ...
        if _zbar_verbosity >= 1 as libc::c_int {
            fprintf(
                ...
                b"%s: v4l2 get user control \"%s\" returned %d\n\x00" as *const u8
                    as *const libc::c_char,
                (*::std::mem::transmute::<&[u8; 15], &[libc::c_char; 15]>(b"v4l2_g_control\x00"))
                    .as_ptr(),
                (*p).s.name,
                rv,
            );
            ...
            if _zbar_verbosity >= 1 as libc::c_int {
                fprintf(
                    ...
                    (*::std::mem::transmute::<&[u8; 15], &[libc::c_char; 15]>(
                        b"v4l2_g_control\x00",
                    ))
                    .as_ptr(),
                    (*p).s.name,
                    c.c2rust_unnamed.value,
                );
            }
            return 0 as libc::c_int;
        }
...
#[no_mangle]
pub unsafe extern fn _zbar_v4l2_probe(mut vdo: *mut zbar_video_t) -> libc::c_int {
    /* check capabilities */
    let mut vcap: v4l2_capability = v4l2_capability {
        driver: [0; 16],
        card: [0; 32],
        bus_info: [0; 32],
        version: 0,
    ...
    memset(
        &mut vcap as *mut v4l2_capability as *mut libc::c_void,
        0 as libc::c_int,
    ...
    if ioctl(
        ...
        ((2 as libc::c_uint)
            ...
            | (::std::mem::size_of::<v4l2_capability>() as libc::c_ulong)
                << 0 as libc::c_int + 8 as libc::c_int + 8 as libc::c_int,
        &mut vcap as *mut v4l2_capability,
    ) < 0 as libc::c_int
    {
        return err_capture(
            vdo as *const libc::c_void,
            ...
            (*::std::mem::transmute::<&[u8; 17], &[libc::c_char; 17]>(b"_zbar_v4l2_probe\x00"))
                .as_ptr(),
            b"video4linux version 2 not supported (VIDIOC_QUERYCAP)\x00" as *const u8
                as *const libc::c_char,
        );
    }
    if _zbar_verbosity >= 1 as libc::c_int {
        fprintf(
            ...
            if vcap.bus_info[0 as libc::c_int as usize] as libc::c_int != 0 {
                vcap.bus_info.as_mut_ptr() as *mut libc::c_char
            } else {
                b"<unknown>\x00" as *const u8 as *const libc::c_char
            },
            vcap.driver.as_mut_ptr(),
            vcap.version >> 16 as libc::c_int & 0xff as libc::c_int as libc::c_uint,
            vcap.version >> 8 as libc::c_int & 0xff as libc::c_int as libc::c_uint,
    ...
    if _zbar_verbosity >= 1 as libc::c_int {
        fprintf(
            ...
            if vcap.capabilities & 0x1000000 as libc::c_int as libc::c_uint != 0 {
                b" READWRITE\x00" as *const u8 as *const libc::c_char
            } else {
                b"\x00" as *const u8 as *const libc::c_char
            },
            if vcap.capabilities & 0x4000000 as libc::c_int as libc::c_uint != 0 {
    ...
    if vcap.capabilities & 0x1 as libc::c_int as libc::c_uint == 0
        || vcap.capabilities & (0x1000000 as libc::c_int | 0x4000000 as libc::c_int) as libc::c_uint
            == 0
    {
        return err_capture(
            vdo as *const libc::c_void,
            ...
            (*::std::mem::transmute::<&[u8; 17], &[libc::c_char; 17]>(b"_zbar_v4l2_probe\x00"))
                .as_ptr(),
            b"v4l2 device does not support usable CAPTURE\x00" as *const u8 as *const libc::c_char,
        );
    }
    (v4l2_reset_crop(vdo)) != 0;
    if v4l2_probe_formats(vdo) != 0 {
        return -(1 as libc::c_int);
    }
    if v4l2_query_controls(vdo) != 0 {
        return -(1 as libc::c_int);
    }
    ...
    if _zbar_verbosity >= 1 as libc::c_int {
        fprintf(
            ...
            if (*vdo).iomode as libc::c_uint == VIDEO_READWRITE as libc::c_int as libc::c_uint {
                b"READWRITE\x00" as *const u8 as *const libc::c_char
            } else if (*vdo).iomode as libc::c_uint == VIDEO_MMAP as libc::c_int as libc::c_uint {
                b"MMAP\x00" as *const u8 as *const libc::c_char
            } else if (*vdo).iomode as libc::c_uint == VIDEO_USERPTR as libc::c_int as libc::c_uint
            {
    ...
    (*vdo).intf = VIDEO_V4L2;
    (*vdo).init =
        Some(v4l2_init as unsafe extern fn(_: *mut zbar_video_t, _: uint32_t) -> libc::c_int);
    (*vdo).cleanup = Some(v4l2_cleanup as unsafe extern fn(_: *mut zbar_video_t) -> libc::c_int);
    (*vdo).start = Some(v4l2_start as unsafe extern fn(_: *mut zbar_video_t) -> libc::c_int);
    (*vdo).stop = Some(v4l2_stop as unsafe extern fn(_: *mut zbar_video_t) -> libc::c_int);
    (*vdo).nq = Some(
        v4l2_nq as unsafe extern fn(_: *mut zbar_video_t, _: *mut zbar_image_t) -> libc::c_int,
    );
    (*vdo).dq = Some(v4l2_dq as unsafe extern fn(_: *mut zbar_video_t) -> *mut zbar_image_t);
    (*vdo).set_control = Some(
        v4l2_s_control
            as unsafe extern fn(
                _: *mut zbar_video_t,
                _: *const libc::c_char,
    ...
    (*vdo).free = Some(v4l2_free_controls as unsafe extern fn(_: *mut zbar_video_t) -> ());
    return 0 as libc::c_int;
}
