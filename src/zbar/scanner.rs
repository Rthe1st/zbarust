...
/* last element width */
#[no_mangle]
pub unsafe extern "C" fn zbar_scanner_create(mut dcode: *mut zbar_decoder_t)
 -> *mut zbar_scanner_t {
    let mut scn: *mut zbar_scanner_t =
        malloc(::std::mem::size_of::<zbar_scanner_t>() as libc::c_ulong) as
            *mut zbar_scanner_t;
    (*scn).decoder = dcode;
...
#[no_mangle]
pub unsafe extern "C" fn zbar_scanner_destroy(mut scn: *mut zbar_scanner_t) {
    free(scn as *mut libc::c_void);
}
#[no_mangle]
pub unsafe extern "C" fn zbar_scanner_reset(mut scn: *mut zbar_scanner_t)
 -> zbar_symbol_type_t {
    memset(&mut (*scn).x as *mut libc::c_uint as *mut libc::c_void,
           0 as libc::c_int,
           (::std::mem::size_of::<zbar_scanner_t>() as
                libc::c_ulong).wrapping_sub(12 as libc::c_ulong));
    (*scn).y1_thresh = (*scn).y1_min_thresh;
    if !(*scn).decoder.is_null() { zbar_decoder_reset((*scn).decoder); }
    return ZBAR_NONE;
}
...
#[no_mangle]
pub unsafe extern "C" fn zbar_scanner_get_width(mut scn:
                                                    *const zbar_scanner_t)
 -> libc::c_uint {
    return (*scn).width;
}
 ...
 */
#[no_mangle]
pub unsafe extern "C" fn zbar_scanner_get_edge(mut scn: *const zbar_scanner_t,
                                               mut offset: libc::c_uint,
                                               mut prec: libc::c_int)
 -> libc::c_uint {
    let mut edge: libc::c_uint =
        (*scn).last_edge.wrapping_sub(offset).wrapping_sub(((1 as libc::c_int)
                                                                <<
                                                                5 as
                                                                    libc::c_int)
                                                               as
    ...
    if prec > 0 as libc::c_int {
        return edge >> prec
    } else if prec == 0 { return edge } else { return edge << -prec };
}
/* * retrieve last scanned color. */
#[no_mangle]
pub unsafe extern "C" fn zbar_scanner_get_color(mut scn:
                                                    *const zbar_scanner_t)
 -> zbar_color_t {
    return if (*scn).y1_sign <= 0 as libc::c_int {
               ZBAR_SPACE as libc::c_int
           } else { ZBAR_BAR as libc::c_int } as zbar_color_t;
}
#[inline]
unsafe extern "C" fn calc_thresh(mut scn: *mut zbar_scanner_t)
 -> libc::c_uint {
    ...
    if thresh as libc::c_ulong > t {
        thresh =
            (thresh as libc::c_ulong).wrapping_sub(t) as libc::c_uint as
                libc::c_uint;
...
#[inline]
unsafe extern "C" fn process_edge(mut scn: *mut zbar_scanner_t,
                                  mut y1: libc::c_int) -> zbar_symbol_type_t {
    if (*scn).y1_sign == 0 {
        (*scn).cur_edge =
    ...
    } else if (*scn).last_edge == 0 { (*scn).last_edge = (*scn).cur_edge }
...
#[inline]
#[linkage = "external"]
pub unsafe extern "C" fn zbar_scanner_flush(mut scn: *mut zbar_scanner_t)
 -> zbar_symbol_type_t {
    let mut x: libc::c_uint = 0;
    if (*scn).y1_sign == 0 { return ZBAR_NONE }
    x =
        ((*scn).x <<
             5 as
                 libc::c_int).wrapping_add(((1 as libc::c_int) <<
                                                5 as libc::c_int -
                                                    1 as libc::c_int) as
                                               libc::c_uint);
    ...
    if !(*scn).decoder.is_null() {
        return zbar_decode_width((*scn).decoder,
                                 0 as libc::c_int as libc::c_uint)
    }
    return ZBAR_PARTIAL;
}
#[no_mangle]
pub unsafe extern "C" fn zbar_scanner_new_scan(mut scn: *mut zbar_scanner_t)
 -> zbar_symbol_type_t {
    ...
    memset(&mut (*scn).x as *mut libc::c_uint as *mut libc::c_void,
           ...
           (::std::mem::size_of::<zbar_scanner_t>() as
                libc::c_ulong).wrapping_sub(12 as libc::c_ulong));
    (*scn).y1_thresh = (*scn).y1_min_thresh;
    if !(*scn).decoder.is_null() { zbar_decoder_new_scan((*scn).decoder); }
    return edge;
}
#[no_mangle]
pub unsafe extern "C" fn zbar_scan_y(mut scn: *mut zbar_scanner_t,
                                     mut y: libc::c_int)
 -> zbar_symbol_type_t {
    /* FIXME calc and clip to max y range... */
    /* retrieve short value history */
    let mut x: libc::c_int = (*scn).x as libc::c_int;
    let mut y0_1: libc::c_int =
        (*scn).y0[(x - 1 as libc::c_int & 3 as libc::c_int) as usize];
    ...
    if x != 0 {
        ...
        y0_0 +=
            ((y - y0_1) as
                 libc::c_uint).wrapping_mul(((0.78f64 *
                                                  ((1 as libc::c_int) <<
                                                       5 as libc::c_int +
                                                           1 as libc::c_int)
                                                      as libc::c_double +
        ...
        (*scn).y0[2 as libc::c_int as usize] =
            (*scn).y0[3 as libc::c_int as usize];
        (*scn).y0[1 as libc::c_int as usize] =
            (*scn).y0[2 as libc::c_int as usize];
        (*scn).y0[0 as libc::c_int as usize] =
            (*scn).y0[1 as libc::c_int as usize];
    ...
    if abs(y1_1) < abs(y1_2) &&
           (y1_1 >= 0 as libc::c_int) as libc::c_int ==
               (y1_2 >= 0 as libc::c_int) as libc::c_int {
        y1_1 = y1_2
    }
    ...
    if (y2_1 == 0 ||
            (if y2_1 > 0 as libc::c_int {
             ...
             } else { (y2_2 > 0 as libc::c_int) as libc::c_int }) != 0) &&
           calc_thresh(scn) <= abs(y1_1) as libc::c_uint {
        /* check for 1st sign change */
        let mut y1_rev: libc::c_char =
            if (*scn).y1_sign > 0 as libc::c_int {
                (y1_1 < 0 as libc::c_int) as libc::c_int
            } else { (y1_1 > 0 as libc::c_int) as libc::c_int } as
                libc::c_char;
        if y1_rev != 0 {
        ...
        if y1_rev as libc::c_int != 0 || abs((*scn).y1_sign) < abs(y1_1) {
            ...
            (*scn).y1_thresh =
                (abs(y1_1) as
                     libc::c_uint).wrapping_mul(((0.44f64 *
                                                      ((1 as libc::c_int) <<
                                                           5 as libc::c_int +
                                                               1 as
                                                                   libc::c_int)
            ...
            if d == 0 {
                ...
                (*scn).cur_edge =
                    (*scn).cur_edge.wrapping_sub((((y2_1 << 5 as libc::c_int)
                                                       + 1 as libc::c_int) /
                                                      d) as libc::c_uint)
            }
            (*scn).cur_edge =
                (*scn).cur_edge.wrapping_add((x << 5 as libc::c_int) as
                                                 libc::c_uint)
        }
    }
...
#[no_mangle]
pub unsafe extern "C" fn zbar_scanner_get_state(mut scn:
                                                    *const zbar_scanner_t,
                                                ...
                                                mut y1_thresh:
                                                    *mut libc::c_int) {
    let mut y0_0: libc::c_int =
        (*scn).y0[((*scn).x.wrapping_sub(1 as libc::c_int as libc::c_uint) &
                       3 as libc::c_int as libc::c_uint) as usize];
    let mut y0_1: libc::c_int =
        (*scn).y0[((*scn).x.wrapping_sub(2 as libc::c_int as libc::c_uint) &
                       3 as libc::c_int as libc::c_uint) as usize];
    let mut y0_2: libc::c_int =
        (*scn).y0[((*scn).x.wrapping_sub(3 as libc::c_int as libc::c_uint) &
                       3 as libc::c_int as libc::c_uint) as usize];
    let mut mut_scn: *mut zbar_scanner_t = 0 as *mut zbar_scanner_t;
    if !x.is_null() {
        *x = (*scn).x.wrapping_sub(1 as libc::c_int as libc::c_uint)
    }
    if !last_edge.is_null() { *last_edge = (*scn).last_edge }
    if !y0.is_null() { *y0 = y0_1 }
    if !y1.is_null() { *y1 = y0_1 - y0_2 }
    if !y2.is_null() { *y2 = y0_0 - y0_1 * 2 as libc::c_int + y0_2 }
