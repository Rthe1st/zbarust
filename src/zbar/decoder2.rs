...
#[inline]
unsafe extern fn ean_reset(mut ean: *mut ean_decoder_t) {
    ean_new_scan(ean);
    (*ean).right = ZBAR_NONE;
    (*ean).left = (*ean).right;
}
#[inline]
unsafe extern fn ean_new_scan(mut ean: *mut ean_decoder_t) {
    (*ean).pass[1 as libc::c_int as usize].state = -(1 as libc::c_int) as libc::c_schar;
    (*ean).pass[0 as libc::c_int as usize].state = (*ean).pass[1 as libc::c_int as usize].state;
    (*ean).pass[3 as libc::c_int as usize].state = -(1 as libc::c_int) as libc::c_schar;
    (*ean).pass[2 as libc::c_int as usize].state = (*ean).pass[3 as libc::c_int as usize].state;
...
#[inline]
unsafe extern fn databar_new_scan(mut db: *mut databar_decoder_t) {
    let mut i: libc::c_int = 0;
    i = 0 as libc::c_int;
    while i < 16 as libc::c_int {
        if (*db).chars[i as usize] as libc::c_int >= 0 as libc::c_int {
            let mut seg: *mut databar_segment_t =
                (*db).segs.offset((*db).chars[i as usize] as libc::c_int as isize);
            if (*seg).partial() != 0 {
...
#[inline]
unsafe extern fn databar_reset(mut db: *mut databar_decoder_t) {
    let mut i: libc::c_int = 0;
...
#[inline]
unsafe extern fn codabar_reset(mut codabar: *mut codabar_decoder_t) {
...
#[inline]
unsafe extern fn code39_reset(mut dcode39: *mut code39_decoder_t) {
...
#[inline]
unsafe extern fn code93_reset(mut dcode93: *mut code93_decoder_t) {
...
#[inline]
unsafe extern fn code128_reset(mut dcode128: *mut code128_decoder_t) {
...
#[inline]
unsafe extern fn qr_finder_reset(mut qrf: *mut qr_finder_t) {
    (*qrf).s5 = 0 as libc::c_int as libc::c_uint;
}
#[inline]
unsafe extern fn i25_reset(mut i25: *mut i25_decoder_t) {
...
/* memset, strlen */
#[no_mangle]
pub unsafe extern fn zbar_decoder_create() -> *mut zbar_decoder_t {
    let mut dcode: *mut zbar_decoder_t = calloc(
        1 as libc::c_int as libc::c_ulong,
        ::std::mem::size_of::<zbar_decoder_t>() as libc::c_ulong,
    ) as *mut zbar_decoder_t;
    (*dcode).buf_alloc = 0x20 as libc::c_int as libc::c_uint;
    (*dcode).buf = malloc((*dcode).buf_alloc as libc::c_ulong) as *mut libc::c_uchar;
    /* initialize default configs */
    (*dcode).ean.enable = 1 as libc::c_int as libc::c_schar;
    (*dcode).ean.ean13_config = ((1 as libc::c_int) << ZBAR_CFG_ENABLE as libc::c_int
        | (1 as libc::c_int) << ZBAR_CFG_EMIT_CHECK as libc::c_int)
        as libc::c_uint;
    (*dcode).ean.ean8_config = ((1 as libc::c_int) << ZBAR_CFG_ENABLE as libc::c_int
        | (1 as libc::c_int) << ZBAR_CFG_EMIT_CHECK as libc::c_int)
        as libc::c_uint;
    (*dcode).ean.upca_config =
        ((1 as libc::c_int) << ZBAR_CFG_EMIT_CHECK as libc::c_int) as libc::c_uint;
    ...
    (*dcode).ean.isbn13_config =
        ((1 as libc::c_int) << ZBAR_CFG_EMIT_CHECK as libc::c_int) as libc::c_uint;
    (*dcode).i25.config = ((1 as libc::c_int) << ZBAR_CFG_ENABLE as libc::c_int) as libc::c_uint;
    (*dcode).i25.configs
        [(ZBAR_CFG_MIN_LEN as libc::c_int - ZBAR_CFG_MIN_LEN as libc::c_int) as usize] =
        6 as libc::c_int;
    (*dcode).databar.config = ((1 as libc::c_int) << ZBAR_CFG_ENABLE as libc::c_int
        | (1 as libc::c_int) << ZBAR_CFG_EMIT_CHECK as libc::c_int)
        as libc::c_uint;
    (*dcode).databar.config_exp = ((1 as libc::c_int) << ZBAR_CFG_ENABLE as libc::c_int
        | (1 as libc::c_int) << ZBAR_CFG_EMIT_CHECK as libc::c_int)
        as libc::c_uint;
    (*dcode).databar.set_csegs(4 as libc::c_int as libc::c_uint);
    (*dcode).databar.segs = calloc(
        4 as libc::c_int as libc::c_ulong,
        ::std::mem::size_of::<databar_segment_t>() as libc::c_ulong,
    ) as *mut databar_segment_t;
    (*dcode).codabar.config =
        ((1 as libc::c_int) << ZBAR_CFG_ENABLE as libc::c_int) as libc::c_uint;
    (*dcode).codabar.configs
        [(ZBAR_CFG_MIN_LEN as libc::c_int - ZBAR_CFG_MIN_LEN as libc::c_int) as usize] =
        4 as libc::c_int;
    (*dcode).code39.config = ((1 as libc::c_int) << ZBAR_CFG_ENABLE as libc::c_int) as libc::c_uint;
    (*dcode).code39.configs
        [(ZBAR_CFG_MIN_LEN as libc::c_int - ZBAR_CFG_MIN_LEN as libc::c_int) as usize] =
        1 as libc::c_int;
    (*dcode).code93.config = ((1 as libc::c_int) << ZBAR_CFG_ENABLE as libc::c_int) as libc::c_uint;
    (*dcode).code128.config =
        ((1 as libc::c_int) << ZBAR_CFG_ENABLE as libc::c_int) as libc::c_uint;
    (*dcode).qrf.config = ((1 as libc::c_int) << ZBAR_CFG_ENABLE as libc::c_int) as libc::c_uint;
    zbar_decoder_reset(dcode);
    return dcode;
}
/* * destructor. */
#[no_mangle]
pub unsafe extern fn zbar_decoder_destroy(mut dcode: *mut zbar_decoder_t) {
    if !(*dcode).databar.segs.is_null() {
        free((*dcode).databar.segs as *mut libc::c_void);
    }
    if !(*dcode).buf.is_null() {
        free((*dcode).buf as *mut libc::c_void);
    }
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_decoder_reset(mut dcode: *mut zbar_decoder_t) {
    memset(
        dcode as *mut libc::c_void,
        0 as libc::c_int,
        (&mut (*dcode).buf_alloc as *mut libc::c_uint as libc::c_long - dcode as libc::c_long)
            as libc::c_ulong,
    );
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_decoder_new_scan(mut dcode: *mut zbar_decoder_t) {
    /* soft reset decoder */
    memset(
        (*dcode).w.as_mut_ptr() as *mut libc::c_void,
        0 as libc::c_int,
 ...
 * zbar_decode_width(). */
#[no_mangle]
pub unsafe extern fn zbar_decoder_get_color(mut dcode: *const zbar_decoder_t) -> zbar_color_t {
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_decoder_get_data(
    mut dcode: *const zbar_decoder_t,
) -> *const libc::c_char {
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_decoder_get_data_length(
    mut dcode: *const zbar_decoder_t,
) -> libc::c_uint {
    return (*dcode).buflen;
}
#[no_mangle]
pub unsafe extern fn zbar_decoder_get_direction(mut dcode: *const zbar_decoder_t) -> libc::c_int {
    return (*dcode).direction;
}
#[no_mangle]
pub unsafe extern fn zbar_decoder_set_handler(
    mut dcode: *mut zbar_decoder_t,
    mut handler: Option<zbar_decoder_handler_t>,
...
#[no_mangle]
pub unsafe extern fn zbar_decoder_set_userdata(
    mut dcode: *mut zbar_decoder_t,
...
#[no_mangle]
pub unsafe extern fn zbar_decoder_get_userdata(
    mut dcode: *const zbar_decoder_t,
) -> *mut libc::c_void {
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_decoder_get_type(mut dcode: *const zbar_decoder_t) -> zbar_symbol_type_t {
    return (*dcode).type_0;
}
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_decoder_get_modifiers(mut dcode: *const zbar_decoder_t) -> libc::c_uint {
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_decode_width(
    mut dcode: *mut zbar_decoder_t,
    mut w: libc::c_uint,
) -> zbar_symbol_type_t {
    let mut tmp: zbar_symbol_type_t = ZBAR_NONE;
    let mut sym: zbar_symbol_type_t = ZBAR_NONE;
    (*dcode).w[((*dcode).idx as libc::c_int & 16 as libc::c_int - 1 as libc::c_int) as usize] = w;
    /* update shared character width */
    (*dcode).s6 = (*dcode).s6.wrapping_sub(get_width(dcode, 7 as libc::c_int as libc::c_uchar));
    (*dcode).s6 = (*dcode).s6.wrapping_add(get_width(dcode, 1 as libc::c_int as libc::c_uchar));
    /* each decoder processes width stream in parallel */
    if (*dcode).qrf.config >> ZBAR_CFG_ENABLE as libc::c_int & 1 as libc::c_int as libc::c_uint != 0
        && {
            tmp = _zbar_find_qr(dcode);
            (tmp as libc::c_uint) > ZBAR_PARTIAL as libc::c_int as libc::c_uint
        }
    {
        sym = tmp
    }
    if (*dcode).ean.enable as libc::c_int != 0 && {
        ...
        (tmp as libc::c_uint) != 0
    } {
        sym = tmp
    }
    if (*dcode).code39.config >> ZBAR_CFG_ENABLE as libc::c_int & 1 as libc::c_int as libc::c_uint
        != 0
        && {
    ...
    if (*dcode).code93.config >> ZBAR_CFG_ENABLE as libc::c_int & 1 as libc::c_int as libc::c_uint
        != 0
        && {
    ...
    if (*dcode).code128.config >> ZBAR_CFG_ENABLE as libc::c_int & 1 as libc::c_int as libc::c_uint
        != 0
        && {
    ...
    if ((*dcode).databar.config | (*dcode).databar.config_exp) >> ZBAR_CFG_ENABLE as libc::c_int
    ...
    if (*dcode).codabar.config >> ZBAR_CFG_ENABLE as libc::c_int & 1 as libc::c_int as libc::c_uint
        != 0
        && {
    ...
    if (*dcode).i25.config >> ZBAR_CFG_ENABLE as libc::c_int & 1 as libc::c_int as libc::c_uint != 0
        && {
    ...
    if sym as u64 != 0 {
        if (*dcode).lock as libc::c_uint != 0
            && sym as libc::c_uint > ZBAR_PARTIAL as libc::c_int as libc::c_uint
            && sym as libc::c_uint != ZBAR_QRCODE as libc::c_int as libc::c_uint
        {
...
#[inline]
unsafe extern fn decoder_get_configp(
    mut dcode: *const zbar_decoder_t,
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_decoder_get_configs(
    mut dcode: *const zbar_decoder_t,
    mut sym: zbar_symbol_type_t,
) -> libc::c_uint {
...
#[inline]
unsafe extern fn decoder_set_config_bool(
    mut dcode: *mut zbar_decoder_t,
    mut sym: zbar_symbol_type_t,
    ...
    let mut config: *mut libc::c_uint =
        decoder_get_configp(dcode, sym) as *mut libc::c_void as *mut libc::c_uint;
    if config.is_null() || cfg as libc::c_uint >= ZBAR_CFG_NUM as libc::c_int as libc::c_uint {
    ...
    (*dcode).ean.enable = (((*dcode).ean.ean13_config
...
#[inline]
unsafe extern fn decoder_set_config_int(
    mut dcode: *mut zbar_decoder_t,
    mut sym: zbar_symbol_type_t,
    mut cfg: zbar_config_t,
    mut val: libc::c_int,
    ...
    match sym as libc::c_uint {
        25 => {
            (*dcode).i25.configs[(cfg as libc::c_uint)
                .wrapping_sub(ZBAR_CFG_MIN_LEN as libc::c_int as libc::c_uint)
                as usize] = val
        }
        38 => {
            (*dcode).codabar.configs[(cfg as libc::c_uint)
                .wrapping_sub(ZBAR_CFG_MIN_LEN as libc::c_int as libc::c_uint)
                as usize] = val
        }
        39 => {
            (*dcode).code39.configs[(cfg as libc::c_uint)
                .wrapping_sub(ZBAR_CFG_MIN_LEN as libc::c_int as libc::c_uint)
                as usize] = val
        }
        93 => {
            (*dcode).code93.configs[(cfg as libc::c_uint)
                .wrapping_sub(ZBAR_CFG_MIN_LEN as libc::c_int as libc::c_uint)
                as usize] = val
        }
        128 => {
            (*dcode).code128.configs[(cfg as libc::c_uint)
                .wrapping_sub(ZBAR_CFG_MIN_LEN as libc::c_int as libc::c_uint)
                as usize] = val
        }
 ...
 */
#[no_mangle]
pub unsafe extern fn zbar_decoder_set_config(
    mut dcode: *mut zbar_decoder_t,
    mut sym: zbar_symbol_type_t,
    mut cfg: zbar_config_t,
    mut val: libc::c_int,
    ...
    if sym as libc::c_uint == ZBAR_NONE as libc::c_int as libc::c_uint {
        ...
        let mut symp: *const zbar_symbol_type_t = 0 as *const zbar_symbol_type_t;
        symp = all.as_ptr();
        while *symp as u64 != 0 {
    ...
    } else if cfg as libc::c_uint >= ZBAR_CFG_MIN_LEN as libc::c_int as libc::c_uint
        && cfg as libc::c_uint <= ZBAR_CFG_MAX_LEN as libc::c_int as libc::c_uint
    {
...
static mut decoder_dump: *mut libc::c_char = 0 as *const libc::c_char as *mut libc::c_char;
static mut decoder_dumplen: libc::c_uint = 0 as libc::c_int as libc::c_uint;
#[no_mangle]
pub unsafe extern fn _zbar_decoder_buf_dump(
    mut buf: *mut libc::c_uchar,
    mut buflen: libc::c_uint,
) -> *const libc::c_char {
    let mut dumplen: libc::c_int = buflen
    ...
    p = decoder_dump.offset(snprintf(
        decoder_dump,
        12 as libc::c_int as libc::c_ulong,
        b"buf[%04x]=\x00" as *const u8 as *const libc::c_char,
        (if buflen > 0xffff as libc::c_int as libc::c_uint {
    ...
    while (i as libc::c_uint) < buflen {
        p = p.offset(snprintf(
            p,
            4 as libc::c_int as libc::c_ulong,
            b"%s%02x\x00" as *const u8 as *const libc::c_char,
            if i != 0 {
