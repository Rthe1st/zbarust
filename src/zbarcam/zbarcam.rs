...
extern {
     ...
     */
    #[no_mangle]
    fn zbar_processor_request_iomode(
    ...
    #[no_mangle]
    fn zbar_image_first_symbol(image: *const zbar_image_t) -> *const zbar_symbol_t;
    #[no_mangle]
    ...
    #[no_mangle]
    fn zbar_processor_request_interface(
        processor: *mut zbar_processor_t,
        version: libc::c_int,
    ) -> libc::c_int;
     ...
     */
    #[no_mangle]
    fn zbar_processor_force_format(
        processor: *mut zbar_processor_t,
 ...
 */
#[inline]
unsafe extern fn zbar_processor_error_spew(
    mut processor: *const zbar_processor_t,
...
#[inline]
unsafe extern fn zbar_processor_get_error_code(
    mut processor: *const zbar_processor_t,
) -> zbar_error_t {
...
static mut proc_0: *mut zbar_processor_t = 0 as *const zbar_processor_t as *mut zbar_processor_t;
static mut quiet: libc::c_int = 0 as libc::c_int;
static mut format: C2RustUnnamed = DEFAULT;
static mut xml_buf: *mut libc::c_char = 0 as *const libc::c_char as *mut libc::c_char;
static mut xml_len: libc::c_uint = 0 as libc::c_int as libc::c_uint;
unsafe extern fn usage(mut rc: libc::c_int) -> libc::c_int {
    let mut out: *mut FILE = if rc != 0 {
        stderr
    } else {
        stdout
    };
...
unsafe extern fn data_handler(mut img: *mut zbar_image_t, mut userdata: *const libc::c_void) {
    let mut sym: *const zbar_symbol_t = zbar_image_first_symbol(img);
    if !sym.is_null() {
    } else {
        __assert_fail(
            b"sym\x00" as *const u8 as *const libc::c_char,
            b"zbarcam/zbarcam.c\x00" as *const u8 as *const libc::c_char,
            98 as libc::c_int as libc::c_uint,
            (*::std::mem::transmute::<&[u8; 48], &[libc::c_char; 48]>(
                b"void data_handler(zbar_image_t *, const void *)\x00",
            ))
            .as_ptr(),
        );
    }
        ...
        if !(zbar_symbol_get_count(sym) != 0) {
            ...
            if !(type_0 as libc::c_uint == ZBAR_PARTIAL as libc::c_int as libc::c_uint) {
                if format as u64 == 0 {
                    ...
                    if fwrite(
                        zbar_symbol_get_data(sym) as *const libc::c_void,
                    ...
                    ) != 1 as libc::c_int as libc::c_ulong
                    {
                        ...
                        current_block_6 = 6009453772311597924;
                    }
                } else if format as libc::c_uint == RAW as libc::c_int as libc::c_uint {
                    if fwrite(
                        zbar_symbol_get_data(sym) as *const libc::c_void,
                        zbar_symbol_get_data_length(sym) as size_t,
                        1 as libc::c_int as size_t,
                ...
                } else if format as libc::c_uint == XML as libc::c_int as libc::c_uint {
                    if n == 0 {
                        printf(
                            b"<index num=\'%u\'>\n\x00" as *const u8 as *const libc::c_char,
...
unsafe fn main_0(mut argc: libc::c_int, mut argv: *mut *const libc::c_char) -> libc::c_int {
    ...
    zbar_processor_set_data_handler(
        proc_0,
        Some(data_handler as unsafe extern fn(_: *mut zbar_image_t, _: *const libc::c_void) -> ()),
        0 as *const libc::c_void,
    );
    let mut video_device: *const libc::c_char = b"\x00" as *const u8 as *const libc::c_char;
    ...
    while i < argc {
        ...
        } else if *(*argv.offset(i as isize)).offset(1 as libc::c_int as isize) as libc::c_int
            != '-' as i32
        {
            let mut j: libc::c_int = 0;
            j = 1 as libc::c_int;
            while *(*argv.offset(i as isize)).offset(j as isize) != 0 {
                if *(*argv.offset(i as isize)).offset(j as isize) as libc::c_int == 'S' as i32 {
                    j += 1;
            ...
            if i < argc - 1 as libc::c_int {
                video_device = *argv.offset((argc - 1 as libc::c_int) as isize)
            }
            break;
        } else if strcmp(
        ...
        ) == 0
        {
            ...
            ) == 0
            {
                ...
                ) == 0
                {
                    ...
                    if parse_config(
                        *argv.offset(i as isize),
                        i,
                        argc,
                        b"--set\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
                    ) != 0
                    {
                        return usage(1 as libc::c_int);
                    }
                ...
                {
                    if parse_config(
                        &*(*argv.offset(i as isize)).offset(6 as libc::c_int as isize),
                        i,
                        argc,
                        b"--set=\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
                    ) != 0
                ...
                ) == 0
                {
                    ...
                    *argv.offset(i as isize),
                    b"--nodisplay\x00" as *const u8 as *const libc::c_char,
                ) == 0
                {
                ...
                {
                    zbar_set_verbosity(strtol(
                        (*argv.offset(i as isize)).offset(10 as libc::c_int as isize),
                        0 as *mut *mut libc::c_char,
                        0 as libc::c_int,
                    ) as libc::c_int);
                } else if strncmp(
                    *argv.offset(i as isize),
                    b"--prescale=\x00" as *const u8 as *const libc::c_char,
                    11 as libc::c_int as libc::c_ulong,
                ) == 0
                {
                    let mut x: *mut libc::c_char = 0 as *mut libc::c_char;
                    let mut w: libc::c_long = strtol(
                        (*argv.offset(i as isize)).offset(11 as libc::c_int as isize),
                        &mut x,
                        10 as libc::c_int,
                    );
                    let mut h: libc::c_long = 0 as libc::c_int as libc::c_long;
                    ...
                    if w == 0 || h == 0 || x.is_null() || *x as libc::c_int != 'x' as i32 {
                        fprintf(
                            stderr,
                    ...
                    zbar_processor_request_size(proc_0, w as libc::c_uint, h as libc::c_uint);
                } else if strncmp(
                    *argv.offset(i as isize),
                    b"--v4l=\x00" as *const u8 as *const libc::c_char,
                    6 as libc::c_int as libc::c_ulong,
                ) == 0
                {
                    let mut v: libc::c_long = strtol(
                        (*argv.offset(i as isize)).offset(6 as libc::c_int as isize),
                        0 as *mut *mut libc::c_char,
                        0 as libc::c_int,
                    );
                    zbar_processor_request_interface(proc_0, v as libc::c_int);
                } else if strncmp(
                    *argv.offset(i as isize),
                    b"--iomode=\x00" as *const u8 as *const libc::c_char,
                    9 as libc::c_int as libc::c_ulong,
                ) == 0
                {
                    let mut v_0: libc::c_long = strtol(
                        (*argv.offset(i as isize)).offset(9 as libc::c_int as isize),
                        0 as *mut *mut libc::c_char,
                        0 as libc::c_int,
                    );
                    ...
                    *argv.offset(i as isize),
                    b"--infmt=\x00" as *const u8 as *const libc::c_char,
                    8 as libc::c_int as libc::c_ulong,
                ) == 0
                    && strlen(*argv.offset(i as isize)) == 12 as libc::c_int as libc::c_ulong
                {
                    infmt = (*(*argv.offset(i as isize)).offset(8 as libc::c_int as isize)
                        as libc::c_int
                        | (*(*argv.offset(i as isize)).offset(9 as libc::c_int as isize)
                            as libc::c_int)
                            << 8 as libc::c_int
                    ...
                    *argv.offset(i as isize),
                    b"--outfmt=\x00" as *const u8 as *const libc::c_char,
                    9 as libc::c_int as libc::c_ulong,
                ) == 0
                    && strlen(*argv.offset(i as isize)) == 13 as libc::c_int as libc::c_ulong
                {
                    outfmt = (*(*argv.offset(i as isize)).offset(9 as libc::c_int as isize)
                        as libc::c_int
                        | (*(*argv.offset(i as isize)).offset(10 as libc::c_int as isize)
                            as libc::c_int)
                            << 8 as libc::c_int
                        | (*(*argv.offset(i as isize)).offset(11 as libc::c_int as isize)
                            as libc::c_int)
                            << 16 as libc::c_int
                        | (*(*argv.offset(i as isize)).offset(12 as libc::c_int as isize)
                            as libc::c_int)
                            << 24 as libc::c_int) as libc::c_ulong
                } else {
                    fprintf(
    ...
    if zbar_processor_init(proc_0, video_device, display) != 0
        || display != 0 && zbar_processor_set_visible(proc_0, 1 as libc::c_int) != 0
    {
