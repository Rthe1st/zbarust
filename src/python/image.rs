...
*/
   ...
   cause an exception).  */
    #[no_mangle]
    fn PyString_AsStringAndSize(obj: *mut PyObject, s: *mut *mut libc::c_char,
                                len: *mut Py_ssize_t) -> libc::c_int;
    #[no_mangle]
    fn PyBuffer_FromMemory(ptr: *mut libc::c_void, size: Py_ssize_t)
     -> *mut PyObject;
    #[no_mangle]
 ...
 */
    #[no_mangle]
    fn zbar_image_convert_resize(image: *const zbar_image_t,
                                 format: libc::c_ulong, width: libc::c_uint,
                                 height: libc::c_uint) -> *mut zbar_image_t;
 ...
 */
    #[no_mangle]
    fn zbar_image_get_size(image: *const zbar_image_t,
 ...
 */
    #[no_mangle]
    fn zbar_image_get_crop(image: *const zbar_image_t, x: *mut libc::c_uint,
                           y: *mut libc::c_uint, width: *mut libc::c_uint,
                           height: *mut libc::c_uint);
 ...
 */
    #[no_mangle]
    fn zbar_image_get_symbols(image: *const zbar_image_t)
 ...
 */
    #[no_mangle]
    fn zbar_image_set_symbols(image: *mut zbar_image_t,
 ...
 */
    #[no_mangle]
    fn zbar_image_set_sequence(image: *mut zbar_image_t,
                               sequence_num: libc::c_uint);
 ...
 */
    #[no_mangle]
    fn zbar_image_set_data(image: *mut zbar_image_t,
 ...
 */
    #[no_mangle]
    fn zbar_image_set_userdata(image: *mut zbar_image_t,
                               userdata: *mut libc::c_void);
    /* * return user specified data value associated with the image.
 * @since 0.5
 */
    #[no_mangle]
    fn zbar_image_get_userdata(image: *const zbar_image_t)
     -> *mut libc::c_void;
    #[no_mangle]
    ...
    #[no_mangle]
    fn parse_dimensions(seq: *mut PyObject, dims: *mut libc::c_int,
 ...
 */
#[inline]
unsafe extern "C" fn zbar_fourcc_parse(mut format: *const libc::c_char)
 -> libc::c_ulong {
    ...
    if !format.is_null() {
        ...
        while i < 4 as libc::c_int &&
                  *format.offset(i as isize) as libc::c_int != 0 {
            fourcc |=
                (*format.offset(i as isize) as libc::c_ulong) <<
                    i * 8 as libc::c_int;
            i += 1
        }
    }
...
static mut image_doc: [libc::c_char; 89] =
    [105, 109, 97, 103, 101, 32, 111, 98, 106, 101, 99, 116, 46, 10, 10, 115,
     116, 111, 114, 101, 115, 32, 105, 109, 97, 103, 101, 32, 100, 97, 116,
     97, 32, 115, 97, 109, 112, 108, 101, 115, 32, 97, 108, 111, 110, 103, 32,
     119, 105, 116, 104, 32, 97, 115, 115, 111, 99, 105, 97, 116, 101, 100,
     32, 102, 111, 114, 109, 97, 116, 32, 97, 110, 100, 32, 115, 105, 122,
     101, 32, 109, 101, 116, 97, 100, 97, 116, 97, 46, 0];
unsafe extern "C" fn image_new(mut type_0: *mut PyTypeObject,
                               mut args: *mut PyObject,
                               mut kwds: *mut PyObject) -> *mut zbarImage {
    let mut self_0: *mut zbarImage =
        (*type_0).tp_alloc.expect("non-null function pointer")(type_0,
                                                               0 as
                                                                   ...
                                                                   Py_ssize_t)
            as *mut zbarImage;
    if self_0.is_null() { return 0 as *mut zbarImage }
...
unsafe extern "C" fn image_traverse(mut self_0: *mut zbarImage,
                                    mut visit: visitproc,
                                    mut arg: *mut libc::c_void)
 -> libc::c_int {
    if !(*self_0).data.is_null() {
        let mut vret: libc::c_int =
            visit.expect("non-null function pointer")((*self_0).data, arg);
        if vret != 0 { return vret }
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn image_clear(mut self_0: *mut zbarImage) -> libc::c_int {
    let mut zimg: *mut zbar_image_t = (*self_0).zimg;
    (*self_0).zimg = 0 as *mut zbar_image_t;
    if !zimg.is_null() {
        if !(*self_0).data.is_null() {
            /* attach data directly to zbar image */
            zbar_image_set_userdata(zimg,
                                    (*self_0).data as
                                        *mut libc::c_void); /* FIXME internal error */
            (*self_0).data = 0 as *mut PyObject
        } else { zbar_image_set_userdata(zimg, 0 as *mut libc::c_void); }
        zbar_image_destroy(zimg);
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn image_dealloc(mut self_0: *mut zbarImage) {
    image_clear(self_0);
    (*(*(self_0 as
...
unsafe extern "C" fn image_get_symbols(mut self_0: *mut zbarImage,
                                       mut closure: *mut libc::c_void)
 -> *mut zbarSymbolSet {
    let mut zsyms: *const zbar_symbol_set_t =
        zbar_image_get_symbols((*self_0).zimg);
    return zbarSymbolSet_FromSymbolSet(zsyms);
}
unsafe extern "C" fn image_set_symbols(mut self_0: *mut zbarImage,
 ...
 -> libc::c_int {
    ...
    if value.is_null() || value == &mut _Py_NoneStruct as *mut PyObject {
        zsyms = 0 as *const zbar_symbol_set_t
                  ...
                  ||
                  PyType_IsSubtype((*value).ob_type, &mut zbarSymbolSet_Type)
                      != 0 {
        zsyms = (*(value as *mut zbarSymbolSet)).zsyms
    } else {
        PyErr_Format(PyExc_TypeError,
                     b"must set image symbols to a zbar.SymbolSet, not \'%.50s\'\x00"
...
unsafe extern "C" fn image_iter(mut self_0: *mut zbarImage)
 -> *mut zbarSymbolIter {
    let mut syms: *mut zbarSymbolSet =
        image_get_symbols(self_0, 0 as *mut libc::c_void);
    if syms.is_null() { return 0 as *mut zbarSymbolIter }
    return zbarSymbolIter_FromSymbolSet(syms);
}
unsafe extern "C" fn image_get_format(mut self_0: *mut zbarImage,
                                      mut closure: *mut libc::c_void)
 -> *mut PyObject {
    let mut format: libc::c_ulong = zbar_image_get_format((*self_0).zimg);
    return PyString_FromStringAndSize(&mut format as *mut libc::c_ulong as
                                          *mut libc::c_char,
                                      4 as libc::c_int as Py_ssize_t);
}
unsafe extern "C" fn image_set_format(mut self_0: *mut zbarImage,
                                      mut value: *mut PyObject,
                                      mut closure: *mut libc::c_void)
 -> libc::c_int {
    if value.is_null() {
        PyErr_SetString(PyExc_TypeError,
                        b"cannot delete format attribute\x00" as *const u8 as
                            *const libc::c_char);
        return -(1 as libc::c_int)
    }
    ...
    if PyString_AsStringAndSize(value, &mut format, &mut len) != 0 ||
           format.is_null() || len != 4 as libc::c_int as libc::c_long {
        if format.is_null() {
            format =
        ...
        PyErr_Format(PyExc_ValueError,
                     b"format \'%.50s\' is not a valid four character code\x00"
                         as *const u8 as *const libc::c_char, format);
        return -(1 as libc::c_int)
    }
    zbar_image_set_format((*self_0).zimg, zbar_fourcc_parse(format));
    return 0 as libc::c_int;
}
unsafe extern "C" fn image_get_size(mut self_0: *mut zbarImage,
                                    mut closure: *mut libc::c_void)
 -> *mut PyObject {
    let mut w: libc::c_uint = 0;
    let mut h: libc::c_uint = 0;
    zbar_image_get_size((*self_0).zimg, &mut w, &mut h);
    return PyTuple_Pack(2 as libc::c_int as Py_ssize_t,
                        PyInt_FromLong(w as libc::c_long),
                        PyInt_FromLong(h as libc::c_long));
}
unsafe extern "C" fn image_set_size(mut self_0: *mut zbarImage,
                                    mut value: *mut PyObject,
                                    mut closure: *mut libc::c_void)
 -> libc::c_int {
    if value.is_null() {
        PyErr_SetString(PyExc_TypeError,
                        b"cannot delete size attribute\x00" as *const u8 as
                            *const libc::c_char);
        return -(1 as libc::c_int)
    }
    ...
    if parse_dimensions(value, dims.as_mut_ptr(), 2 as libc::c_int) != 0 ||
        ...
        PyErr_SetString(PyExc_ValueError,
                        b"size must be a sequence of two positive ints\x00" as
                            *const u8 as *const libc::c_char);
        return -(1 as libc::c_int)
    }
    zbar_image_set_size((*self_0).zimg,
                        dims[0 as libc::c_int as usize] as libc::c_uint,
                        dims[1 as libc::c_int as usize] as libc::c_uint);
    return 0 as libc::c_int;
}
unsafe extern "C" fn image_get_crop(mut self_0: *mut zbarImage,
                                    mut closure: *mut libc::c_void)
 -> *mut PyObject {
    ...
    return PyTuple_Pack(4 as libc::c_int as Py_ssize_t,
                        PyInt_FromLong(x as libc::c_long),
                        PyInt_FromLong(y as libc::c_long),
                        PyInt_FromLong(w as libc::c_long),
                        PyInt_FromLong(h as libc::c_long));
}
unsafe extern "C" fn image_set_crop(mut self_0: *mut zbarImage,
                                    mut value: *mut PyObject,
                                    mut closure: *mut libc::c_void)
 -> libc::c_int {
    let mut w: libc::c_uint = 0;
    ...
    zbar_image_get_size((*self_0).zimg, &mut w, &mut h);
    if value.is_null() {
        zbar_image_set_crop((*self_0).zimg, 0 as libc::c_int as libc::c_uint,
                            0 as libc::c_int as libc::c_uint, w, h);
        return 0 as libc::c_int
    }
    ...
    if parse_dimensions(value, dims.as_mut_ptr(), 4 as libc::c_int) != 0 ||
        ...
        PyErr_SetString(PyExc_ValueError,
                        b"crop must be a sequence of four positive ints\x00"
                            as *const u8 as *const libc::c_char);
        return -(1 as libc::c_int)
    }
    ...
    zbar_image_set_crop((*self_0).zimg,
                        dims[0 as libc::c_int as usize] as libc::c_uint,
                        dims[1 as libc::c_int as usize] as libc::c_uint,
...
unsafe extern "C" fn image_get_int(mut self_0: *mut zbarImage,
                                   mut closure: *mut libc::c_void)
 -> *mut PyObject {
...
unsafe extern "C" fn image_set_int(mut self_0: *mut zbarImage,
                                   mut value: *mut PyObject,
                                   mut closure: *mut libc::c_void)
 -> libc::c_int {
    ...
    if val == -(1 as libc::c_int) as libc::c_uint &&
        ...
        PyErr_SetString(PyExc_TypeError,
                        b"expecting an integer\x00" as *const u8 as
                            *const libc::c_char);
        return -(1 as libc::c_int)
    }
    match closure as intptr_t {
        ...
        2 => { zbar_image_set_sequence((*self_0).zimg, val); }
        _ => { }
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn image_get_data(mut self_0: *mut zbarImage,
                                    mut closure: *mut libc::c_void)
 -> *mut PyObject {
    if !(*self_0).data.is_null() {
    ...
    let mut data: *const libc::c_char =
        zbar_image_get_data((*self_0).zimg) as *const libc::c_char;
    let mut datalen: libc::c_ulong =
        zbar_image_get_data_length((*self_0).zimg);
    ...
    (*self_0).data =
        PyBuffer_FromMemory(data as *mut libc::c_void, datalen as Py_ssize_t);
    (*(*self_0).data).ob_refcnt += 1;
    return (*self_0).data;
}
#[no_mangle]
pub unsafe extern "C" fn image_cleanup(mut zimg: *mut zbar_image_t) {
    let mut data: *mut PyObject =
        zbar_image_get_userdata(zimg) as *mut PyObject;
    ...
    if (*data).ob_type == &mut zbarImage_Type as *mut PyTypeObject ||
        ...
        if !((*data).ob_refcnt != 0 as libc::c_int as libc::c_long) {
            Some((*(*data).ob_type).tp_dealloc.expect("non-null function pointer")).expect("non-null function pointer")(data);
        }
    };
}
unsafe extern "C" fn image_set_data(mut self_0: *mut zbarImage,
                                    mut value: *mut PyObject,
                                    mut closure: *mut libc::c_void)
 -> libc::c_int {
    if value.is_null() {
    ...
    (*value).ob_refcnt += 1;
    zbar_image_set_data((*self_0).zimg, data as *const libc::c_void,
                        datalen as libc::c_ulong,
                        Some(image_cleanup as
                                 unsafe extern "C" fn(_: *mut zbar_image_t)
                                     -> ()));
    (*self_0).data = value;
    zbar_image_set_userdata((*self_0).zimg, self_0 as *mut libc::c_void);
...
static mut image_getset: [PyGetSetDef; 9] =
    unsafe {
        [{
             let mut init =
                 PyGetSetDef{name:
...
unsafe extern "C" fn image_init(mut self_0: *mut zbarImage,
                                mut args: *mut PyObject,
    ...
    static mut kwlist: [*mut libc::c_char; 5] =
        [b"width\x00" as *const u8 as *const libc::c_char as
             *mut libc::c_char,
         b"height\x00" as *const u8 as *const libc::c_char as
             *mut libc::c_char,
         b"format\x00" as *const u8 as *const libc::c_char as
             *mut libc::c_char,
         b"data\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
         0 as *const libc::c_char as *mut libc::c_char];
    if PyArg_ParseTupleAndKeywords(args, kwds,
                                   b"|iiOO\x00" as *const u8 as
                                       *const libc::c_char,
                                   kwlist.as_mut_ptr(),
                                   &mut width as *mut libc::c_int,
                                   &mut height as *mut libc::c_int,
                                   &mut format as *mut *mut PyObject,
                                   &mut data as *mut *mut PyObject) == 0 {
        return -(1 as libc::c_int)
    }
    if width > 0 as libc::c_int && height > 0 as libc::c_int {
        zbar_image_set_size((*self_0).zimg, width as libc::c_uint,
                            height as libc::c_uint);
    }
    if !format.is_null() &&
           image_set_format(self_0, format, 0 as *mut libc::c_void) != 0 {
        return -(1 as libc::c_int)
    }
    if !data.is_null() &&
           image_set_data(self_0, data, 0 as *mut libc::c_void) != 0 {
        return -(1 as libc::c_int)
    }
    return 0 as libc::c_int;
}
unsafe extern "C" fn image_convert(mut self_0: *mut zbarImage,
                                   mut args: *mut PyObject,
 ...
 -> *mut zbarImage {
    ...
    static mut kwlist: [*mut libc::c_char; 4] =
        [b"format\x00" as *const u8 as *const libc::c_char as
         ...
         0 as *const libc::c_char as *mut libc::c_char];
    if PyArg_ParseTupleAndKeywords(args, kwds,
                                   b"s|ii\x00" as *const u8 as
                                       *const libc::c_char,
                                   kwlist.as_mut_ptr(),
                                   &mut format as *mut *const libc::c_char,
                                   &mut width as *mut libc::c_int,
                                   &mut height as *mut libc::c_int) == 0 {
        return 0 as *mut zbarImage
    }
    ...
    let mut img: *mut zbarImage =
        _PyObject_GC_New(&mut zbarImage_Type) as *mut zbarImage;
    if img.is_null() { return 0 as *mut zbarImage }
    (*img).data = 0 as *mut PyObject;
    if width > 0 as libc::c_int && height > 0 as libc::c_int {
        (*img).zimg =
            zbar_image_convert_resize((*self_0).zimg, fourcc,
                                      width as libc::c_uint,
                                      height as libc::c_uint)
    } else { (*img).zimg = zbar_image_convert((*self_0).zimg, fourcc) }
    if (*img).zimg.is_null() {
        ...
        *fresh2 -= 1;
        if !(*fresh2 != 0 as libc::c_int as libc::c_long) {
            Some((*(*(img as
                          *mut PyObject)).ob_type).tp_dealloc.expect("non-null function pointer")).expect("non-null function pointer")(img
                                                                                                                                           as
                                                                                                                                           *mut PyObject);
        }
        return 0 as *mut zbarImage
...
static mut image_methods: [PyMethodDef; 2] =
    unsafe {
        [{
             let mut init =
                 PyMethodDef{ml_name:
                                 b"convert\x00" as *const u8 as
                                     *const libc::c_char,
                             ml_meth:
                                 ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                         *mut zbarImage,
                                                                    ...
                                                                    ->
                                                                        *mut zbarImage>,
                                                         PyCFunction>(Some(image_convert
                                                                               as
                                                                               unsafe extern "C" fn(_:
                                                                                                        *mut zbarImage,
                                                                                                    _:
...
#[no_mangle]
pub static mut zbarImage_Type: PyTypeObject =
    unsafe {
        {
            let mut init =
                _typeobject{ob_refcnt: 1 as libc::c_int as Py_ssize_t,
                            ...
                            ob_size: 0,
                            tp_name:
                                b"zbar.Image\x00" as *const u8 as
                                    *const libc::c_char,
                            tp_basicsize:
                                ::std::mem::size_of::<zbarImage>() as
                            ...
                            tp_traverse:
                                ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                   ...
                                                                   ->
                                                                       libc::c_int>,
                                                        traverseproc>(Some(image_traverse
                                                                               as
                                                                               unsafe extern "C" fn(_:
                                                                                                        *mut zbarImage,
                                                                                                    _:
...
#[no_mangle]
pub unsafe extern "C" fn zbarImage_FromImage(mut zimg: *mut zbar_image_t)
 -> *mut zbarImage {
    let mut self_0: *mut zbarImage =
        _PyObject_GC_New(&mut zbarImage_Type) as *mut zbarImage;
    if self_0.is_null() { return 0 as *mut zbarImage }
...
#[no_mangle]
pub unsafe extern "C" fn zbarImage_validate(mut img: *mut zbarImage)
 -> libc::c_int {
    if zbar_image_get_width((*img).zimg) == 0 ||
        ...
        PyErr_Format(PyExc_ValueError,
                     b"image size and data must be defined\x00" as *const u8
