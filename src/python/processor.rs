 ...
 */
    #[no_mangle]
    fn zbar_processor_set_userdata(processor: *mut zbar_processor_t,
 ...
 */
    #[no_mangle]
    fn zbar_processor_is_visible(processor: *mut zbar_processor_t)
     -> libc::c_int;
 ...
 */
    #[no_mangle]
    fn zbar_processor_get_results(processor: *const zbar_processor_t)
 ...
 */
    #[no_mangle]
    fn zbar_process_one(processor: *mut zbar_processor_t,
                        timeout: libc::c_int) -> libc::c_int;
 ...
 */
    #[no_mangle]
    fn zbar_process_image(processor: *mut zbar_processor_t,
...
pub type Py_tracefunc
    =
    Option<unsafe extern "C" fn(_: *mut PyObject, _: *mut _frame,
                                _: libc::c_int, _: *mut PyObject)
               -> libc::c_int>;
...
unsafe extern "C" fn processor_new(mut type_0: *mut PyTypeObject,
                                   mut args: *mut PyObject,
                                   mut kwds: *mut PyObject)
 -> *mut zbarProcessor {
    static mut kwlist: [*mut libc::c_char; 2] =
        [b"enable_threads\x00" as *const u8 as *const libc::c_char as
             *mut libc::c_char,
                                   ...
                                   Some(object_to_bool as
                                            unsafe extern "C" fn(_:
                                                                 ...
                                                                 _:
                                                                     *mut libc::c_int)
                                                -> libc::c_int),
                                   &mut threaded as *mut libc::c_int) == 0 {
     ...
     */
    PyEval_InitThreads();
    let mut self_0: *mut zbarProcessor =
    ...
    if self_0.is_null() { return 0 as *mut zbarProcessor }
...
unsafe extern "C" fn processor_traverse(mut self_0: *mut zbarProcessor,
                                        mut visit: visitproc,
...
unsafe extern "C" fn processor_clear(mut self_0: *mut zbarProcessor)
 -> libc::c_int {
    zbar_processor_set_data_handler((*self_0).zproc, None,
...
unsafe extern "C" fn processor_dealloc(mut self_0: *mut zbarProcessor) {
...
unsafe extern "C" fn processor_get_bool(mut self_0: *mut zbarProcessor,
 ...
 -> *mut PyObject {
    ...
    if val < 0 as libc::c_int { return zbarErr_Set(self_0 as *mut PyObject) }
    return PyBool_FromLong(val as libc::c_long);
}
unsafe extern "C" fn processor_set_bool(mut self_0: *mut zbarProcessor,
                                        mut value: *mut PyObject,
                                        mut closure: *mut libc::c_void)
 -> libc::c_int {
    if value.is_null() {
        PyErr_SetString(PyExc_TypeError,
                        b"cannot delete attribute\x00" as *const u8 as
                            *const libc::c_char);
        return -(1 as libc::c_int)
    }
    let mut rc: libc::c_int = 0;
    let mut val: libc::c_int = PyObject_IsTrue(value);
    if val < 0 as libc::c_int { return -(1 as libc::c_int) }
    match closure as intptr_t {
...
unsafe extern "C" fn processor_get_results(mut self_0: *mut zbarProcessor,
                                           mut closure: *mut libc::c_void)
 -> *mut zbarSymbolSet {
    let mut zsyms: *const zbar_symbol_set_t =
        zbar_processor_get_results((*self_0).zproc);
    return zbarSymbolSet_FromSymbolSet(zsyms);
}
unsafe extern "C" fn processor_set_request_size(mut self_0:
                                                    *mut zbarProcessor,
                                                mut value: *mut PyObject,
                                                mut closure:
                                                    *mut libc::c_void)
 -> libc::c_int {
    if value.is_null() {
        zbar_processor_request_size((*self_0).zproc,
    ...
    if parse_dimensions(value, dims.as_mut_ptr(), 2 as libc::c_int) != 0 ||
        ...
        PyErr_SetString(PyExc_ValueError,
                        b"request_size must be a sequence of two positive ints\x00"
                            as *const u8 as *const libc::c_char);
        return -(1 as libc::c_int)
    }
    zbar_processor_request_size((*self_0).zproc,
                                dims[0 as libc::c_int as usize] as
                                    libc::c_uint,
                                dims[1 as libc::c_int as usize] as
                                    libc::c_uint);
    return 0 as libc::c_int;
}
static mut processor_getset: [PyGetSetDef; 5] =
    unsafe {
        [{
             let mut init =
                 PyGetSetDef{name:
                                 b"visible\x00" as *const u8 as
                             ...
                             get:
                                 ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                    ...
                                                                    ->
                                                                        *mut PyObject>,
                                                         getter>(Some(processor_get_bool
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut zbarProcessor,
                                                                                               _:
                             ...
                             set:
                                 ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                    ...
                                                                    ->
                                                                        libc::c_int>,
                                                         setter>(Some(processor_set_bool
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut zbarProcessor,
                                                                                               _:
                 ...
                 PyGetSetDef{name:
                             ...
                             get:
                                 ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                    ...
                                                                    ->
                                                                        *mut zbarSymbolSet>,
                                                         getter>(Some(processor_get_results
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut zbarProcessor,
                                                                                               _:
         ...
         },
         {
             let mut init =
                 PyGetSetDef{name:
                                 b"request_size\x00" as *const u8 as
                                     *const libc::c_char as *mut libc::c_char,
                             get: None,
                             set:
                                 ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                    ...
                                                                    ->
                                                                        libc::c_int>,
                                                         setter>(Some(processor_set_request_size
                                                                          as
                                                                          unsafe extern "C" fn(_:
                                                                                                   *mut zbarProcessor,
                                                                                               _:
...
unsafe extern "C" fn processor_set_config(mut self_0: *mut zbarProcessor,
                                          mut args: *mut PyObject,
                                          mut kwds: *mut PyObject)
 -> *mut PyObject {
    let mut sym: zbar_symbol_type_t = ZBAR_NONE;
...
unsafe extern "C" fn processor_init_(mut self_0: *mut zbarProcessor,
                                     mut args: *mut PyObject,
                                     mut kwds: *mut PyObject)
 -> *mut PyObject {
    let mut dev: *const libc::c_char =
        b"\x00" as *const u8 as *const libc::c_char;
    let mut disp: libc::c_int = 1 as libc::c_int;
    static mut kwlist: [*mut libc::c_char; 3] =
        [b"video_device\x00" as *const u8 as *const libc::c_char as
             *mut libc::c_char,
         b"enable_display\x00" as *const u8 as *const libc::c_char as
             *mut libc::c_char,
         0 as *const libc::c_char as *mut libc::c_char];
    if PyArg_ParseTupleAndKeywords(args, kwds,
                                   b"|zO&\x00" as *const u8 as
                                       *const libc::c_char,
                                   kwlist.as_mut_ptr(),
...
unsafe extern "C" fn processor_parse_config(mut self_0: *mut zbarProcessor,
                                            mut args: *mut PyObject,
                                            mut kwds: *mut PyObject)
 -> *mut PyObject {
...
unsafe extern "C" fn object_to_timeout(mut obj: *mut PyObject,
 ...
 -> libc::c_int {
    ...
    if (*obj).ob_type == &mut PyFloat_Type as *mut PyTypeObject ||
        ...
        tmp =
            ((*(obj as *mut PyFloatObject)).ob_fval *
                 1000 as libc::c_int as libc::c_double) as libc::c_int
    } else {
        tmp =
            (PyInt_AsLong(obj) * 1000 as libc::c_int as libc::c_long) as
                libc::c_int
    }
...
unsafe extern "C" fn processor_user_wait(mut self_0: *mut zbarProcessor,
                                         mut args: *mut PyObject,
                                         mut kwds: *mut PyObject)
 -> *mut PyObject {
    let mut timeout: libc::c_int = -(1 as libc::c_int);
    static mut kwlist: [*mut libc::c_char; 2] =
        [b"timeout\x00" as *const u8 as *const libc::c_char as
             *mut libc::c_char,
         0 as *const libc::c_char as *mut libc::c_char];
    if PyArg_ParseTupleAndKeywords(args, kwds,
                                   b"|O&\x00" as *const u8 as
                                       *const libc::c_char,
                                   kwlist.as_mut_ptr(),
                                   Some(object_to_timeout as
                                            unsafe extern "C" fn(_:
                                                                     *mut PyObject,
                                                                 _:
                                                                     *mut libc::c_int)
                                                -> libc::c_int),
                                   &mut timeout as *mut libc::c_int) == 0 {
        return 0 as *mut PyObject
    }
    ...
    if rc < 0 as libc::c_int { return zbarErr_Set(self_0 as *mut PyObject) }
    return PyInt_FromLong(rc as libc::c_long);
}
unsafe extern "C" fn processor_process_one(mut self_0: *mut zbarProcessor,
                                           mut args: *mut PyObject,
                                           mut kwds: *mut PyObject)
 -> *mut PyObject {
    let mut timeout: libc::c_int = -(1 as libc::c_int);
...
unsafe extern "C" fn processor_process_image(mut self_0: *mut zbarProcessor,
                                             mut args: *mut PyObject,
                                             mut kwds: *mut PyObject)
 -> *mut PyObject {
    ...
    PyEval_RestoreThread(_save);
    if n < 0 as libc::c_int { return zbarErr_Set(self_0 as *mut PyObject) }
    return PyInt_FromLong(n as libc::c_long);
}
#[no_mangle]
pub unsafe extern "C" fn process_handler(mut zimg: *mut zbar_image_t,
    ...
    let mut img: *mut zbarImage =
        zbar_image_get_userdata(zimg) as *mut zbarImage;
    ...
    match current_block {
        2868539653012386629 => {
            ...
            *fresh7 = img as *mut PyObject;
            let ref mut fresh8 =
                *(*(args as
                        *mut PyTupleObject)).ob_item.as_mut_ptr().offset(2 as
                                                                             libc::c_int
                                                                             as
                                                                             isize);
            *fresh8 = (*self_0).closure;
            ...
            if !junk.is_null() {
                ...
                PySys_WriteStderr(b"in ZBar Processor data_handler:\n\x00" as
                                      *const u8 as *const libc::c_char);
                PyErr_Print();
            }
            (*args).ob_refcnt -= 1;
            if !((*args).ob_refcnt != 0 as libc::c_int as libc::c_long) {
                Some((*(*args).ob_type).tp_dealloc.expect("non-null function pointer")).expect("non-null function pointer")(args);
            }
        }
        _ => { }
    }
...
unsafe extern "C" fn processor_set_data_handler(mut self_0:
                                                    *mut zbarProcessor,
                                                mut args: *mut PyObject,
                                                mut kwds: *mut PyObject)
 -> *mut PyObject {
    ...
    if handler != &mut _Py_NoneStruct as *mut PyObject {
        ...
        zbar_processor_set_data_handler((*self_0).zproc,
                                        Some(process_handler as
                                                 unsafe extern "C" fn(_:
                                                                          *mut zbar_image_t,
                                                                      _:
                                                                          *const libc::c_void)
...
static mut processor_methods: [PyMethodDef; 8] =
    unsafe {
        [{
             let mut init =
                 PyMethodDef{ml_name:
                             ...
                             ml_meth:
                                 ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                    ...
                                                                    ->
                                                                        *mut PyObject>,
                                                         PyCFunction>(Some(processor_init_
                                                                               as
                                                                               unsafe extern "C" fn(_:
                                                                                                        *mut zbarProcessor,
                                                                                                    _:
                 ...
                 PyMethodDef{ml_name:
                             ...
                             ml_meth:
                                 ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                    ...
                                                                    ->
                                                                        *mut PyObject>,
                                                         PyCFunction>(Some(processor_set_config
                                                                               as
                                                                               unsafe extern "C" fn(_:
                                                                                                        *mut zbarProcessor,
                                                                                                    _:
                 ...
                 PyMethodDef{ml_name:
                             ...
                             ml_meth:
                                 ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                    ...
                                                                    ->
                                                                        *mut PyObject>,
                                                         PyCFunction>(Some(processor_parse_config
                                                                               as
                                                                               unsafe extern "C" fn(_:
                                                                                                        *mut zbarProcessor,
                                                                                                    _:
         ...
         },
         {
             let mut init =
                 PyMethodDef{ml_name:
                                 b"user_wait\x00" as *const u8 as
                                     *const libc::c_char,
                             ml_meth:
                                 ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                         *mut zbarProcessor,
                                                                    ...
                                                                    ->
                                                                        *mut PyObject>,
                                                         PyCFunction>(Some(processor_user_wait
                                                                               as
                                                                               unsafe extern "C" fn(_:
                                                                                                        *mut zbarProcessor,
                                                                                                    _:
         ...
         },
         {
             let mut init =
                 PyMethodDef{ml_name:
                                 b"process_one\x00" as *const u8 as
                                     *const libc::c_char,
                             ml_meth:
                                 ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                         *mut zbarProcessor,
                                                                    ...
                                                                    ->
                                                                        *mut PyObject>,
                                                         PyCFunction>(Some(processor_process_one
                                                                               as
                                                                               unsafe extern "C" fn(_:
                                                                                                        *mut zbarProcessor,
                                                                                                    _:
         ...
         },
         {
             let mut init =
                 PyMethodDef{ml_name:
                                 b"process_image\x00" as *const u8 as
                                     *const libc::c_char,
                             ml_meth:
                                 ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                         *mut zbarProcessor,
                                                                    ...
                                                                    ->
                                                                        *mut PyObject>,
                                                         PyCFunction>(Some(processor_process_image
                                                                               as
                                                                               unsafe extern "C" fn(_:
                                                                                                        *mut zbarProcessor,
                                                                                                    _:
         ...
         },
         {
             let mut init =
                 PyMethodDef{ml_name:
                                 b"set_data_handler\x00" as *const u8 as
                                     *const libc::c_char,
                             ml_meth:
                                 ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                         *mut zbarProcessor,
                                                                    ...
                                                                    ->
                                                                        *mut PyObject>,
                                                         PyCFunction>(Some(processor_set_data_handler
                                                                               as
                                                                               unsafe extern "C" fn(_:
                                                                                                        *mut zbarProcessor,
                                                                                                    _:
...
#[no_mangle]
pub static mut zbarProcessor_Type: PyTypeObject =
    unsafe {
        {
            let mut init =
                _typeobject{ob_refcnt: 1 as libc::c_int as Py_ssize_t,
                            ...
                            ob_size: 0,
                            tp_name:
                                b"zbar.Processor\x00" as *const u8 as
                                    *const libc::c_char,
                            tp_basicsize:
                                ::std::mem::size_of::<zbarProcessor>() as
                            ...
                            tp_dealloc:
                                ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                        *mut zbarProcessor)
                                                                   -> ()>,
                                                        destructor>(Some(processor_dealloc
                                                                             as
                                                                             unsafe extern "C" fn(_:
                                                                                                      *mut zbarProcessor)
                                                                                 ->
                            ...
                            tp_traverse:
                                ::std::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                   ...
                                                                   ->
                                                                       libc::c_int>,
                                                        traverseproc>(Some(processor_traverse
                                                                               as
                                                                               unsafe extern "C" fn(_:
                                                                                                        *mut zbarProcessor,
                                                                                                    _:
