...
extern {
    ...
    */
     ...
     */
    #[no_mangle]
    fn zbar_image_scanner_enable_cache(scanner: *mut zbar_image_scanner_t, enable: libc::c_int);
     ...
     */
    #[no_mangle]
    fn zbar_image_scanner_recycle_image(
        scanner: *mut zbar_image_scanner_t,
     ...
     */
    #[no_mangle]
    fn zbar_image_scanner_get_results(
     ...
     */
    #[no_mangle]
    fn zbar_scan_image(scanner: *mut zbar_image_scanner_t, image: *mut zbar_image_t)
        -> libc::c_int;
    #[no_mangle]
 ...
 */
#[inline]
unsafe extern fn zbar_image_scanner_parse_config(
    mut scanner: *mut zbar_image_scanner_t,
    ...
    return (zbar_parse_config(config_string, &mut sym, &mut cfg, &mut val) != 0
        || zbar_image_scanner_set_config(scanner, sym, cfg, val) != 0) as libc::c_int;
}
/*------------------------------------------------------------------------
...
static mut imagescanner_doc: [libc::c_char; 78] = [
    115, 99, 97, 110, 32, 105, 109, 97, 103, 101, 115, 32, 102, 111, 114, 32, 98, 97, 114, 99, 111,
    100, 101, 115, 46, 10, 10, 97, 116, 116, 97, 99, 104, 101, 115, 32, 115, 121, 109, 98, 111,
    108, 115, 32, 116, 111, 32, 105, 109, 97, 103, 101, 32, 102, 111, 114, 32, 101, 97, 99, 104,
    32, 100, 101, 99, 111, 100, 101, 100, 32, 114, 101, 115, 117, 108, 116, 46, 0,
];
unsafe extern fn imagescanner_new(
    ...
    let mut self_0: *mut zbarImageScanner = (*type_0).tp_alloc.expect("non-null function pointer")(
        type_0,
...
unsafe extern fn imagescanner_dealloc(mut self_0: *mut zbarImageScanner) {
...
unsafe extern fn imagescanner_get_results(
    mut self_0: *mut zbarImageScanner,
    mut closure: *mut libc::c_void,
) -> *mut zbarSymbolSet {
    let mut zsyms: *const zbar_symbol_set_t = zbar_image_scanner_get_results((*self_0).zscn);
    return zbarSymbolSet_FromSymbolSet(zsyms);
}
static mut imagescanner_getset: [PyGetSetDef; 2] = unsafe {
    [
        {
            let mut init = PyGetSetDef {
                ...
                get: ::std::mem::transmute::<
                    Option<
                        unsafe extern fn(
                            _: *mut zbarImageScanner,
                            _: *mut libc::c_void,
                        ) -> *mut zbarSymbolSet,
                    >,
                    getter,
                >(Some(
                    imagescanner_get_results
                        as unsafe extern fn(
                            _: *mut zbarImageScanner,
                            _: *mut libc::c_void,
                        ) -> *mut zbarSymbolSet,
...
unsafe extern fn imagescanner_set_config(
    mut self_0: *mut zbarImageScanner,
    mut args: *mut PyObject,
    mut kwds: *mut PyObject,
) -> *mut PyObject {
...
unsafe extern fn imagescanner_parse_config(
    mut self_0: *mut zbarImageScanner,
    mut args: *mut PyObject,
    mut kwds: *mut PyObject,
) -> *mut PyObject {
...
unsafe extern fn imagescanner_enable_cache(
    mut self_0: *mut zbarImageScanner,
    mut args: *mut PyObject,
    mut kwds: *mut PyObject,
) -> *mut PyObject {
    ...
    static mut kwlist: [*mut libc::c_char; 2] = [
        b"enable\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
        0 as *const libc::c_char as *mut libc::c_char,
    ];
    if PyArg_ParseTupleAndKeywords(
        args,
        ...
        &mut enable as *mut libc::c_uchar,
    ) == 0
    {
        return 0 as *mut PyObject;
    }
...
unsafe extern fn imagescanner_recycle(
    mut self_0: *mut zbarImageScanner,
    mut args: *mut PyObject,
    mut kwds: *mut PyObject,
) -> *mut PyObject {
...
unsafe extern fn imagescanner_scan(
    mut self_0: *mut zbarImageScanner,
    mut args: *mut PyObject,
    mut kwds: *mut PyObject,
) -> *mut PyObject {
    ...
    if n < 0 as libc::c_int {
        PyErr_Format(
            PyExc_ValueError,
            b"unsupported image format\x00" as *const u8 as *const libc::c_char,
        );
        return 0 as *mut PyObject;
    }
    return PyInt_FromLong(n as libc::c_long);
}
static mut imagescanner_methods: [PyMethodDef; 6] = unsafe {
    [
        {
        ...
        {
            let mut init = PyMethodDef {
                ml_name: b"enable_cache\x00" as *const u8 as *const libc::c_char,
                ml_meth: ::std::mem::transmute::<
                    Option<
                        unsafe extern fn(
                            _: *mut zbarImageScanner,
        ...
        {
            let mut init = PyMethodDef {
                ml_name: b"recycle\x00" as *const u8 as *const libc::c_char,
                ml_meth: ::std::mem::transmute::<
                    Option<
                        unsafe extern fn(
                            _: *mut zbarImageScanner,
        ...
        {
            let mut init = PyMethodDef {
                ml_name: b"scan\x00" as *const u8 as *const libc::c_char,
                ml_meth: ::std::mem::transmute::<
                    Option<
                        unsafe extern fn(
                            _: *mut zbarImageScanner,
...
#[no_mangle]
pub static mut zbarImageScanner_Type: PyTypeObject = unsafe {
    {
        let mut init = _typeobject {
            ob_refcnt: 1 as libc::c_int as Py_ssize_t,
            ob_type: 0 as *const _typeobject as *mut _typeobject,
            ob_size: 0,
            tp_name: b"zbar.ImageScanner\x00" as *const u8 as *const libc::c_char,
            tp_basicsize: ::std::mem::size_of::<zbarImageScanner>() as libc::c_ulong as Py_ssize_t,
            tp_itemsize: 0,
            tp_dealloc: ::std::mem::transmute::<
                Option<unsafe extern fn(_: *mut zbarImageScanner) -> ()>,
                destructor,
            >(Some(
                imagescanner_dealloc as unsafe extern fn(_: *mut zbarImageScanner) -> (),
            )),
            tp_print: None,
            tp_getattr: None,
            tp_setattr: None,
            ...
            tp_iter: None,
            tp_iternext: None,
            tp_methods: imagescanner_methods.as_ptr() as *mut _,
