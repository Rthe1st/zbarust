...
extern {
     ...
     */
    #[no_mangle]
    fn zbar_symbol_get_type(symbol: *const zbar_symbol_t) -> zbar_symbol_type_t;
     ...
     */
    #[no_mangle]
    fn zbar_symbol_get_modifiers(symbol: *const zbar_symbol_t) -> libc::c_uint;
    /* * retrieve data decoded from symbol.
     * @returns the data string
     */
    #[no_mangle]
    fn zbar_symbol_get_data(symbol: *const zbar_symbol_t) -> *const libc::c_char;
    /* * retrieve length of binary data.
     * @returns the length of the decoded data
     */
    #[no_mangle]
    fn zbar_symbol_get_data_length(symbol: *const zbar_symbol_t) -> libc::c_uint;
     ...
     */
    #[no_mangle]
    fn zbar_symbol_get_loc_x(symbol: *const zbar_symbol_t, index: libc::c_uint) -> libc::c_int;
     ...
     */
    #[no_mangle]
    fn zbar_symbol_get_loc_y(symbol: *const zbar_symbol_t, index: libc::c_uint) -> libc::c_int;
     ...
     */
    #[no_mangle]
    fn zbar_symbol_get_orientation(symbol: *const zbar_symbol_t) -> zbar_orientation_t;
     ...
     */
    #[no_mangle]
    fn zbar_symbol_get_components(symbol: *const zbar_symbol_t) -> *const zbar_symbol_set_t;
    #[no_mangle]
    fn zbarEnum_LookupValue(self_0: *mut zbarEnum, val: libc::c_int) -> *mut zbarEnumItem;
    #[no_mangle]
    fn zbarEnum_SetFromMask(self_0: *mut zbarEnum, mask: libc::c_uint) -> *mut PyObject;
    #[no_mangle]
...
static mut symbol_doc: [libc::c_char; 82] = [
    115, 121, 109, 98, 111, 108, 32, 114, 101, 115, 117, 108, 116, 32, 111, 98, 106, 101, 99, 116,
    46, 10, 10, 100, 97, 116, 97, 32, 97, 110, 100, 32, 97, 115, 115, 111, 99, 105, 97, 116, 101,
    100, 32, 105, 110, 102, 111, 114, 109, 97, 116, 105, 111, 110, 32, 97, 98, 111, 117, 116, 32,
    97, 32, 115, 117, 99, 99, 101, 115, 115, 102, 117, 108, 32, 100, 101, 99, 111, 100, 101, 46, 0,
];
unsafe extern fn symbol_traverse(
    mut self_0: *mut zbarSymbol,
    mut visit: visitproc,
    mut arg: *mut libc::c_void,
) -> libc::c_int {
    return 0 as libc::c_int;
}
unsafe extern fn symbol_clear(mut self_0: *mut zbarSymbol) -> libc::c_int {
...
unsafe extern fn symbol_dealloc(mut self_0: *mut zbarSymbol) {
    symbol_clear(self_0);
    (*(*(self_0 as *mut PyObject)).ob_type).tp_free.expect("non-null function pointer")(
        self_0 as *mut PyObject as *mut libc::c_void,
    );
}
unsafe extern fn symbol_get_components(
    mut self_0: *mut zbarSymbol,
    mut closure: *mut libc::c_void,
) -> *mut zbarSymbolSet {
    let mut zsyms: *const zbar_symbol_set_t = zbar_symbol_get_components((*self_0).zsym);
    return zbarSymbolSet_FromSymbolSet(zsyms);
}
unsafe extern fn symbol_iter(mut self_0: *mut zbarSymbol) -> *mut zbarSymbolIter {
    let mut syms: *mut zbarSymbolSet = symbol_get_components(self_0, 0 as *mut libc::c_void);
    ...
    if !syms.is_null() {
        ...
        *fresh0 -= 1;
        if !(*fresh0 != 0 as libc::c_int as libc::c_long) {
            Some(
                (*(*(syms as *mut PyObject)).ob_type)
                    .tp_dealloc
                    .expect("non-null function pointer"),
            )
            .expect("non-null function pointer")(syms as *mut PyObject);
        }
    }
    return iter;
}
unsafe extern fn symbol_get_type(
    mut self_0: *mut zbarSymbol,
    mut closure: *mut libc::c_void,
) -> *mut zbarEnumItem {
    return zbarSymbol_LookupEnum(zbar_symbol_get_type((*self_0).zsym));
}
unsafe extern fn symbol_get_configs(
    mut self_0: *mut zbarSymbol,
    mut closure: *mut libc::c_void,
) -> *mut PyObject {
...
unsafe extern fn symbol_get_modifiers(
    mut self_0: *mut zbarSymbol,
    mut closure: *mut libc::c_void,
) -> *mut PyObject {
...
unsafe extern fn symbol_get_long(
    mut self_0: *mut zbarSymbol,
    mut closure: *mut libc::c_void,
) -> *mut PyObject {
    ...
    if closure.is_null() {
        ...
        val = zbar_symbol_get_count((*self_0).zsym)
    }
    return PyInt_FromLong(val as libc::c_long);
}
unsafe extern fn symbol_get_data(
    mut self_0: *mut zbarSymbol,
    mut closure: *mut libc::c_void,
) -> *mut PyObject {
    if (*self_0).data.is_null() {
        /* FIXME this could be a buffer now */
        (*self_0).data = PyString_FromStringAndSize(
            zbar_symbol_get_data((*self_0).zsym),
            zbar_symbol_get_data_length((*self_0).zsym) as Py_ssize_t,
        );
        if (*self_0).data.is_null() {
...
unsafe extern fn symbol_get_location(
    mut self_0: *mut zbarSymbol,
    mut closure: *mut libc::c_void,
) -> *mut PyObject {
    if (*self_0).loc.is_null() {
        ...
        while i < n {
            ...
            x = PyInt_FromLong(zbar_symbol_get_loc_x((*self_0).zsym, i) as libc::c_long);
            y = PyInt_FromLong(zbar_symbol_get_loc_y((*self_0).zsym, i) as libc::c_long);
            let ref mut fresh1 =
                *(*((*self_0).loc as *mut PyTupleObject)).ob_item.as_mut_ptr().offset(i as isize);
...
unsafe extern fn symbol_get_orientation(
    mut self_0: *mut zbarSymbol,
    mut closure: *mut libc::c_void,
) -> *mut zbarEnumItem {
    return zbarEnum_LookupValue(
        orient_enum,
        zbar_symbol_get_orientation((*self_0).zsym) as libc::c_int,
    );
}
static mut symbol_getset: [PyGetSetDef; 10] = unsafe {
    [
        {
        ...
        {
            let mut init = PyGetSetDef {
                name: b"configs\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
                get: ::std::mem::transmute::<
                    Option<
                        unsafe extern fn(_: *mut zbarSymbol, _: *mut libc::c_void) -> *mut PyObject,
                    >,
                    getter,
                >(Some(
                    symbol_get_configs
        ...
        {
            let mut init = PyGetSetDef {
                name: b"modifiers\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
                get: ::std::mem::transmute::<
                    Option<
                        unsafe extern fn(_: *mut zbarSymbol, _: *mut libc::c_void) -> *mut PyObject,
                    >,
        ...
        {
            let mut init = PyGetSetDef {
                name: b"quality\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
                get: ::std::mem::transmute::<
                    Option<
                        unsafe extern fn(_: *mut zbarSymbol, _: *mut libc::c_void) -> *mut PyObject,
                    >,
        ...
        {
            let mut init = PyGetSetDef {
                name: b"location\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
                get: ::std::mem::transmute::<
                    Option<
                        unsafe extern fn(_: *mut zbarSymbol, _: *mut libc::c_void) -> *mut PyObject,
                    >,
        ...
        {
            let mut init = PyGetSetDef {
                name: b"orientation\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
                get: ::std::mem::transmute::<
                    Option<
                        unsafe extern fn(
                            _: *mut zbarSymbol,
        ...
        {
            let mut init = PyGetSetDef {
                name: b"components\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
                get: ::std::mem::transmute::<
                    Option<
                        unsafe extern fn(
                            _: *mut zbarSymbol,
...
#[no_mangle]
pub static mut zbarSymbol_Type: PyTypeObject = unsafe {
    {
        let mut init = _typeobject {
            ob_refcnt: 1 as libc::c_int as Py_ssize_t,
            ob_type: 0 as *const _typeobject as *mut _typeobject,
            ob_size: 0,
            tp_name: b"zbar.Symbol\x00" as *const u8 as *const libc::c_char,
            tp_basicsize: ::std::mem::size_of::<zbarSymbol>() as libc::c_ulong as Py_ssize_t,
            tp_itemsize: 0,
            tp_dealloc: ::std::mem::transmute::<
                Option<unsafe extern fn(_: *mut zbarSymbol) -> ()>,
                destructor,
            >(Some(
                symbol_dealloc as unsafe extern fn(_: *mut zbarSymbol) -> (),
            )),
            tp_print: None,
            tp_getattr: None,
            tp_setattr: None,
            ...
            tp_clear: ::std::mem::transmute::<
                Option<unsafe extern fn(_: *mut zbarSymbol) -> libc::c_int>,
                inquiry,
            >(Some(
                symbol_clear as unsafe extern fn(_: *mut zbarSymbol) -> libc::c_int,
            )),
            tp_richcompare: None,
            tp_weaklistoffset: 0,
            tp_iter: ::std::mem::transmute::<
                Option<unsafe extern fn(_: *mut zbarSymbol) -> *mut zbarSymbolIter>,
                getiterfunc,
            >(Some(
                symbol_iter as unsafe extern fn(_: *mut zbarSymbol) -> *mut zbarSymbolIter,
            )),
            tp_iternext: None,
...
#[no_mangle]
pub unsafe extern fn zbarSymbol_FromSymbol(mut zsym: *const zbar_symbol_t) -> *mut zbarSymbol {
    /* FIXME symbol object recycle cache */
    let mut self_0: *mut zbarSymbol = _PyObject_GC_New(&mut zbarSymbol_Type) as *mut zbarSymbol;
    if self_0.is_null() {
...
#[no_mangle]
pub unsafe extern fn zbarSymbol_LookupEnum(mut type_0: zbar_symbol_type_t) -> *mut zbarEnumItem {
    let mut key: *mut PyObject = PyInt_FromLong(type_0 as libc::c_long);
    let mut e: *mut zbarEnumItem = PyDict_GetItem(symbol_enum, key) as *mut zbarEnumItem;
    if e.is_null() {
