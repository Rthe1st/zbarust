 ...
 */
#[inline]
unsafe extern fn zbar_decoder_parse_config(
    mut decoder: *mut zbar_decoder_t,
    ...
    return (zbar_parse_config(config_string, &mut sym, &mut cfg, &mut val) != 0
        || zbar_decoder_set_config(decoder, sym, cfg, val) != 0) as libc::c_int;
}
/*------------------------------------------------------------------------
...
unsafe extern fn decoder_new(
    ...
    let mut self_0: *mut zbarDecoder = (*type_0).tp_alloc.expect("non-null function pointer")(
        type_0,
...
unsafe extern fn decoder_traverse(
    mut self_0: *mut zbarDecoder,
    mut visit: visitproc,
...
unsafe extern fn decoder_clear(mut self_0: *mut zbarDecoder) -> libc::c_int {
...
unsafe extern fn decoder_dealloc(mut self_0: *mut zbarDecoder) {
...
unsafe extern fn decoder_get_color(
    mut self_0: *mut zbarDecoder,
...
unsafe extern fn decoder_get_type(
    mut self_0: *mut zbarDecoder,
    mut closure: *mut libc::c_void,
) -> *mut zbarEnumItem {
...
unsafe extern fn decoder_get_configs(
    mut self_0: *mut zbarDecoder,
    mut closure: *mut libc::c_void,
) -> *mut PyObject {
    let mut sym: libc::c_uint = zbar_decoder_get_type((*self_0).zdcode) as libc::c_uint;
...
unsafe extern fn decoder_get_modifiers(
    mut self_0: *mut zbarDecoder,
    mut closure: *mut libc::c_void,
) -> *mut PyObject {
...
unsafe extern fn decoder_get_data(
    mut self_0: *mut zbarDecoder,
    mut closure: *mut libc::c_void,
) -> *mut PyObject {
    return PyString_FromStringAndSize(
        zbar_decoder_get_data((*self_0).zdcode),
        zbar_decoder_get_data_length((*self_0).zdcode) as Py_ssize_t,
    );
}
unsafe extern fn decoder_get_direction(
    mut self_0: *mut zbarDecoder,
    mut closure: *mut libc::c_void,
) -> *mut PyObject {
    return PyInt_FromLong(zbar_decoder_get_direction((*self_0).zdcode) as libc::c_long);
}
static mut decoder_getset: [PyGetSetDef; 7] = unsafe {
    [
        {
        ...
        {
            let mut init = PyGetSetDef {
                name: b"direction\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
                get: ::std::mem::transmute::<
                    Option<
                        unsafe extern fn(
                            _: *mut zbarDecoder,
...
unsafe extern fn decoder_set_config(
    mut self_0: *mut zbarDecoder,
    mut args: *mut PyObject,
    mut kwds: *mut PyObject,
) -> *mut PyObject {
...
unsafe extern fn decoder_get_configs_meth(
    mut self_0: *mut zbarDecoder,
    mut args: *mut PyObject,
    mut kwds: *mut PyObject,
) -> *mut PyObject {
    ...
    let mut mask: libc::c_uint = zbar_decoder_get_configs((*self_0).zdcode, sym);
    return zbarEnum_SetFromMask(config_enum, mask);
}
unsafe extern fn decoder_parse_config(
    mut self_0: *mut zbarDecoder,
    mut args: *mut PyObject,
    mut kwds: *mut PyObject,
) -> *mut PyObject {
...
unsafe extern fn decoder_reset(
    mut self_0: *mut zbarDecoder,
    mut args: *mut PyObject,
    mut kwds: *mut PyObject,
) -> *mut PyObject {
...
unsafe extern fn decoder_new_scan(
    mut self_0: *mut zbarDecoder,
    mut args: *mut PyObject,
    mut kwds: *mut PyObject,
) -> *mut PyObject {
...
#[no_mangle]
pub unsafe extern fn decode_handler(mut zdcode: *mut zbar_decoder_t) {
    let mut self_0: *mut zbarDecoder = zbar_decoder_get_userdata(zdcode) as *mut zbarDecoder;
...
unsafe extern fn decoder_set_handler(
    mut self_0: *mut zbarDecoder,
    mut args: *mut PyObject,
    mut kwds: *mut PyObject,
) -> *mut PyObject {
    ...
    if handler != &mut _Py_NoneStruct as *mut PyObject {
        ...
        *fresh7 += 1;
        (*closure).ob_refcnt += 1;
        let ref mut fresh8 = *(*((*self_0).args as *mut PyTupleObject))
            .ob_item
            .as_mut_ptr()
            .offset(0 as libc::c_int as isize);
        *fresh8 = self_0 as *mut PyObject;
        let ref mut fresh9 = *(*((*self_0).args as *mut PyTupleObject))
            .ob_item
            .as_mut_ptr()
        ...
        *fresh9 = closure;
        ...
        zbar_decoder_set_handler(
            (*self_0).zdcode,
            Some(decode_handler as unsafe extern fn(_: *mut zbar_decoder_t) -> ()),
        );
    } else {
        (*self_0).args = 0 as *mut PyObject;
...
unsafe extern fn decoder_decode_width(
    mut self_0: *mut zbarDecoder,
    mut args: *mut PyObject,
    mut kwds: *mut PyObject,
) -> *mut zbarEnumItem {
    ...
    let mut sym: zbar_symbol_type_t = zbar_decode_width((*self_0).zdcode, width);
...
static mut decoder_methods: [PyMethodDef; 8] = unsafe {
    [
        {
        ...
        {
            let mut init = PyMethodDef {
                ml_name: b"get_configs\x00" as *const u8 as *const libc::c_char,
                ml_meth: ::std::mem::transmute::<
                    Option<
                        unsafe extern fn(
                            _: *mut zbarDecoder,
        ...
        {
            let mut init = PyMethodDef {
                ml_name: b"set_handler\x00" as *const u8 as *const libc::c_char,
                ml_meth: ::std::mem::transmute::<
                    Option<
                        unsafe extern fn(
                            _: *mut zbarDecoder,
        ...
        {
            let mut init = PyMethodDef {
                ml_name: b"decode_width\x00" as *const u8 as *const libc::c_char,
                ml_meth: ::std::mem::transmute::<
                    Option<
                        unsafe extern fn(
                            _: *mut zbarDecoder,
...
#[no_mangle]
pub static mut zbarDecoder_Type: PyTypeObject = unsafe {
    {
        let mut init = _typeobject {
            ob_refcnt: 1 as libc::c_int as Py_ssize_t,
            ob_type: 0 as *const _typeobject as *mut _typeobject,
            ob_size: 0,
            tp_name: b"zbar.Decoder\x00" as *const u8 as *const libc::c_char,
            tp_basicsize: ::std::mem::size_of::<zbarDecoder>() as libc::c_ulong as Py_ssize_t,
            tp_itemsize: 0,
            tp_dealloc: ::std::mem::transmute::<
                Option<unsafe extern fn(_: *mut zbarDecoder) -> ()>,
                destructor,
            >(Some(
                decoder_dealloc as unsafe extern fn(_: *mut zbarDecoder) -> (),
            )),
            tp_print: None,
            tp_getattr: None,
            tp_setattr: None,
            ...
            tp_clear: ::std::mem::transmute::<
                Option<unsafe extern fn(_: *mut zbarDecoder) -> libc::c_int>,
                inquiry,
            >(Some(
                decoder_clear as unsafe extern fn(_: *mut zbarDecoder) -> libc::c_int,
            )),
            tp_richcompare: None,
            tp_weaklistoffset: 0,
            tp_iter: None,
