...
extern {
    ...
    */
    ...
    #[no_mangle]
    fn PyErr_NewException(
        name: *mut libc::c_char,
        base: *mut PyObject,
        dict: *mut PyObject,
    ) -> *mut PyObject;
    #[no_mangle]
    fn PyArg_ParseTuple(_: *mut PyObject, _: *const libc::c_char, _: ...) -> libc::c_int;
    #[no_mangle]
     ...
     */
    #[no_mangle]
    fn zbar_version(major: *mut libc::c_uint, minor: *mut libc::c_uint) -> libc::c_int;
...
static mut exc_names: [*mut libc::c_char; 12] = [
    b"zbar.Exception\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
    0 as *const libc::c_char as *mut libc::c_char,
    b"zbar.InternalError\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
    b"zbar.UnsupportedError\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
    b"zbar.InvalidRequestError\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
    b"zbar.SystemError\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
    b"zbar.LockingError\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
    b"zbar.BusyError\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
    b"zbar.X11DisplayError\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
    b"zbar.X11ProtocolError\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
    b"zbar.WindowClosed\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
    b"zbar.WinAPIError\x00" as *const u8 as *const libc::c_char as *mut libc::c_char,
];
static mut symbol_defs: [enumdef; 18] = [
    {
        let mut init = enumdef {
            strval: b"NONE\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"PARTIAL\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"EAN8\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"UPCE\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"ISBN10\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"UPCA\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"EAN13\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"ISBN13\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"DATABAR\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"DATABAR_EXP\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"I25\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"CODABAR\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"CODE39\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"PDF417\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"QRCODE\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"CODE93\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"CODE128\x00" as *const u8 as *const libc::c_char,
...
static mut config_defs: [enumdef; 11] = [
    {
        let mut init = enumdef {
            strval: b"ENABLE\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"ADD_CHECK\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"EMIT_CHECK\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"ASCII\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"MIN_LEN\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"MAX_LEN\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"UNCERTAINTY\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"POSITION\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"X_DENSITY\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"Y_DENSITY\x00" as *const u8 as *const libc::c_char,
...
static mut modifier_defs: [enumdef; 3] = [
    {
        let mut init = enumdef {
            strval: b"GS1\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"AIM\x00" as *const u8 as *const libc::c_char,
...
static mut orient_defs: [enumdef; 6] = [
    {
        let mut init = enumdef {
            strval: b"UNKNOWN\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"UP\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"RIGHT\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"DOWN\x00" as *const u8 as *const libc::c_char,
    ...
    {
        let mut init = enumdef {
            strval: b"LEFT\x00" as *const u8 as *const libc::c_char,
...
#[no_mangle]
pub unsafe extern fn object_to_bool(
...
#[no_mangle]
pub unsafe extern fn parse_dimensions(
    mut seq: *mut PyObject,
    ...
    while i < n {
        ...
        *dims = PyInt_AsSsize_t(dim) as libc::c_int;
        ...
        if !((*dim).ob_refcnt != 0 as libc::c_int as libc::c_long) {
            Some((*(*dim).ob_type).tp_dealloc.expect("non-null function pointer"))
                .expect("non-null function pointer")(dim);
        }
...
#[no_mangle]
pub static mut zbar_exc: [*mut PyObject; 12] = [0 as *const PyObject as *mut PyObject; 12];
#[no_mangle]
pub static mut color_enum: [*mut zbarEnumItem; 2] =
    [0 as *const zbarEnumItem as *mut zbarEnumItem; 2];
#[no_mangle]
pub static mut config_enum: *mut zbarEnum = 0 as *const zbarEnum as *mut zbarEnum;
#[no_mangle]
pub static mut modifier_enum: *mut zbarEnum = 0 as *const zbarEnum as *mut zbarEnum;
#[no_mangle]
pub static mut symbol_enum: *mut PyObject = 0 as *const PyObject as *mut PyObject;
#[no_mangle]
pub static mut symbol_NONE: *mut zbarEnumItem = 0 as *const zbarEnumItem as *mut zbarEnumItem;
#[no_mangle]
pub static mut orient_enum: *mut zbarEnum = 0 as *const zbarEnum as *mut zbarEnum;
unsafe extern fn version(mut self_0: *mut PyObject, mut args: *mut PyObject) -> *mut PyObject {
    if PyArg_ParseTuple(args, b"\x00" as *const u8 as *const libc::c_char) == 0 {
        return 0 as *mut PyObject;
    }
    let mut major: libc::c_uint = 0;
    let mut minor: libc::c_uint = 0;
    zbar_version(&mut major, &mut minor);
    return Py_BuildValue(b"II\x00" as *const u8 as *const libc::c_char, major, minor);
}
unsafe extern fn set_verbosity(
    ...
    if PyArg_ParseTuple(
        ...
        &mut verbosity as *mut libc::c_int,
    ) == 0
    {
        return 0 as *mut PyObject;
    }
...
unsafe extern fn increase_verbosity(
    mut self_0: *mut PyObject,
    mut args: *mut PyObject,
) -> *mut PyObject {
    if PyArg_ParseTuple(args, b"\x00" as *const u8 as *const libc::c_char) == 0 {
...
static mut zbar_functions: [PyMethodDef; 4] = unsafe {
    [
        {
            let mut init = PyMethodDef {
                ml_name: b"version\x00" as *const u8 as *const libc::c_char,
                ml_meth: Some(
                    version
                        as unsafe extern fn(_: *mut PyObject, _: *mut PyObject) -> *mut PyObject,
                ),
        ...
        {
            let mut init = PyMethodDef {
                ml_name: b"set_verbosity\x00" as *const u8 as *const libc::c_char,
                ml_meth: Some(
                    set_verbosity
                        as unsafe extern fn(_: *mut PyObject, _: *mut PyObject) -> *mut PyObject,
                ),
        ...
        {
            let mut init = PyMethodDef {
                ml_name: b"increase_verbosity\x00" as *const u8 as *const libc::c_char,
                ml_meth: Some(
                    increase_verbosity
                        as unsafe extern fn(_: *mut PyObject, _: *mut PyObject) -> *mut PyObject,
                ),
...
pub unsafe extern fn initzbar() {
    ...
    if config_enum.is_null()
        || modifier_enum.is_null()
        || symbol_enum.is_null()
        || orient_enum.is_null()
    {
        return;
    ...
    while (ei as libc::c_uint) < ZBAR_ERR_NUM as libc::c_int as libc::c_uint {
        zbar_exc[ei as usize] = PyErr_NewException(
            exc_names[ei as usize],
            zbar_exc[0 as libc::c_int as usize],
            0 as *mut PyObject,
        );
    ...
    /* initialize module */
    let mut mod_0: *mut PyObject = Py_InitModule4_64(
    ...
    PyModule_AddObject(
        ...
        &mut zbarEnumItem_Type as *mut PyTypeObject as *mut PyObject,
    );
    PyModule_AddObject(
        mod_0,
        b"Image\x00" as *const u8 as *const libc::c_char,
        &mut zbarImage_Type as *mut PyTypeObject as *mut PyObject,
    );
    PyModule_AddObject(
        mod_0,
    ...
    PyModule_AddObject(
        ...
        &mut zbarSymbol_Type as *mut PyTypeObject as *mut PyObject,
    );
    PyModule_AddObject(
        mod_0,
        b"SymbolSet\x00" as *const u8 as *const libc::c_char,
        &mut zbarSymbolSet_Type as *mut PyTypeObject as *mut PyObject,
    );
    PyModule_AddObject(
        mod_0,
        b"SymbolIter\x00" as *const u8 as *const libc::c_char,
        &mut zbarSymbolIter_Type as *mut PyTypeObject as *mut PyObject,
    );
    PyModule_AddObject(
        mod_0,
        b"Processor\x00" as *const u8 as *const libc::c_char,
        &mut zbarProcessor_Type as *mut PyTypeObject as *mut PyObject,
    );
    PyModule_AddObject(
        mod_0,
        b"ImageScanner\x00" as *const u8 as *const libc::c_char,
        &mut zbarImageScanner_Type as *mut PyTypeObject as *mut PyObject,
    );
    PyModule_AddObject(
        mod_0,
        b"Decoder\x00" as *const u8 as *const libc::c_char,
        &mut zbarDecoder_Type as *mut PyTypeObject as *mut PyObject,
    );
    PyModule_AddObject(
        mod_0,
        b"Scanner\x00" as *const u8 as *const libc::c_char,
        &mut zbarScanner_Type as *mut PyTypeObject as *mut PyObject,
    );
    ei = ZBAR_OK;
    while (ei as libc::c_uint) < ZBAR_ERR_NUM as libc::c_int as libc::c_uint {
        if !zbar_exc[ei as usize].is_null() {
            PyModule_AddObject(
                mod_0,
                exc_names[ei as usize].offset(5 as libc::c_int as isize),
    ...
    color_enum[ZBAR_SPACE as libc::c_int as usize] = zbarEnumItem_New(
        dict,
        0 as *mut PyObject,
        ZBAR_SPACE as libc::c_int,
        b"SPACE\x00" as *const u8 as *const libc::c_char,
    );
    color_enum[ZBAR_BAR as libc::c_int as usize] = zbarEnumItem_New(
        dict,
        0 as *mut PyObject,
